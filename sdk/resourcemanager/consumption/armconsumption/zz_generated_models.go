...
func (l LegacyReservationRecommendationProperties) marshalInternal(objectMap map[string]interface{}, discValue string) {
...
func (l *LegacyReservationRecommendationProperties) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		var err error
		switch key {
...
func (l LegacySharedScopeReservationRecommendationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	l.LegacyReservationRecommendationProperties.marshalInternal(objectMap, "Shared")
	return json.Marshal(objectMap)
}
...
func (l LegacySingleScopeReservationRecommendationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	l.LegacyReservationRecommendationProperties.marshalInternal(objectMap, "Single")
...
func (l *LegacySingleScopeReservationRecommendationProperties) UnmarshalJSON(data []byte) error {
	...
	if err := l.LegacyReservationRecommendationProperties.unmarshalInternal(rawMsg); err != nil {
		return err
	}
	return nil
}
...
func (l *LotSummary) UnmarshalJSON(data []byte) error {
	...
	if err := l.ProxyResource.unmarshalInternal(rawMsg); err != nil {
		return err
	}
	return nil
}
