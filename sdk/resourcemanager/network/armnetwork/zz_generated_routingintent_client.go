...
func NewRoutingIntentClient(con *arm.Connection, subscriptionID string) *RoutingIntentClient {
	return &RoutingIntentClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
