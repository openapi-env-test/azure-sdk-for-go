...
func NewFirewallPolicyIdpsSignaturesOverridesClient(con *arm.Connection, subscriptionID string) *FirewallPolicyIdpsSignaturesOverridesClient {
	return &FirewallPolicyIdpsSignaturesOverridesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
