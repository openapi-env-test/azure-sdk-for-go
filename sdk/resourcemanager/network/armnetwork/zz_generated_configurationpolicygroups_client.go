...
func NewConfigurationPolicyGroupsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *ConfigurationPolicyGroupsClient {
...
func (client *ConfigurationPolicyGroupsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, vpnServerConfigurationName string, configurationPolicyGroupName string, vpnServerConfigurationPolicyGroupParameters VPNServerConfigurationPolicyGroup, options *ConfigurationPolicyGroupsClientBeginCreateOrUpdateOptions) (ConfigurationPolicyGroupsClientCreateOrUpdatePollerResponse, error) {
	...
	if err != nil {
		return ConfigurationPolicyGroupsClientCreateOrUpdatePollerResponse{}, err
	}
	result := ConfigurationPolicyGroupsClientCreateOrUpdatePollerResponse{
		RawResponse: resp,
	}
	pt, err := armruntime.NewPoller("ConfigurationPolicyGroupsClient.CreateOrUpdate", "azure-async-operation", resp, client.pl)
	if err != nil {
		return ConfigurationPolicyGroupsClientCreateOrUpdatePollerResponse{}, err
	}
	result.Poller = &ConfigurationPolicyGroupsClientCreateOrUpdatePoller{
		pt: pt,
	}
	return result, nil
}
...
// method.
func (client *ConfigurationPolicyGroupsClient) BeginDelete(ctx context.Context, resourceGroupName string, vpnServerConfigurationName string, configurationPolicyGroupName string, options *ConfigurationPolicyGroupsClientBeginDeleteOptions) (ConfigurationPolicyGroupsClientDeletePollerResponse, error) {
	resp, err := client.deleteOperation(ctx, resourceGroupName, vpnServerConfigurationName, configurationPolicyGroupName, options)
	if err != nil {
		return ConfigurationPolicyGroupsClientDeletePollerResponse{}, err
	}
	result := ConfigurationPolicyGroupsClientDeletePollerResponse{
		RawResponse: resp,
	}
	pt, err := armruntime.NewPoller("ConfigurationPolicyGroupsClient.Delete", "location", resp, client.pl)
	if err != nil {
		return ConfigurationPolicyGroupsClientDeletePollerResponse{}, err
	}
	result.Poller = &ConfigurationPolicyGroupsClientDeletePoller{
		pt: pt,
	}
	return result, nil
}
...
func (client *ConfigurationPolicyGroupsClient) getHandleResponse(resp *http.Response) (ConfigurationPolicyGroupsClientGetResponse, error) {
	result := ConfigurationPolicyGroupsClientGetResponse{RawResponse: resp}
...
// ListByVPNServerConfiguration - Lists all the configurationPolicyGroups in a resource group for a vpnServerConfiguration.
// If the operation fails it returns an *azcore.ResponseError type.
// resourceGroupName - The resource group name of the VpnServerConfiguration.
// vpnServerConfigurationName - The name of the VpnServerConfiguration.
...
// method.
func (client *ConfigurationPolicyGroupsClient) ListByVPNServerConfiguration(resourceGroupName string, vpnServerConfigurationName string, options *ConfigurationPolicyGroupsClientListByVPNServerConfigurationOptions) *ConfigurationPolicyGroupsClientListByVPNServerConfigurationPager {
	return &ConfigurationPolicyGroupsClientListByVPNServerConfigurationPager{
		client: client,
		...
		advancer: func(ctx context.Context, resp ConfigurationPolicyGroupsClientListByVPNServerConfigurationResponse) (*policy.Request, error) {
			return runtime.NewRequest(ctx, http.MethodGet, *resp.ListVPNServerConfigurationPolicyGroupsResult.NextLink)
		},
	}
}
...
func (client *ConfigurationPolicyGroupsClient) listByVPNServerConfigurationHandleResponse(resp *http.Response) (ConfigurationPolicyGroupsClientListByVPNServerConfigurationResponse, error) {
	result := ConfigurationPolicyGroupsClientListByVPNServerConfigurationResponse{RawResponse: resp}
