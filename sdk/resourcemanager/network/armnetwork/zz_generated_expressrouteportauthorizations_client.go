...
func NewExpressRoutePortAuthorizationsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *ExpressRoutePortAuthorizationsClient {
...
func (client *ExpressRoutePortAuthorizationsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, expressRoutePortName string, authorizationName string, authorizationParameters ExpressRoutePortAuthorization, options *ExpressRoutePortAuthorizationsClientBeginCreateOrUpdateOptions) (ExpressRoutePortAuthorizationsClientCreateOrUpdatePollerResponse, error) {
	...
	if err != nil {
		return ExpressRoutePortAuthorizationsClientCreateOrUpdatePollerResponse{}, err
	}
	result := ExpressRoutePortAuthorizationsClientCreateOrUpdatePollerResponse{
		RawResponse: resp,
	}
	pt, err := armruntime.NewPoller("ExpressRoutePortAuthorizationsClient.CreateOrUpdate", "azure-async-operation", resp, client.pl)
	if err != nil {
		return ExpressRoutePortAuthorizationsClientCreateOrUpdatePollerResponse{}, err
	}
	result.Poller = &ExpressRoutePortAuthorizationsClientCreateOrUpdatePoller{
		pt: pt,
	}
	return result, nil
}
...
// method.
func (client *ExpressRoutePortAuthorizationsClient) BeginDelete(ctx context.Context, resourceGroupName string, expressRoutePortName string, authorizationName string, options *ExpressRoutePortAuthorizationsClientBeginDeleteOptions) (ExpressRoutePortAuthorizationsClientDeletePollerResponse, error) {
	resp, err := client.deleteOperation(ctx, resourceGroupName, expressRoutePortName, authorizationName, options)
	if err != nil {
		return ExpressRoutePortAuthorizationsClientDeletePollerResponse{}, err
	}
	result := ExpressRoutePortAuthorizationsClientDeletePollerResponse{
		RawResponse: resp,
	}
	pt, err := armruntime.NewPoller("ExpressRoutePortAuthorizationsClient.Delete", "location", resp, client.pl)
	if err != nil {
		return ExpressRoutePortAuthorizationsClientDeletePollerResponse{}, err
	}
	result.Poller = &ExpressRoutePortAuthorizationsClientDeletePoller{
		pt: pt,
	}
	return result, nil
}
...
func (client *ExpressRoutePortAuthorizationsClient) getHandleResponse(resp *http.Response) (ExpressRoutePortAuthorizationsClientGetResponse, error) {
	result := ExpressRoutePortAuthorizationsClientGetResponse{RawResponse: resp}
...
// method.
func (client *ExpressRoutePortAuthorizationsClient) List(resourceGroupName string, expressRoutePortName string, options *ExpressRoutePortAuthorizationsClientListOptions) *ExpressRoutePortAuthorizationsClientListPager {
	return &ExpressRoutePortAuthorizationsClientListPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listCreateRequest(ctx, resourceGroupName, expressRoutePortName, options)
		},
		advancer: func(ctx context.Context, resp ExpressRoutePortAuthorizationsClientListResponse) (*policy.Request, error) {
			return runtime.NewRequest(ctx, http.MethodGet, *resp.ExpressRoutePortAuthorizationListResult.NextLink)
		},
	}
}
...
func (client *ExpressRoutePortAuthorizationsClient) listHandleResponse(resp *http.Response) (ExpressRoutePortAuthorizationsClientListResponse, error) {
	result := ExpressRoutePortAuthorizationsClientListResponse{RawResponse: resp}
