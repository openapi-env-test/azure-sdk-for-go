...
type CommunicationsGatewayProperties struct {
	...
	AutoGeneratedDomainNameLabel *string `json:"autoGeneratedDomainNameLabel,omitempty" azure:"ro"`
...
// CommunicationsGatewaysClientListByResourceGroupOptions contains the optional parameters for the CommunicationsGatewaysClient.ListByResourceGroup
// method.
type CommunicationsGatewaysClientListByResourceGroupOptions struct {
	// placeholder for future optional parameters
}

// CommunicationsGatewaysClientListBySubscriptionOptions contains the optional parameters for the CommunicationsGatewaysClient.ListBySubscription
// method.
...
// TestLinesClientListByCommunicationsGatewayOptions contains the optional parameters for the TestLinesClient.ListByCommunicationsGateway
// method.
