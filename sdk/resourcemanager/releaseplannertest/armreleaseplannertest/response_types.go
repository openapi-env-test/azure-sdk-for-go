...
// DeviceUpdateClientCheckNameAvailabilityResponse contains the response from method DeviceUpdateClient.CheckNameAvailability.
type DeviceUpdateClientCheckNameAvailabilityResponse struct {
