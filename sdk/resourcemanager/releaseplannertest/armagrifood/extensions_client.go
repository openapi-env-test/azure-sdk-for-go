...
// requestBody - Extension resource request body.
// options - ExtensionsClientCreateOrUpdateOptions contains the optional parameters for the ExtensionsClient.CreateOrUpdate
// method.
func (client *ExtensionsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, farmBeatsResourceName string, extensionID string, requestBody ExtensionInstallationRequest, options *ExtensionsClientCreateOrUpdateOptions) (ExtensionsClientCreateOrUpdateResponse, error) {
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, farmBeatsResourceName, extensionID, requestBody, options)
	if err != nil {
...
func (client *ExtensionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, farmBeatsResourceName string, extensionID string, requestBody ExtensionInstallationRequest, options *ExtensionsClientCreateOrUpdateOptions) (*policy.Request, error) {
