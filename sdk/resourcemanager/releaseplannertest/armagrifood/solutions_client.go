...
// body - Solution resource request body.
// options - SolutionsClientCreateOrUpdateOptions contains the optional parameters for the SolutionsClient.CreateOrUpdate
// method.
func (client *SolutionsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, farmBeatsResourceName string, solutionID string, body SolutionInstallationRequest, options *SolutionsClientCreateOrUpdateOptions) (SolutionsClientCreateOrUpdateResponse, error) {
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, farmBeatsResourceName, solutionID, body, options)
	if err != nil {
...
func (client *SolutionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, farmBeatsResourceName string, solutionID string, body SolutionInstallationRequest, options *SolutionsClientCreateOrUpdateOptions) (*policy.Request, error) {
