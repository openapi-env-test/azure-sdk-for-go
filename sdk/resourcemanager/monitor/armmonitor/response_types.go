...
// AzureMonitorWorkspacesClientListByResourceGroupResponse contains the response from method AzureMonitorWorkspacesClient.ListByResourceGroup.
type AzureMonitorWorkspacesClientListByResourceGroupResponse struct {
	MonitoringAccountResourceListResult
}

// AzureMonitorWorkspacesClientListBySubscriptionResponse contains the response from method AzureMonitorWorkspacesClient.ListBySubscription.
