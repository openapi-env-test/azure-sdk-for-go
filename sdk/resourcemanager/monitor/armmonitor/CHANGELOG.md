...
- New function `*AzureMonitorWorkspacesClient.Create(context.Context, string, string, MonitoringAccountResource, *AzureMonitorWorkspacesClientCreateOptions) (AzureMonitorWorkspacesClientCreateResponse, error)`
