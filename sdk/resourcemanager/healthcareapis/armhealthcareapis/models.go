...
// AnalyticsConnector - Analytics Connector definition.
type AnalyticsConnector struct {
	...
	Properties *AnalyticsConnectorProperties `json:"properties,omitempty"`
...
// AnalyticsConnectorCollection - A collection of Analytics Connectors.
type AnalyticsConnectorCollection struct {
	// The link used to get the next page of AnalyticsConnectors.
	NextLink *string `json:"nextLink,omitempty"`

	// The list of Analytics Connectors.
	Value []*AnalyticsConnector `json:"value,omitempty"`
}

// AnalyticsConnectorDataDestinationClassification provides polymorphic access to related types.
// Call the interface's GetAnalyticsConnectorDataDestination() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AnalyticsConnectorDataDestination, *AnalyticsConnectorDataLakeDataDestination
type AnalyticsConnectorDataDestinationClassification interface {
	// GetAnalyticsConnectorDataDestination returns the AnalyticsConnectorDataDestination content of the underlying type.
	GetAnalyticsConnectorDataDestination() *AnalyticsConnectorDataDestination
}

// AnalyticsConnectorDataDestination - Data destination configuration for Analytics Connector.
type AnalyticsConnectorDataDestination struct {
	// REQUIRED; Type of data destination.
	Type *AnalyticsConnectorDataDestinationType `json:"type,omitempty"`
...
// GetAnalyticsConnectorDataDestination implements the AnalyticsConnectorDataDestinationClassification interface for type
// AnalyticsConnectorDataDestination.
func (a *AnalyticsConnectorDataDestination) GetAnalyticsConnectorDataDestination() *AnalyticsConnectorDataDestination {
	return a
}

// AnalyticsConnectorDataLakeDataDestination - The Data Lake data destination for Analytics Connector.
type AnalyticsConnectorDataLakeDataDestination struct {
	// REQUIRED; The name for the Data Lake.
...
func (a *AnalyticsConnectorDataLakeDataDestination) GetAnalyticsConnectorDataDestination() *AnalyticsConnectorDataDestination {
	return &AnalyticsConnectorDataDestination{
		Type:                 a.Type,
		Name:                 a.Name,
...
// AnalyticsConnectorDataSourceClassification provides polymorphic access to related types.
// Call the interface's GetAnalyticsConnectorDataSource() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AnalyticsConnectorDataSource, *AnalyticsConnectorFhirServiceDataSource
type AnalyticsConnectorDataSourceClassification interface {
	// GetAnalyticsConnectorDataSource returns the AnalyticsConnectorDataSource content of the underlying type.
	GetAnalyticsConnectorDataSource() *AnalyticsConnectorDataSource
}

// AnalyticsConnectorDataSource - Data source for Analytics Connector. The target resource must be in the same workspace with
// the Analytics Connector.
type AnalyticsConnectorDataSource struct {
	// REQUIRED; Type of data source.
	Type *AnalyticsConnectorDataSourceType `json:"type,omitempty"`

	// OPTIONAL; Contains additional key/value pairs not defined in the schema.
	AdditionalProperties map[string]interface{}
}

// GetAnalyticsConnectorDataSource implements the AnalyticsConnectorDataSourceClassification interface for type AnalyticsConnectorDataSource.
func (a *AnalyticsConnectorDataSource) GetAnalyticsConnectorDataSource() *AnalyticsConnectorDataSource {
	return a
}

// AnalyticsConnectorFhirServiceDataSource - The FHIR service data source for Analytics Connector.
type AnalyticsConnectorFhirServiceDataSource struct {
	// REQUIRED; The kind of FHIR Service.
	Kind *FhirServiceVersion `json:"kind,omitempty"`

	// REQUIRED; Type of data source.
	Type *AnalyticsConnectorDataSourceType `json:"type,omitempty"`

	// REQUIRED; The URL of FHIR service.
...
// GetAnalyticsConnectorDataSource implements the AnalyticsConnectorDataSourceClassification interface for type AnalyticsConnectorFhirServiceDataSource.
func (a *AnalyticsConnectorFhirServiceDataSource) GetAnalyticsConnectorDataSource() *AnalyticsConnectorDataSource {
	return &AnalyticsConnectorDataSource{
		Type:                 a.Type,
		AdditionalProperties: a.AdditionalProperties,
	}
}

// AnalyticsConnectorFhirToParquetMapping - FHIR Service data mapping configuration for Analytics Connector.
type AnalyticsConnectorFhirToParquetMapping struct {
	// REQUIRED; Type of data mapping.
	Type *AnalyticsConnectorMappingType `json:"type,omitempty"`

	// OPTIONAL; Contains additional key/value pairs not defined in the schema.
	AdditionalProperties map[string]interface{}

	// Artifact reference for extension schema.
	ExtensionSchemaReference *string `json:"extensionSchemaReference,omitempty"`

	// Artifact reference for filter configurations.
	FilterConfigurationReference *string `json:"filterConfigurationReference,omitempty"`
}

// GetAnalyticsConnectorMapping implements the AnalyticsConnectorMappingClassification interface for type AnalyticsConnectorFhirToParquetMapping.
func (a *AnalyticsConnectorFhirToParquetMapping) GetAnalyticsConnectorMapping() *AnalyticsConnectorMapping {
	return &AnalyticsConnectorMapping{
		Type:                 a.Type,
		AdditionalProperties: a.AdditionalProperties,
	}
}

// AnalyticsConnectorMappingClassification provides polymorphic access to related types.
// Call the interface's GetAnalyticsConnectorMapping() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *AnalyticsConnectorFhirToParquetMapping, *AnalyticsConnectorMapping
type AnalyticsConnectorMappingClassification interface {
	// GetAnalyticsConnectorMapping returns the AnalyticsConnectorMapping content of the underlying type.
	GetAnalyticsConnectorMapping() *AnalyticsConnectorMapping
}

// AnalyticsConnectorMapping - Data mapping configuration for Analytics Connector.
type AnalyticsConnectorMapping struct {
	// REQUIRED; Type of data mapping.
	Type *AnalyticsConnectorMappingType `json:"type,omitempty"`
...
// GetAnalyticsConnectorMapping implements the AnalyticsConnectorMappingClassification interface for type AnalyticsConnectorMapping.
func (a *AnalyticsConnectorMapping) GetAnalyticsConnectorMapping() *AnalyticsConnectorMapping {
	return a
}

// AnalyticsConnectorPatchResource - AnalyticsConnector patch properties
type AnalyticsConnectorPatchResource struct {
	// Setting indicating whether the service has a managed identity associated with it.
	Identity *ServiceManagedIdentityIdentity `json:"identity,omitempty"`
...
// AnalyticsConnectorProperties - Analytics Connector Properties.
type AnalyticsConnectorProperties struct {
	// REQUIRED; Data destination configuration for Analytics Connector.
	DataDestinationConfiguration AnalyticsConnectorDataDestinationClassification `json:"dataDestinationConfiguration,omitempty"`

	// REQUIRED; Data mapping configuration for Analytics Connector.
	DataMappingConfiguration AnalyticsConnectorMappingClassification `json:"dataMappingConfiguration,omitempty"`

	// REQUIRED; Data source for Analytics Connector.
	DataSourceConfiguration AnalyticsConnectorDataSourceClassification `json:"dataSourceConfiguration,omitempty"`

	// READ-ONLY; The provisioning state.
	ProvisioningState *ProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}

// AnalyticsConnectorsClientBeginCreateOrUpdateOptions contains the optional parameters for the AnalyticsConnectorsClient.BeginCreateOrUpdate
// method.
type AnalyticsConnectorsClientBeginCreateOrUpdateOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// AnalyticsConnectorsClientBeginDeleteOptions contains the optional parameters for the AnalyticsConnectorsClient.BeginDelete
// method.
type AnalyticsConnectorsClientBeginDeleteOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// AnalyticsConnectorsClientBeginUpdateOptions contains the optional parameters for the AnalyticsConnectorsClient.BeginUpdate
// method.
type AnalyticsConnectorsClientBeginUpdateOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// AnalyticsConnectorsClientGetOptions contains the optional parameters for the AnalyticsConnectorsClient.Get method.
type AnalyticsConnectorsClientGetOptions struct {
	// placeholder for future optional parameters
}

// AnalyticsConnectorsClientListByWorkspaceOptions contains the optional parameters for the AnalyticsConnectorsClient.ListByWorkspace
// method.
type AnalyticsConnectorsClientListByWorkspaceOptions struct {
	// placeholder for future optional parameters
}
