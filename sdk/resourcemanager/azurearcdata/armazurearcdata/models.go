...
type ArcSQLServerDatabaseListResult struct {
	...
	Value []*SQLServerDatabaseResource `json:"value,omitempty" azure:"ro"`
}
...
type SQLServerDatabaseResource struct {
	...
	Properties *SQLServerDatabaseResourceProperties `json:"properties,omitempty"`
...
type SQLServerDatabaseResourceProperties struct {
	BackupInformation *SQLServerDatabaseResourcePropertiesBackupInformation `json:"backupInformation,omitempty"`
	...
	DatabaseCreationDate *time.Time `json:"databaseCreationDate,omitempty"`

	// List of features that are enabled for the database
	DatabaseOptions *SQLServerDatabaseResourcePropertiesDatabaseOptions `json:"databaseOptions,omitempty"`
	...
	SpaceAvailableMB *float32 `json:"spaceAvailableMB,omitempty"`
...
type SQLServerDatabaseResourcePropertiesBackupInformation struct {
	...
	LastLogBackup *time.Time `json:"lastLogBackup,omitempty"`
}
...
type SQLServerDatabaseResourcePropertiesDatabaseOptions struct {
	IsAutoCloseOn               *bool `json:"isAutoCloseOn,omitempty"`
	IsAutoCreateStatsOn         *bool `json:"isAutoCreateStatsOn,omitempty"`
	IsAutoShrinkOn              *bool `json:"isAutoShrinkOn,omitempty"`
	IsAutoUpdateStatsOn         *bool `json:"isAutoUpdateStatsOn,omitempty"`
	IsEncrypted                 *bool `json:"isEncrypted,omitempty"`
	IsMemoryOptimizationEnabled *bool `json:"isMemoryOptimizationEnabled,omitempty"`
	IsRemoteDataArchiveEnabled  *bool `json:"isRemoteDataArchiveEnabled,omitempty"`
	IsTrustworthyOn             *bool `json:"isTrustworthyOn,omitempty"`
}
...
// SQLServerDatabasesClientListOptions contains the optional parameters for the SQLServerDatabasesClient.List method.
