...
// KustoPoolPrivateLinkResourcesClientListOptions contains the optional parameters for the KustoPoolPrivateLinkResourcesClient.List
// method.
...
type SelfHostedIntegrationRuntimeStatusTypeProperties struct {
	...
	// READ-ONLY
	OSType *int32 `json:"osType,omitempty" azure:"ro"`
	...
	// READ-ONLY
	TargetFramework *int32 `json:"targetFramework,omitempty" azure:"ro"`
...
type WorkspaceProperties struct {
	...
	ExtraProperties interface{} `json:"extraProperties,omitempty" azure:"ro"`
