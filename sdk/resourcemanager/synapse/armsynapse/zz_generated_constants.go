...
// ToPtr returns a *DedicatedSQLMinimalTLSSettingsName pointing to the current value.
func (c DedicatedSQLMinimalTLSSettingsName) ToPtr() *DedicatedSQLMinimalTLSSettingsName {
	return &c
}
