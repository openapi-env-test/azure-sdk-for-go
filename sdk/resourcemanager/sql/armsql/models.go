...
type ChangeLongTermRetentionBackupAccessTierParameters struct {
	...
	BackupStorageAccessTier *string `json:"backupStorageAccessTier,omitempty"`
...
type JobPrivateEndpointListResult struct {
	...
	// READ-ONLY; Array of results.
	Value []*JobPrivateEndpoint `json:"value,omitempty" azure:"ro"`
}
...
type JobPrivateEndpointProperties struct {
	...
	TargetServerAzureResourceID *string `json:"targetServerAzureResourceId,omitempty"`

	// READ-ONLY; Private endpoint id of the private endpoint.
	PrivateEndpointID *string `json:"privateEndpointId,omitempty" azure:"ro"`
}
...
// JobPrivateEndpointsClientListByAgentOptions contains the optional parameters for the JobPrivateEndpointsClient.ListByAgent
// method.
...
type LongTermRetentionBackupProperties struct {
	...
	BackupStorageAccessTier *BackupStorageAccessTier `json:"backupStorageAccessTier,omitempty" azure:"ro"`
