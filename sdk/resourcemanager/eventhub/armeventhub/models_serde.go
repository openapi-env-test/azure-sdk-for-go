...
func (f FailOverProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "maximumGracePeriodInMins", f.MaximumGracePeriodInMins)
...
func (f *FailOverProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "maximumGracePeriodInMins":
			err = unpopulate(val, "MaximumGracePeriodInMins", &f.MaximumGracePeriodInMins)
			delete(rawMsg, key)
...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "messageTimestampType", p.MessageTimestampType)
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "messageRetentionInDays":
			...
			delete(rawMsg, key)
		case "messageTimestampType":
			err = unpopulate(val, "MessageTimestampType", &p.MessageTimestampType)
			delete(rawMsg, key)
		case "partitionCount":
