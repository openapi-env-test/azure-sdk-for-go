...
type EHNamespaceProperties struct {
	...
	GeoDataReplication *GeoDataReplicationProperties `json:"geoDataReplication,omitempty"`
...
type FailOverProperties struct {
	...
	MaximumGracePeriodInMins *int32 `json:"maximumGracePeriodInMins,omitempty"`
...
type GeoDataReplicationProperties struct {
	...
	MaxReplicationLagDurationInSeconds *int32 `json:"maxReplicationLagDurationInSeconds,omitempty"`
}
...
type NamespaceReplicaLocation struct {
	...
	ReplicaState *string `json:"replicaState,omitempty" azure:"ro"`
}
...
type NetworkSecurityPerimeterConfigurationProperties struct {
	...
	ApplicableFeatures []*string `json:"applicableFeatures,omitempty" azure:"ro"`

	// READ-ONLY; True if the EventHub namespace is backed by another Azure resource and not visible to end users.
	IsBackingResource *bool `json:"isBackingResource,omitempty" azure:"ro"`
	...
	ParentAssociationName *string `json:"parentAssociationName,omitempty" azure:"ro"`
...
type Properties struct {
	...
	MessageTimestampType *TimestampType `json:"messageTimestampType,omitempty"`
...
type RetentionDescription struct {
	...
	MinCompactionLagInMins *int64 `json:"minCompactionLagInMins,omitempty"`
