...
// TimestampType - Denotes the type of timestamp the message will hold. Two types of timestamp types AppendTime, CreateTime.
// AppendTime refers the time in which message got appended inside broker log. CreateTime refers
