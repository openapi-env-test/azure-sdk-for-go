...
func NewApplicationGroupClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *ApplicationGroupClient {
...
func (client *ApplicationGroupClient) createOrUpdateApplicationGroupHandleResponse(resp *http.Response) (ApplicationGroupClientCreateOrUpdateApplicationGroupResponse, error) {
	result := ApplicationGroupClientCreateOrUpdateApplicationGroupResponse{RawResponse: resp}
...
func (client *ApplicationGroupClient) Delete(ctx context.Context, resourceGroupName string, namespaceName string, applicationGroupName string, options *ApplicationGroupClientDeleteOptions) (ApplicationGroupClientDeleteResponse, error) {
	...
	return ApplicationGroupClientDeleteResponse{RawResponse: resp}, nil
}
...
func (client *ApplicationGroupClient) getHandleResponse(resp *http.Response) (ApplicationGroupClientGetResponse, error) {
	result := ApplicationGroupClientGetResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.ApplicationGroup); err != nil {
		return ApplicationGroupClientGetResponse{}, err
	}
	return result, nil
...
// method.
func (client *ApplicationGroupClient) ListByNamespace(resourceGroupName string, namespaceName string, options *ApplicationGroupClientListByNamespaceOptions) *ApplicationGroupClientListByNamespacePager {
	return &ApplicationGroupClientListByNamespacePager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listByNamespaceCreateRequest(ctx, resourceGroupName, namespaceName, options)
		},
		advancer: func(ctx context.Context, resp ApplicationGroupClientListByNamespaceResponse) (*policy.Request, error) {
			return runtime.NewRequest(ctx, http.MethodGet, *resp.ApplicationGroupListResult.NextLink)
		},
	}
}
...
func (client *ApplicationGroupClient) listByNamespaceHandleResponse(resp *http.Response) (ApplicationGroupClientListByNamespaceResponse, error) {
	result := ApplicationGroupClientListByNamespaceResponse{RawResponse: resp}
