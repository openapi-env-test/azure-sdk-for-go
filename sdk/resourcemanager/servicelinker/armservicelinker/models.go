...
type ConfigurationNameResult struct {
	...
	Value []*ConfigurationNameItem `json:"value,omitempty"`
...
type DaprConfigurationList struct {
	...
	Value []*DaprConfigurationResource `json:"value,omitempty"`
...
type DaprProperties struct {
	...
	BindingComponentDirection *DaprBindingComponentDirection `json:"bindingComponentDirection,omitempty" azure:"ro"`
...
// LinkersClientListDaprConfigurationsOptions contains the optional parameters for the LinkersClient.ListDaprConfigurations
// method.
...
type SourceConfiguration struct {
	...
	ConfigType *LinkerConfigurationType `json:"configType,omitempty" azure:"ro"`
}
