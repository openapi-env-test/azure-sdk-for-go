...
// ReplicasClientCreateResponse contains the response from method ReplicasClient.Create.
...
// ReplicasClientListByConfigurationStoreResponse contains the response from method ReplicasClient.ListByConfigurationStore.
