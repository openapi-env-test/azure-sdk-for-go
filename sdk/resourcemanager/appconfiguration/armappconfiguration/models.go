...
type ConfigurationStoreProperties struct {
	...
	Experimentation *ExperimentationProperties `json:"experimentation,omitempty"`
	...
	Telemetry *TelemetryProperties `json:"telemetry,omitempty"`
...
type DataPlaneProxyProperties struct {
	...
	PrivateLinkDelegation *PrivateLinkDelegation `json:"privateLinkDelegation,omitempty"`
}
...
// ReplicasClientListByConfigurationStoreOptions contains the optional parameters for the ReplicasClient.ListByConfigurationStore
// method.
...
type SnapshotProperties struct {
	...
	Status *SnapshotStatus `json:"status,omitempty" azure:"ro"`
}
