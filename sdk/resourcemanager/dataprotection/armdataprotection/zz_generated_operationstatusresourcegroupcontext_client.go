...
func NewOperationStatusResourceGroupContextClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *OperationStatusResourceGroupContextClient {
...
func (client *OperationStatusResourceGroupContextClient) getHandleResponse(resp *http.Response) (OperationStatusResourceGroupContextClientGetResponse, error) {
	result := OperationStatusResourceGroupContextClientGetResponse{RawResponse: resp}
