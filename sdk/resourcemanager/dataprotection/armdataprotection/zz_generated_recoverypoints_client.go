...
func (client *RecoveryPointsClient) List(resourceGroupName string, vaultName string, backupInstanceName string, options *RecoveryPointsClientListOptions) *RecoveryPointsClientListPager {
