...
func (testsuite *MockTestSuite) TestExtensions_Create() {
	...
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Create.json
	...
	_, err = client.Create(ctx, "provider.extension", "examples-farmbeatsResourceName", "examples-rg", nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Create.json")
}

func (testsuite *MockTestSuite) TestExtensions_Get() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Get.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"Extensions_Get"},
	})
	client, err := armagrifood.NewExtensionsClient("11111111-2222-3333-4444-555555555555", testsuite.cred, &testsuite.options)
	testsuite.Require().NoError(err, "Failed to create client")
	res, err := client.Get(ctx, "provider.extension", "examples-farmbeatsResourceName", "examples-rg", nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Get.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.Extension) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestExtensions_Update() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Update.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"Extensions_Update"},
	})
	client, err := armagrifood.NewExtensionsClient("11111111-2222-3333-4444-555555555555", testsuite.cred, &testsuite.options)
	testsuite.Require().NoError(err, "Failed to create client")
	res, err := client.Update(ctx, "provider.extension", "examples-farmbeatsResourceName", "examples-rg", nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Update.json")
	// Response check
	exampleRes := armagrifood.Extension{
		Name: to.Ptr("provider.extension"),
		Type: to.Ptr("Microsoft.AgFoodPlatform/farmBeats/extensions"),
	...
	if !reflect.DeepEqual(exampleRes, res.Extension) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.Extension)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Update.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestExtensions_Delete() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Delete.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"Extensions_Delete"},
	})
	client, err := armagrifood.NewExtensionsClient("11111111-2222-3333-4444-555555555555", testsuite.cred, &testsuite.options)
	testsuite.Require().NoError(err, "Failed to create client")
	_, err = client.Delete(ctx, "provider.extension", "examples-farmbeatsResourceName", "examples-rg", nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_Delete.json")
}

func (testsuite *MockTestSuite) TestExtensions_ListByFarmBeats() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_ListByFarmBeats.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		...
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_ListByFarmBeats.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.ExtensionListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Extensions_ListByFarmBeats.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsExtensions_List() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsExtensions_List.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsExtensions_List.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsExtensionListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsExtensions_List.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsExtensions_Get() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsExtensions_Get.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsExtensions_Get.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeatsExtension) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsExtensions_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_Get() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Get.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Get.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_CreateOrUpdate() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_CreateOrUpdate.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"FarmBeatsModels_CreateOrUpdate"},
	})
	client, err := armagrifood.NewFarmBeatsModelsClient("11111111-2222-3333-4444-555555555555", testsuite.cred, &testsuite.options)
	testsuite.Require().NoError(err, "Failed to create client")
	res, err := client.CreateOrUpdate(ctx, "examples-farmbeatsResourceName", "examples-rg", armagrifood.FarmBeats{
		Location: to.Ptr("eastus2"),
		Tags: map[string]*string{
			"key1": to.Ptr("value1"),
			"key2": to.Ptr("value2"),
	...
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_CreateOrUpdate.json")
	// Response check
	exampleRes := armagrifood.FarmBeats{
		Name:     to.Ptr("examples-farmbeatsResourceName"),
		Type:     to.Ptr("Microsoft.AgFoodPlatform/farmBeats"),
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.FarmBeats)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_CreateOrUpdate.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_Update() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Update.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
		"example-id": {"FarmBeatsModels_Update"},
	})
	client, err := armagrifood.NewFarmBeatsModelsClient("11111111-2222-3333-4444-555555555555", testsuite.cred, &testsuite.options)
	testsuite.Require().NoError(err, "Failed to create client")
	res, err := client.Update(ctx, "examples-farmBeatsResourceName", "examples-rg", armagrifood.FarmBeatsUpdateRequestModel{
		Tags: map[string]*string{
			"key1": to.Ptr("value1"),
			"key2": to.Ptr("value2"),
		},
	}, nil)
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Update.json")
	// Response check
	exampleRes := armagrifood.FarmBeats{
		Name:     to.Ptr("examples-farmBeatsResourceName"),
		Type:     to.Ptr("Microsoft.AgFoodPlatform/farmBeats"),
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.FarmBeats)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Update.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_Delete() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Delete.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_Delete.json")
}

func (testsuite *MockTestSuite) TestFarmBeatsModels_ListBySubscription() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_ListBySubscription.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_ListBySubscription.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_ListBySubscription.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsModels_ListByResourceGroup() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_ListByResourceGroup.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_ListByResourceGroup.json")
		// Response check
		pagerExampleRes := armagrifood.FarmBeatsListResponse{
			Value: []*armagrifood.FarmBeats{
				{
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsListResponse) {
			exampleResJson, _ := json.Marshal(pagerExampleRes)
			mockResJson, _ := json.Marshal(nextResult.FarmBeatsListResponse)
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/FarmBeatsModels_ListByResourceGroup.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestLocations_CheckNameAvailability() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Locations_CheckNameAvailability_AlreadyExists.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Locations_CheckNameAvailability_AlreadyExists.json")
	// Response check
	...
	if !reflect.DeepEqual(exampleRes, res.CheckNameAvailabilityResponse) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Locations_CheckNameAvailability_AlreadyExists.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}

	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Locations_CheckNameAvailability_Available.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	testsuite.Require().NoError(err, "Failed to get result for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Locations_CheckNameAvailability_Available.json")
	// Response check
	exampleRes = armagrifood.CheckNameAvailabilityResponse{
	...
	if !reflect.DeepEqual(exampleRes, res.CheckNameAvailabilityResponse) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.CheckNameAvailabilityResponse)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Locations_CheckNameAvailability_Available.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}

func (testsuite *MockTestSuite) TestOperations_List() {
	ctx := context.Background()
	// From example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Operations_List.json
	ctx = runtime.WithHTTPHeader(ctx, map[string][]string{
	...
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Operations_List.json")
		// Response check
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.OperationListResult) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2022-08-02-preview/examples/Operations_List.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
