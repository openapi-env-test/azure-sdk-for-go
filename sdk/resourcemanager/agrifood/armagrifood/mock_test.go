...
func (testsuite *MockTestSuite) TestExtensions_Get() {
	...
	if !reflect.DeepEqual(exampleRes, res.Extension) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/Extensions_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}
...
func (testsuite *MockTestSuite) TestExtensions_Update() {
	...
	if !reflect.DeepEqual(exampleRes, res.Extension) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.Extension)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/Extensions_Update.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}
...
func (testsuite *MockTestSuite) TestExtensions_ListByFarmBeats() {
	...
	for pager.More() {
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.ExtensionListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/Extensions_ListByFarmBeats.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsExtensions_List() {
	...
	for pager.More() {
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsExtensionListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/FarmBeatsExtensions_List.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsExtensions_Get() {
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeatsExtension) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/FarmBeatsExtensions_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsModels_Get() {
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/FarmBeatsModels_Get.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsModels_CreateOrUpdate() {
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.FarmBeats)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/FarmBeatsModels_CreateOrUpdate.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsModels_Update() {
	...
	if !reflect.DeepEqual(exampleRes, res.FarmBeats) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.FarmBeats)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/FarmBeatsModels_Update.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsModels_ListBySubscription() {
	...
	for pager.More() {
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsListResponse) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/FarmBeatsModels_ListBySubscription.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestFarmBeatsModels_ListByResourceGroup() {
	...
	for pager.More() {
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.FarmBeatsListResponse) {
			exampleResJson, _ := json.Marshal(pagerExampleRes)
			mockResJson, _ := json.Marshal(nextResult.FarmBeatsListResponse)
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/FarmBeatsModels_ListByResourceGroup.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
...
func (testsuite *MockTestSuite) TestLocations_CheckNameAvailability() {
	...
	if !reflect.DeepEqual(exampleRes, res.CheckNameAvailabilityResponse) {
		...
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/Locations_CheckNameAvailability_AlreadyExists.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
	...
	if !reflect.DeepEqual(exampleRes, res.CheckNameAvailabilityResponse) {
		exampleResJson, _ := json.Marshal(exampleRes)
		mockResJson, _ := json.Marshal(res.CheckNameAvailabilityResponse)
		testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/Locations_CheckNameAvailability_Available.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
	}
}
...
func (testsuite *MockTestSuite) TestOperations_List() {
	...
	for pager.More() {
		...
		if !reflect.DeepEqual(pagerExampleRes, nextResult.OperationListResult) {
			...
			testsuite.Failf("Failed to validate response", "Mock response is not equal to example response for example specification/agrifood/resource-manager/Microsoft.AgFoodPlatform/preview/2020-05-12-preview/examples/Operations_List.json:\nmock response: %s\nexample response: %s", mockResJson, exampleResJson)
		}
	}
}
