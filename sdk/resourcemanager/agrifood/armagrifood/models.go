...
type FarmBeatsListResponse struct {
	...
	// READ-ONLY; Continuation link (absolute URI) to the next page of result in the list.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}
...
type FarmBeatsProperties struct {
	...
	ProvisioningStateSz *ProvisioningState `json:"provisioningStateSz,omitempty" azure:"ro"`
}
