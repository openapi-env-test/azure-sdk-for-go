...
// OperationResultsServer is a fake server for instances of the armagrifood.OperationResultsClient type.
type OperationResultsServer struct {
	// Get is the fake for method OperationResultsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, locations string, operationResultsID string, options *armagrifood.OperationResultsClientGetOptions) (resp azfake.Responder[armagrifood.OperationResultsClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationResultsServerTransport instance is connected to an instance of armagrifood.OperationResultsClient via the
...
// OperationResultsServerTransport connects instances of armagrifood.OperationResultsClient to instances of OperationResultsServer.
...
func (o *OperationResultsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AgFoodPlatform/locations/(?P<locations>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/operationResults/(?P<operationResultsId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	respr, errRespr := o.srv.Get(req.Context(), locationsParam, operationResultsIDParam, nil)
