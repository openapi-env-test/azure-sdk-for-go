...
- New function `*RoleAssignmentScheduleRequestsClient.Validate(context.Context, string, string, RoleAssignmentScheduleRequest, *RoleAssignmentScheduleRequestsClientValidateOptions) (RoleAssignmentScheduleRequestsClientValidateResponse, error)`
- New function `*RoleEligibilityScheduleRequestsClient.Validate(context.Context, string, string, RoleEligibilityScheduleRequest, *RoleEligibilityScheduleRequestsClientValidateOptions) (RoleEligibilityScheduleRequestsClientValidateResponse, error)`
...
- New struct `RoleAssignmentScheduleRequestsClientValidateResult`
...
- New struct `RoleEligibilityScheduleRequestsClientValidateResult`
