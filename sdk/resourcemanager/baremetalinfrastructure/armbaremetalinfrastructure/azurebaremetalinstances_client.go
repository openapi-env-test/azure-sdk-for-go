...
// Generated from API version 2021-08-10
...
func (client *AzureBareMetalInstancesClient) getCreateRequest(ctx context.Context, resourceGroupName string, azureBareMetalInstanceName string, options *AzureBareMetalInstancesClientGetOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", "2021-08-10")
...
// BeginUpdate - Patches the Tags field of a Azure BareMetal instance for the specified subscription, resource group, and
// instance name.
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2021-08-10
// resourceGroupName - The name of the resource group. The name is case insensitive.
...
// options - AzureBareMetalInstancesClientBeginUpdateOptions contains the optional parameters for the AzureBareMetalInstancesClient.BeginUpdate
// method.
func (client *AzureBareMetalInstancesClient) BeginUpdate(ctx context.Context, resourceGroupName string, azureBareMetalInstanceName string, tagsParameter Tags, options *AzureBareMetalInstancesClientBeginUpdateOptions) (*runtime.Poller[AzureBareMetalInstancesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, azureBareMetalInstanceName, tagsParameter, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[AzureBareMetalInstancesClientUpdateResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[AzureBareMetalInstancesClientUpdateResponse](options.ResumeToken, client.pl, nil)
	}
}
...
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2021-08-10
func (client *AzureBareMetalInstancesClient) update(ctx context.Context, resourceGroupName string, azureBareMetalInstanceName string, tagsParameter Tags, options *AzureBareMetalInstancesClientBeginUpdateOptions) (*http.Response, error) {
...
func (client *AzureBareMetalInstancesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, azureBareMetalInstanceName string, tagsParameter Tags, options *AzureBareMetalInstancesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalInstances/{azureBareMetalInstanceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
