...
// ManagedHsmKeysClientListOptions contains the optional parameters for the ManagedHsmKeysClient.List method.
type ManagedHsmKeysClientListOptions struct {
	// placeholder for future optional parameters
}

// ManagedHsmKeysClientListVersionsOptions contains the optional parameters for the ManagedHsmKeysClient.ListVersions method.
