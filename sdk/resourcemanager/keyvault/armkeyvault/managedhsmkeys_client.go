...
// resourceGroupName - The name of the resource group. The name is case insensitive.
// name - The name of the Managed HSM Pool within the specified resource group.
// options - ManagedHsmKeysClientListOptions contains the optional parameters for the ManagedHsmKeysClient.List method.
...
// service. The value provided should not include personally identifiable or sensitive
// information.
// options - ManagedHsmKeysClientListVersionsOptions contains the optional parameters for the ManagedHsmKeysClient.ListVersions
// method.
