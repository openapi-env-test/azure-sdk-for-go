...
// ManagedHsmKeysClientListResponse contains the response from method ManagedHsmKeysClient.List.
type ManagedHsmKeysClientListResponse struct {
	ManagedHsmKeyListResult
}

// ManagedHsmKeysClientListVersionsResponse contains the response from method ManagedHsmKeysClient.ListVersions.
