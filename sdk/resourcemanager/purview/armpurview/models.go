...
type AccountProperties struct {
	...
	AccountStatus *AccountPropertiesAccountStatus `json:"accountStatus,omitempty" azure:"ro"`
...
type AccountPropertiesAccountStatus struct {
	...
	AccountProvisioningState *AccountProvisioningState `json:"accountProvisioningState,omitempty" azure:"ro"`

	// READ-ONLY; Gets the account error details.
	ErrorDetails *AccountStatusErrorDetails `json:"errorDetails,omitempty" azure:"ro"`
}
...
type KafkaConfiguration struct {
	...
	// READ-ONLY; Metadata pertaining to creation and last modification of the resource.
	SystemData *ProxyResourceSystemData `json:"systemData,omitempty" azure:"ro"`
...
type KafkaConfigurationList struct {
	// REQUIRED; Collection of items of type results.
	Value []*KafkaConfiguration `json:"value,omitempty"`
...
// KafkaConfigurationsClientListByAccountOptions contains the optional parameters for the KafkaConfigurationsClient.ListByAccount
// method.
