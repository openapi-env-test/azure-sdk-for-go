...
// EditedQueriesClientCreateOrUpdateResponse contains the response from method EditedQueriesClient.CreateOrUpdate.
type EditedQueriesClientCreateOrUpdateResponse struct {
	EditedQueriesClientCreateOrUpdateResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// EditedQueriesClientCreateOrUpdateResult contains the result from method EditedQueriesClient.CreateOrUpdate.
type EditedQueriesClientCreateOrUpdateResult struct {
	EditedQuery
}

// EditedQueriesClientDeleteResponse contains the response from method EditedQueriesClient.Delete.
type EditedQueriesClientDeleteResponse struct {
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// EditedQueriesClientGetResponse contains the response from method EditedQueriesClient.Get.
type EditedQueriesClientGetResponse struct {
	EditedQueriesClientGetResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// EditedQueriesClientGetResult contains the result from method EditedQueriesClient.Get.
type EditedQueriesClientGetResult struct {
	EditedQuery
}

// EditedQueriesClientListResponse contains the response from method EditedQueriesClient.List.
type EditedQueriesClientListResponse struct {
	EditedQueriesClientListResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// EditedQueriesClientListResult contains the result from method EditedQueriesClient.List.
type EditedQueriesClientListResult struct {
	EditedQueryList
}
...
type IncidentsClientRunPlaybookResponse struct {
	IncidentsClientRunPlaybookResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// IncidentsClientRunPlaybookResult contains the result from method IncidentsClient.RunPlaybook.
type IncidentsClientRunPlaybookResult struct {
	// Any object
	Object map[string]interface{}
}
...
// QueriesClientCreateOrUpdateResponse contains the response from method QueriesClient.CreateOrUpdate.
type QueriesClientCreateOrUpdateResponse struct {
	QueriesClientCreateOrUpdateResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// QueriesClientCreateOrUpdateResult contains the result from method QueriesClient.CreateOrUpdate.
type QueriesClientCreateOrUpdateResult struct {
	Query
...
type QueriesClientDeleteResponse struct {
	QueriesClientDeleteResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// QueriesClientDeleteResult contains the result from method QueriesClient.Delete.
type QueriesClientDeleteResult struct {
	// AzureAsyncOperation contains the information returned from the Azure-AsyncOperation header response.
	AzureAsyncOperation *string
}
...
type SecurityMLAnalyticsSettingsClientCreateOrUpdateResponse struct {
	SecurityMLAnalyticsSettingsClientCreateOrUpdateResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// SecurityMLAnalyticsSettingsClientCreateOrUpdateResult contains the result from method SecurityMLAnalyticsSettingsClient.CreateOrUpdate.
type SecurityMLAnalyticsSettingsClientCreateOrUpdateResult struct {
	SecurityMLAnalyticsSettingClassification
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SecurityMLAnalyticsSettingsClientCreateOrUpdateResult.
func (s *SecurityMLAnalyticsSettingsClientCreateOrUpdateResult) UnmarshalJSON(data []byte) error {
...
type SecurityMLAnalyticsSettingsClientGetResponse struct {
	SecurityMLAnalyticsSettingsClientGetResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// SecurityMLAnalyticsSettingsClientGetResult contains the result from method SecurityMLAnalyticsSettingsClient.Get.
type SecurityMLAnalyticsSettingsClientGetResult struct {
	SecurityMLAnalyticsSettingClassification
}

// UnmarshalJSON implements the json.Unmarshaller interface for type SecurityMLAnalyticsSettingsClientGetResult.
func (s *SecurityMLAnalyticsSettingsClientGetResult) UnmarshalJSON(data []byte) error {
	res, err := unmarshalSecurityMLAnalyticsSettingClassification(data)
	if err != nil {
		return err
	}
...
type SecurityMLAnalyticsSettingsClientListResponse struct {
	SecurityMLAnalyticsSettingsClientListResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// SecurityMLAnalyticsSettingsClientListResult contains the result from method SecurityMLAnalyticsSettingsClient.List.
type SecurityMLAnalyticsSettingsClientListResult struct {
...
type WatchlistsClientDeleteResponse struct {
	WatchlistsClientDeleteResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// WatchlistsClientDeleteResult contains the result from method WatchlistsClient.Delete.
type WatchlistsClientDeleteResult struct {
	// AzureAsyncOperation contains the information returned from the Azure-AsyncOperation header response.
	AzureAsyncOperation *string
}
