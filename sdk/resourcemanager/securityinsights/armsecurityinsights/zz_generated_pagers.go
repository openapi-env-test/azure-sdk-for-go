...
// EditedQueriesClientListPager provides operations for iterating over paged responses.
type EditedQueriesClientListPager struct {
	client    *EditedQueriesClient
	current   EditedQueriesClientListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, EditedQueriesClientListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *EditedQueriesClientListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *EditedQueriesClientListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.EditedQueryList.NextLink == nil || len(*p.current.EditedQueryList.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current EditedQueriesClientListResponse page.
func (p *EditedQueriesClientListPager) PageResponse() EditedQueriesClientListResponse {
	return p.current
}
...
// QueriesClientListPager provides operations for iterating over paged responses.
type QueriesClientListPager struct {
	client    *QueriesClient
	current   QueriesClientListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, QueriesClientListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *QueriesClientListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *QueriesClientListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.QueryList.NextLink == nil || len(*p.current.QueryList.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current QueriesClientListResponse page.
func (p *QueriesClientListPager) PageResponse() QueriesClientListResponse {
	return p.current
}

// SecurityMLAnalyticsSettingsClientListPager provides operations for iterating over paged responses.
type SecurityMLAnalyticsSettingsClientListPager struct {
	client    *SecurityMLAnalyticsSettingsClient
	current   SecurityMLAnalyticsSettingsClientListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, SecurityMLAnalyticsSettingsClientListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *SecurityMLAnalyticsSettingsClientListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *SecurityMLAnalyticsSettingsClientListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.SecurityMLAnalyticsSettingsList.NextLink == nil || len(*p.current.SecurityMLAnalyticsSettingsList.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current SecurityMLAnalyticsSettingsClientListResponse page.
func (p *SecurityMLAnalyticsSettingsClientListPager) PageResponse() SecurityMLAnalyticsSettingsClientListResponse {
	return p.current
}
