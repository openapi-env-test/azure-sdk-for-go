...
type AnomalySecurityMLAnalyticsSettingsProperties struct {
	...
	CustomizableObservations map[string]interface{} `json:"customizableObservations,omitempty"`
...
// EditedQueriesClientCreateOrUpdateOptions contains the optional parameters for the EditedQueriesClient.CreateOrUpdate method.
type EditedQueriesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// EditedQueriesClientDeleteOptions contains the optional parameters for the EditedQueriesClient.Delete method.
type EditedQueriesClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// EditedQueriesClientGetOptions contains the optional parameters for the EditedQueriesClient.Get method.
type EditedQueriesClientGetOptions struct {
	// placeholder for future optional parameters
}

// EditedQueriesClientListOptions contains the optional parameters for the EditedQueriesClient.List method.
type EditedQueriesClientListOptions struct {
	// placeholder for future optional parameters
}

// EditedQuery - Represents a Edited Query in Azure Security Insights.
type EditedQuery struct {
	// Etag of the azure resource
	Etag *string `json:"etag,omitempty"`

	// Edited Query properties
	Properties *EditedQueryProperties `json:"properties,omitempty"`
...
// EditedQueryList - List all the Edited Queries.
type EditedQueryList struct {
	// REQUIRED; Array of edited queries.
	Value []*EditedQuery `json:"value,omitempty"`

	// READ-ONLY; URL to fetch the next set of edited queries.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}

// MarshalJSON implements the json.Marshaller interface for type EditedQueryList.
func (e EditedQueryList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// EditedQueryProperties - Describes Edited Query properties
type EditedQueryProperties struct {
	// REQUIRED; the kusto query for a natural language
	KustoQueryLanguage *string `json:"kustoQueryLanguage,omitempty"`
	...
	EditedQueryID *string `json:"editedQueryId,omitempty"`
...
// MarshalJSON implements the json.Marshaller interface for type EditedQueryProperties.
func (e EditedQueryProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	...
	populate(objectMap, "documentType", e.DocumentType)
	populate(objectMap, "editedQueryId", e.EditedQueryID)
	populate(objectMap, "executionResult", e.ExecutionResult)
	populate(objectMap, "kustoQueryLanguage", e.KustoQueryLanguage)
	populate(objectMap, "queryId", e.QueryID)
	populateTimeRFC3339(objectMap, "updated", e.Updated)
	populate(objectMap, "updatedBy", e.UpdatedBy)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type EditedQueryProperties.
func (e *EditedQueryProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	for key, val := range rawMsg {
		...
		case "created":
			...
			delete(rawMsg, key)
		case "createdBy":
			err = unpopulate(val, &e.CreatedBy)
			delete(rawMsg, key)
		case "documentType":
			err = unpopulate(val, &e.DocumentType)
			delete(rawMsg, key)
		case "editedQueryId":
			err = unpopulate(val, &e.EditedQueryID)
			delete(rawMsg, key)
		case "executionResult":
			err = unpopulate(val, &e.ExecutionResult)
			delete(rawMsg, key)
		case "kustoQueryLanguage":
			err = unpopulate(val, &e.KustoQueryLanguage)
			delete(rawMsg, key)
		case "queryId":
			err = unpopulate(val, &e.QueryID)
			delete(rawMsg, key)
		case "updated":
			err = unpopulateTimeRFC3339(val, &e.Updated)
			delete(rawMsg, key)
		case "updatedBy":
			err = unpopulate(val, &e.UpdatedBy)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
// QueriesClientCreateOrUpdateOptions contains the optional parameters for the QueriesClient.CreateOrUpdate method.
type QueriesClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}
...
// Query - Represents a Query in Azure Security Insights.
type Query struct {
	// Etag of the azure resource
	Etag *string `json:"etag,omitempty"`
...
type QueryList struct {
	// REQUIRED; Array of queries.
	Value []*Query `json:"value,omitempty"`

	// READ-ONLY; URL to fetch the next set of queries.
	NextLink *string `json:"nextLink,omitempty" azure:"ro"`
}

// MarshalJSON implements the json.Marshaller interface for type QueryList.
func (q QueryList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// QueryProperties - Describes Query properties
...
func (q QueryProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "correlationId", q.CorrelationID)
	populateTimeRFC3339(objectMap, "created", q.Created)
	populate(objectMap, "createdBy", q.CreatedBy)
	populate(objectMap, "documentType", q.DocumentType)
	populate(objectMap, "executionResult", q.ExecutionResult)
	populate(objectMap, "kustoQueryLanguage", q.KustoQueryLanguage)
	populate(objectMap, "naturalLanguage", q.NaturalLanguage)
	populate(objectMap, "queryId", q.QueryID)
	populateTimeRFC3339(objectMap, "updated", q.Updated)
	populate(objectMap, "updatedBy", q.UpdatedBy)
	return json.Marshal(objectMap)
}
...
func (q *QueryProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "correlationId":
			err = unpopulate(val, &q.CorrelationID)
			delete(rawMsg, key)
		case "created":
			err = unpopulateTimeRFC3339(val, &q.Created)
			delete(rawMsg, key)
		case "createdBy":
			err = unpopulate(val, &q.CreatedBy)
			delete(rawMsg, key)
		case "documentType":
			err = unpopulate(val, &q.DocumentType)
			delete(rawMsg, key)
		case "executionResult":
			err = unpopulate(val, &q.ExecutionResult)
			delete(rawMsg, key)
		case "kustoQueryLanguage":
			err = unpopulate(val, &q.KustoQueryLanguage)
			delete(rawMsg, key)
		case "naturalLanguage":
			err = unpopulate(val, &q.NaturalLanguage)
			delete(rawMsg, key)
		case "queryId":
			err = unpopulate(val, &q.QueryID)
			delete(rawMsg, key)
		case "updated":
			err = unpopulateTimeRFC3339(val, &q.Updated)
			delete(rawMsg, key)
		case "updatedBy":
			err = unpopulate(val, &q.UpdatedBy)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
