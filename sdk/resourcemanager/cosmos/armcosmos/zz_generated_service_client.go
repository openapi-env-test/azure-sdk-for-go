...
func (client *ServiceClient) BeginCreate(ctx context.Context, resourceGroupName string, accountName string, serviceName string, createUpdateParameters ServiceResourceCreateUpdateParameters, options *ServiceClientBeginCreateOptions) (ServiceClientCreatePollerResponse, error) {
	resp, err := client.create(ctx, resourceGroupName, accountName, serviceName, createUpdateParameters, options)
	if err != nil {
		return ServiceClientCreatePollerResponse{}, err
	}
	result := ServiceClientCreatePollerResponse{
		RawResponse: resp,
	}
	pt, err := armruntime.NewPoller("ServiceClient.Create", "", resp, client.pl)
	if err != nil {
		return ServiceClientCreatePollerResponse{}, err
	}
	result.Poller = &ServiceClientCreatePoller{
		pt: pt,
	}
	return result, nil
}
...
func (client *ServiceClient) BeginDelete(ctx context.Context, resourceGroupName string, accountName string, serviceName string, options *ServiceClientBeginDeleteOptions) (ServiceClientDeletePollerResponse, error) {
...
func (client *ServiceClient) List(ctx context.Context, resourceGroupName string, accountName string, options *ServiceClientListOptions) (ServiceClientListResponse, error) {
