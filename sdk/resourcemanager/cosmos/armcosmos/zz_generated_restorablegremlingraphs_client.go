...
func NewRestorableGremlinGraphsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *RestorableGremlinGraphsClient {
...
// method.
func (client *RestorableGremlinGraphsClient) List(ctx context.Context, location string, instanceID string, options *RestorableGremlinGraphsClientListOptions) (RestorableGremlinGraphsClientListResponse, error) {
...
func (client *RestorableGremlinGraphsClient) listHandleResponse(resp *http.Response) (RestorableGremlinGraphsClientListResponse, error) {
	result := RestorableGremlinGraphsClientListResponse{RawResponse: resp}
