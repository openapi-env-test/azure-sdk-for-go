...
// MarshalJSON is the custom marshaler for LogSpecifications.
func (ls LogSpecifications) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for MetricDimensions.
func (md MetricDimensions) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for MetricSpecifications.
func (ms MetricSpecifications) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for OperationDetailPropertiesServiceSpecification.
func (odS OperationDetailPropertiesServiceSpecification) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
