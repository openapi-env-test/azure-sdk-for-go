...
// MarshalJSON is the custom marshaler for GatewayError.
func (ge GatewayError) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for OperationPropertiesServiceSpecification.
func (oS OperationPropertiesServiceSpecification) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
