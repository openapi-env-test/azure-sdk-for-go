...
const (
	// Any ...
	Any AllowedEndpointRecordType = "Any"
	// DomainName ...
	DomainName AllowedEndpointRecordType = "DomainName"
	// IPv4Address ...
	IPv4Address AllowedEndpointRecordType = "IPv4Address"
	// IPv6Address ...
	IPv6Address AllowedEndpointRecordType = "IPv6Address"
)
...
func PossibleAllowedEndpointRecordTypeValues() []AllowedEndpointRecordType {
	return []AllowedEndpointRecordType{Any, DomainName, IPv4Address, IPv6Address}
}
