...
type AutoScaleVCoreSku struct {
	...
	Name *string `json:"name,omitempty"`
	// Tier - The name of the Azure pricing tier to which the SKU applies. Possible values include: 'AutoScale'
...
type CapacitySku struct {
	// Name - Name of the SKU level.
	Name *string `json:"name,omitempty"`
	// Tier - The name of the Azure pricing tier to which the SKU applies. Possible values include: 'PBIEAzure', 'Premium', 'AutoPremiumHost'
...
type DedicatedCapacityMutableProperties struct {
	...
	// Mode - The capacity mode. Possible values include: 'Gen1', 'Gen2'
