...
type AccountClientAPI interface {
	...
	ListOutboundNetworkDependenciesEndpoints(ctx context.Context, resourceGroupName string, accountName string) (result batch.OutboundEnvironmentEndpointCollectionPage, err error)
	ListOutboundNetworkDependenciesEndpointsComplete(ctx context.Context, resourceGroupName string, accountName string) (result batch.OutboundEnvironmentEndpointCollectionIterator, err error)
...
type LocationClientAPI interface {
	...
	ListSupportedCloudServiceSkus(ctx context.Context, locationName string, maxresults *int32, filter string) (result batch.SupportedSkusResultPage, err error)
	ListSupportedCloudServiceSkusComplete(ctx context.Context, locationName string, maxresults *int32, filter string) (result batch.SupportedSkusResultIterator, err error)
	ListSupportedVirtualMachineSkus(ctx context.Context, locationName string, maxresults *int32, filter string) (result batch.SupportedSkusResultPage, err error)
	ListSupportedVirtualMachineSkusComplete(ctx context.Context, locationName string, maxresults *int32, filter string) (result batch.SupportedSkusResultIterator, err error)
}
