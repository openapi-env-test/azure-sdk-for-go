...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/batch/mgmt/2021-01-01/batch"
...
type AccountIdentity struct {
	...
	UserAssignedIdentities map[string]*AccountIdentityUserAssignedIdentitiesValue `json:"userAssignedIdentities"`
}
...
// AccountIdentityUserAssignedIdentitiesValue ...
type AccountIdentityUserAssignedIdentitiesValue struct {
...
type PoolIdentity struct {
	...
	// UserAssignedIdentities - The list of user identities associated with the Batch pool. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
	UserAssignedIdentities map[string]*PoolIdentityUserAssignedIdentitiesValue `json:"userAssignedIdentities"`
}
...
// PoolIdentityUserAssignedIdentitiesValue ...
type PoolIdentityUserAssignedIdentitiesValue struct {
	// PrincipalID - READ-ONLY; The principal id of user assigned identity.
	PrincipalID *string `json:"principalId,omitempty"`
	// ClientID - READ-ONLY; The client id of user assigned identity.
	ClientID *string `json:"clientId,omitempty"`
