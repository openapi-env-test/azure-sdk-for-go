...
// IdentityTypeWithNone enumerates the values for identity type with none.
type IdentityTypeWithNone string

const (
	// None ...
	None IdentityTypeWithNone = "None"
	// SystemAssigned ...
	SystemAssigned IdentityTypeWithNone = "SystemAssigned"
	// UserAssigned ...
	UserAssigned IdentityTypeWithNone = "UserAssigned"
)

// PossibleIdentityTypeWithNoneValues returns an array of possible values for the IdentityTypeWithNone const type.
func PossibleIdentityTypeWithNoneValues() []IdentityTypeWithNone {
	return []IdentityTypeWithNone{None, SystemAssigned, UserAssigned}
}
