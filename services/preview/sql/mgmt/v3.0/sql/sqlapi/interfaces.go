...
// BreakingChangeManagedDatabasesClientAPI contains the set of methods on the BreakingChangeManagedDatabasesClient type.
type BreakingChangeManagedDatabasesClientAPI interface {
	Delete(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string) (result sql.BreakingChangeManagedDatabasesDeleteFuture, err error)
}

var _ BreakingChangeManagedDatabasesClientAPI = (*sql.BreakingChangeManagedDatabasesClient)(nil)
