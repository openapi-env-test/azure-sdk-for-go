...
type DatabaseSQLVulnerabilityAssessmentBaselinesClientAPI interface {
	...
	CreateOrUpdate1(ctx context.Context, resourceGroupName string, serverName string, parameters sql.DatabaseSQLVulnerabilityAssessmentRuleBaselineListInput) (result sql.DatabaseSQLVulnerabilityAssessmentBaselineSet, err error)
...
type DatabaseSQLVulnerabilityAssessmentRuleBaselinesClientAPI interface {
	...
	Delete1(ctx context.Context, resourceGroupName string, serverName string, ruleID string) (result autorest.Response, err error)
