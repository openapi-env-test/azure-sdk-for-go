...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/storage/mgmt/2020-08-preview/storage"
...
type DeletedAccountsClientAPI interface {
	List(ctx context.Context) (result storage.DeletedAccountListResult, err error)
}
