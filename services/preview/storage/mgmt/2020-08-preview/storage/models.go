...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/storage/mgmt/2020-08-preview/storage"
...
type DeletedAccountProperties struct {
	// Key - READ-ONLY; key of the deleted account
	Key *string `json:"key,omitempty"`
	// Name - READ-ONLY; name of the deleted account
	Name *string `json:"name,omitempty"`
	// Location - READ-ONLY; location of the deleted account
	Location *string `json:"location,omitempty"`
	// Subscription - READ-ONLY; subscription of the deleted account
	Subscription *string `json:"subscription,omitempty"`
	// ResourceGroupName - READ-ONLY; resource group of the deleted account
