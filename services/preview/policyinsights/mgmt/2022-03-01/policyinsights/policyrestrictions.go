...
func NewPolicyRestrictionsClient(subscriptionID string) PolicyRestrictionsClient {
	return NewPolicyRestrictionsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}
...
// stack).
func NewPolicyRestrictionsClientWithBaseURI(baseURI string, subscriptionID string) PolicyRestrictionsClient {
	return PolicyRestrictionsClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client PolicyRestrictionsClient) CheckAtManagementGroupScope(ctx context.Context, managementGroupID string, parameters CheckManagementGroupRestrictionsRequest) (result CheckRestrictionsResult, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PolicyRestrictionsClient.CheckAtManagementGroupScope")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.ResourceDetails", Name: validation.Null, Rule: false,
		...
		return result, validation.NewError("policyinsights.PolicyRestrictionsClient", "CheckAtManagementGroupScope", err.Error())
	}

	req, err := client.CheckAtManagementGroupScopePreparer(ctx, managementGroupID, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyinsights.PolicyRestrictionsClient", "CheckAtManagementGroupScope", nil, "Failure preparing request")
		return
	}

	resp, err := client.CheckAtManagementGroupScopeSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "policyinsights.PolicyRestrictionsClient", "CheckAtManagementGroupScope", resp, "Failure sending request")
		return
	}

	result, err = client.CheckAtManagementGroupScopeResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyinsights.PolicyRestrictionsClient", "CheckAtManagementGroupScope", resp, "Failure responding to request")
		return
	}
...
// CheckAtManagementGroupScopePreparer prepares the CheckAtManagementGroupScope request.
func (client PolicyRestrictionsClient) CheckAtManagementGroupScopePreparer(ctx context.Context, managementGroupID string, parameters CheckManagementGroupRestrictionsRequest) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/providers/{managementGroupsNamespace}/managementGroups/{managementGroupId}/providers/Microsoft.PolicyInsights/checkPolicyRestrictions", pathParameters),
		autorest.WithJSON(parameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// CheckAtManagementGroupScopeSender sends the CheckAtManagementGroupScope request. The method will close the
// http.Response Body if it receives an error.
func (client PolicyRestrictionsClient) CheckAtManagementGroupScopeSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
}

// CheckAtManagementGroupScopeResponder handles the response to the CheckAtManagementGroupScope request. The method always
// closes the http.Response Body.
func (client PolicyRestrictionsClient) CheckAtManagementGroupScopeResponder(resp *http.Response) (result CheckRestrictionsResult, err error) {
...
// parameters - the check policy restrictions parameters.
func (client PolicyRestrictionsClient) CheckAtResourceGroupScope(ctx context.Context, resourceGroupName string, parameters CheckRestrictionsRequest) (result CheckRestrictionsResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.CheckAtResourceGroupScopePreparer(ctx, resourceGroupName, parameters)
	if err != nil {
...
func (client PolicyRestrictionsClient) CheckAtResourceGroupScopePreparer(ctx context.Context, resourceGroupName string, parameters CheckRestrictionsRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// Parameters:
// parameters - the check policy restrictions parameters.
func (client PolicyRestrictionsClient) CheckAtSubscriptionScope(ctx context.Context, parameters CheckRestrictionsRequest) (result CheckRestrictionsResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.CheckAtSubscriptionScopePreparer(ctx, parameters)
	if err != nil {
...
func (client PolicyRestrictionsClient) CheckAtSubscriptionScopePreparer(ctx context.Context, parameters CheckRestrictionsRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
