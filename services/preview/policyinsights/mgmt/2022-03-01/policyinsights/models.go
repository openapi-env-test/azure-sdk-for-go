...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/policyinsights/mgmt/2022-03-01/policyinsights"
...
// CheckManagementGroupRestrictionsRequest the check policy restrictions parameters describing the resource
...
type RemediationProperties struct {
	...
	// StatusMessage - READ-ONLY; The remediation status message. Provides additional details regarding the state of the remediation.
	StatusMessage *string `json:"statusMessage,omitempty"`
	// CorrelationID - READ-ONLY; The remediation correlation Id. Can be used to find events related to the remediation in the activity log.
...
func (rp RemediationProperties) MarshalJSON() ([]byte, error) {
	...
	if rp.ResourceCount != nil {
		objectMap["resourceCount"] = rp.ResourceCount
	}
	if rp.ParallelDeployments != nil {
		objectMap["parallelDeployments"] = rp.ParallelDeployments
	}
	if rp.FailureThreshold != nil {
		objectMap["failureThreshold"] = rp.FailureThreshold
	}
	return json.Marshal(objectMap)
}
