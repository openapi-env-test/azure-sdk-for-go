...
func NewAttestationsClient(subscriptionID string) AttestationsClient {
	return NewAttestationsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}
...
func NewAttestationsClientWithBaseURI(baseURI string, subscriptionID string) AttestationsClient {
	return AttestationsClient{NewWithBaseURI(baseURI, subscriptionID)}
}
