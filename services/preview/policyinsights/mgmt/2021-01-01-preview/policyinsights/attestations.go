...
func NewAttestationsClient(subscriptionID string, subscriptionID1 string) AttestationsClient {
	return NewAttestationsClientWithBaseURI(DefaultBaseURI, subscriptionID, subscriptionID1)
}
...
func NewAttestationsClientWithBaseURI(baseURI string, subscriptionID string, subscriptionID1 string) AttestationsClient {
	return AttestationsClient{NewWithBaseURI(baseURI, subscriptionID, subscriptionID1)}
}
...
func (client AttestationsClient) CreateOrUpdateAtResource(ctx context.Context, resourceID string, attestationName string, parameters Attestation) (result AttestationsCreateOrUpdateAtResourceFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyinsights.AttestationsClient", "CreateOrUpdateAtResource", result.Response(), "Failure sending request")
		return
	}
...
// attestationName - the name of the attestation.
// parameters - the attestation parameters.
func (client AttestationsClient) CreateOrUpdateAtResourceGroup(ctx context.Context, resourceGroupName string, attestationName string, parameters Attestation) (result AttestationsCreateOrUpdateAtResourceGroupFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.CreateOrUpdateAtResourceGroupPreparer(ctx, resourceGroupName, attestationName, parameters)
	if err != nil {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyinsights.AttestationsClient", "CreateOrUpdateAtResourceGroup", result.Response(), "Failure sending request")
		return
	}
...
func (client AttestationsClient) CreateOrUpdateAtResourceGroupPreparer(ctx context.Context, resourceGroupName string, attestationName string, parameters Attestation) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"attestationName":   autorest.Encode("path", attestationName),
...
// attestationName - the name of the attestation.
// parameters - the attestation parameters.
func (client AttestationsClient) CreateOrUpdateAtSubscription(ctx context.Context, attestationName string, parameters Attestation) (result AttestationsCreateOrUpdateAtSubscriptionFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.CreateOrUpdateAtSubscriptionPreparer(ctx, attestationName, parameters)
	if err != nil {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "policyinsights.AttestationsClient", "CreateOrUpdateAtSubscription", result.Response(), "Failure sending request")
		return
	}
...
func (client AttestationsClient) CreateOrUpdateAtSubscriptionPreparer(ctx context.Context, attestationName string, parameters Attestation) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"attestationName": autorest.Encode("path", attestationName),
		"subscriptionId":  autorest.Encode("path", client.SubscriptionID),
	}
...
// resourceGroupName - the name of the resource group. The name is case insensitive.
// attestationName - the name of the attestation.
func (client AttestationsClient) DeleteAtResourceGroup(ctx context.Context, resourceGroupName string, attestationName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DeleteAtResourceGroupPreparer(ctx, resourceGroupName, attestationName)
	if err != nil {
...
func (client AttestationsClient) DeleteAtResourceGroupPreparer(ctx context.Context, resourceGroupName string, attestationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"attestationName":   autorest.Encode("path", attestationName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// Parameters:
// attestationName - the name of the attestation.
func (client AttestationsClient) DeleteAtSubscription(ctx context.Context, attestationName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DeleteAtSubscriptionPreparer(ctx, attestationName)
	if err != nil {
...
func (client AttestationsClient) DeleteAtSubscriptionPreparer(ctx context.Context, attestationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"attestationName": autorest.Encode("path", attestationName),
		"subscriptionId":  autorest.Encode("path", client.SubscriptionID),
	}
...
// resourceGroupName - the name of the resource group. The name is case insensitive.
// attestationName - the name of the attestation.
func (client AttestationsClient) GetAtResourceGroup(ctx context.Context, resourceGroupName string, attestationName string) (result Attestation, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetAtResourceGroupPreparer(ctx, resourceGroupName, attestationName)
	if err != nil {
...
func (client AttestationsClient) GetAtResourceGroupPreparer(ctx context.Context, resourceGroupName string, attestationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"attestationName":   autorest.Encode("path", attestationName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// Parameters:
// attestationName - the name of the attestation.
func (client AttestationsClient) GetAtSubscription(ctx context.Context, attestationName string) (result Attestation, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetAtSubscriptionPreparer(ctx, attestationName)
	if err != nil {
...
func (client AttestationsClient) GetAtSubscriptionPreparer(ctx context.Context, attestationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"attestationName": autorest.Encode("path", attestationName),
		"subscriptionId":  autorest.Encode("path", client.SubscriptionID),
	}
...
// top - maximum number of records to return.
// filter - oData filter expression.
func (client AttestationsClient) ListForResourceGroup(ctx context.Context, resourceGroupName string, top *int32, filter string) (result AttestationListResultPage, err error) {
	if tracing.IsEnabled() {
...
func (client AttestationsClient) ListForResourceGroupPreparer(ctx context.Context, resourceGroupName string, top *int32, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	}
...
func (client AttestationsClient) ListForResourceGroupComplete(ctx context.Context, resourceGroupName string, top *int32, filter string) (result AttestationListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AttestationsClient.ListForResourceGroup")
		defer func() {
			sc := -1
...
// top - maximum number of records to return.
// filter - oData filter expression.
func (client AttestationsClient) ListForSubscription(ctx context.Context, top *int32, filter string) (result AttestationListResultPage, err error) {
	if tracing.IsEnabled() {
...
func (client AttestationsClient) ListForSubscriptionPreparer(ctx context.Context, top *int32, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client AttestationsClient) ListForSubscriptionComplete(ctx context.Context, top *int32, filter string) (result AttestationListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AttestationsClient.ListForSubscription")
		defer func() {
			sc := -1
