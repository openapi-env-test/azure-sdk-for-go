...
func NewPolicyRestrictionsClient(subscriptionID string, subscriptionID1 string) PolicyRestrictionsClient {
	return NewPolicyRestrictionsClientWithBaseURI(DefaultBaseURI, subscriptionID, subscriptionID1)
}
...
// stack).
func NewPolicyRestrictionsClientWithBaseURI(baseURI string, subscriptionID string, subscriptionID1 string) PolicyRestrictionsClient {
	return PolicyRestrictionsClient{NewWithBaseURI(baseURI, subscriptionID, subscriptionID1)}
}
