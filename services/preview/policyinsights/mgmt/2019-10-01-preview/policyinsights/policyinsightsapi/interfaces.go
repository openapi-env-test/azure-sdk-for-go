...
type PolicyEventsClientAPI interface {
	...
	NextLink(ctx context.Context, nextLink string, skipToken string) (result policyinsights.PolicyEventsQueryResults, err error)
}
...
type PolicyStatesClientAPI interface {
	...
	NextLink(ctx context.Context, nextLink string, skipToken string) (result policyinsights.PolicyStatesQueryResults, err error)
