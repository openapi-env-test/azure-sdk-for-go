...
// pipelineName - the name of the Pipeline resource in ARM.
// createOperationParameters - the request payload to create the Pipeline.
...
func (client PipelinesClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, pipelineName string, createOperationParameters Pipeline) (*http.Request, error) {
	...
	createOperationParameters.SystemData = nil
...
// ListByResourceGroup lists all Pipelines under the specified resource group.
// Parameters:
// resourceGroupName - name of the resource group within the Azure subscription.
...
// ListBySubscription lists all Pipelines under the specified subscription.
...
// Update updates the properties of an Azure Pipeline. Currently, it is not supported on 'githubWorkflow' pipeline type
// and only tags can be updated for 'azurePipeline' pipeline type.
// Parameters:
// resourceGroupName - name of the resource group within the Azure subscription.
