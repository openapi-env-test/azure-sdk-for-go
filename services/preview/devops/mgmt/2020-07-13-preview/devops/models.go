...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/devops/mgmt/2020-07-13-preview/devops"
...
// AzurePipelineProperties custom properties of a Azure Pipeline.
type AzurePipelineProperties struct {
	// Organization - Reference to the Azure DevOps Organization containing the Pipeline. Required for 'azurePipeline' pipeline type.
	Organization *OrganizationReference `json:"organization,omitempty"`
	// Project - Reference to the Azure DevOps Project containing the Pipeline. Required for 'azurePipeline' pipeline type.
	Project *ProjectReference `json:"project,omitempty"`
	// PipelineID - READ-ONLY; Unique identifier of the Pipeline
	...
	// PipelineType - Possible values include: 'PipelineTypePipelineProperties', 'PipelineTypeAzurePipeline', 'PipelineTypeGithubWorkflow'
	PipelineType PipelineType `json:"pipelineType,omitempty"`
}

// MarshalJSON is the custom marshaler for AzurePipelineProperties.
func (app AzurePipelineProperties) MarshalJSON() ([]byte, error) {
	app.PipelineType = PipelineTypeAzurePipeline
	objectMap := make(map[string]interface{})
	if app.Organization != nil {
		objectMap["organization"] = app.Organization
	}
	if app.Project != nil {
		objectMap["project"] = app.Project
	}
	if app.BootstrapConfiguration != nil {
		objectMap["bootstrapConfiguration"] = app.BootstrapConfiguration
	}
	if app.PipelineType != "" {
		objectMap["pipelineType"] = app.PipelineType
	}
	return json.Marshal(objectMap)
}

// AsAzurePipelineProperties is the BasicPipelineProperties implementation for AzurePipelineProperties.
func (app AzurePipelineProperties) AsAzurePipelineProperties() (*AzurePipelineProperties, bool) {
	return &app, true
}

// AsGithubWorkflowProperties is the BasicPipelineProperties implementation for AzurePipelineProperties.
func (app AzurePipelineProperties) AsGithubWorkflowProperties() (*GithubWorkflowProperties, bool) {
	return nil, false
}

// AsPipelineProperties is the BasicPipelineProperties implementation for AzurePipelineProperties.
func (app AzurePipelineProperties) AsPipelineProperties() (*PipelineProperties, bool) {
	return nil, false
}

// AsBasicPipelineProperties is the BasicPipelineProperties implementation for AzurePipelineProperties.
func (app AzurePipelineProperties) AsBasicPipelineProperties() (BasicPipelineProperties, bool) {
	return &app, true
}

// BootstrapConfiguration configuration used to bootstrap a Pipeline.
type BootstrapConfiguration struct {
	// SourceRepository - Repository containing the source code for the pipeline. Currently only 'azurePipeline' pipeline type supports this.
	SourceRepository *CodeRepository `json:"sourceRepository,omitempty"`
...
// GithubWorkflowProperties custom properties of an Github Pipeline.
type GithubWorkflowProperties struct {
	// Repository - Contains the specifications of the repository to be created for generating the workflow. Required for 'githubWorkflow' pipeline type.
...
// MarshalJSON is the custom marshaler for GithubWorkflowProperties.
func (gwp GithubWorkflowProperties) MarshalJSON() ([]byte, error) {
	gwp.PipelineType = PipelineTypeGithubWorkflow
	objectMap := make(map[string]interface{})
	if gwp.Repository != nil {
		objectMap["repository"] = gwp.Repository
	}
	if gwp.BootstrapConfiguration != nil {
		objectMap["bootstrapConfiguration"] = gwp.BootstrapConfiguration
	}
	if gwp.PipelineType != "" {
		objectMap["pipelineType"] = gwp.PipelineType
	}
	return json.Marshal(objectMap)
}

// AsAzurePipelineProperties is the BasicPipelineProperties implementation for GithubWorkflowProperties.
func (gwp GithubWorkflowProperties) AsAzurePipelineProperties() (*AzurePipelineProperties, bool) {
	return nil, false
}

// AsGithubWorkflowProperties is the BasicPipelineProperties implementation for GithubWorkflowProperties.
func (gwp GithubWorkflowProperties) AsGithubWorkflowProperties() (*GithubWorkflowProperties, bool) {
	return &gwp, true
}

// AsPipelineProperties is the BasicPipelineProperties implementation for GithubWorkflowProperties.
func (gwp GithubWorkflowProperties) AsPipelineProperties() (*PipelineProperties, bool) {
	return nil, false
}

// AsBasicPipelineProperties is the BasicPipelineProperties implementation for GithubWorkflowProperties.
func (gwp GithubWorkflowProperties) AsBasicPipelineProperties() (BasicPipelineProperties, bool) {
	return &gwp, true
}
...
// Pipeline pipeline used to configure Continuous Integration (CI) & Continuous Delivery (CD) for Azure
// resources.
type Pipeline struct {
	autorest.Response `json:"-"`
	// BasicPipelineProperties - Custom properties of the Pipeline.
	BasicPipelineProperties `json:"properties,omitempty"`
	// SystemData - READ-ONLY; The system metadata pertaining to this resource.
...
func (p Pipeline) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	objectMap["properties"] = p.BasicPipelineProperties
	if p.Tags != nil {
...
func (p *Pipeline) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				basicPipelineProperties, err := unmarshalBasicPipelineProperties(*v)
				if err != nil {
					return err
				}
				p.BasicPipelineProperties = basicPipelineProperties
			}
		case "systemData":
			if v != nil {
...
// PipelineListResult result of a request to list all Pipelines under a given scope.
...
// BasicPipelineProperties custom properties of a Pipeline.
type BasicPipelineProperties interface {
	AsAzurePipelineProperties() (*AzurePipelineProperties, bool)
	AsGithubWorkflowProperties() (*GithubWorkflowProperties, bool)
	AsPipelineProperties() (*PipelineProperties, bool)
}
...
func unmarshalBasicPipelineProperties(body []byte) (BasicPipelineProperties, error) {
	...
	switch m["pipelineType"] {
	case string(PipelineTypeAzurePipeline):
		var app AzurePipelineProperties
		err := json.Unmarshal(body, &app)
		return app, err
	case string(PipelineTypeGithubWorkflow):
		var gwp GithubWorkflowProperties
		err := json.Unmarshal(body, &gwp)
		return gwp, err
	default:
		var pp PipelineProperties
		err := json.Unmarshal(body, &pp)
		return pp, err
	}
}
func unmarshalBasicPipelinePropertiesArray(body []byte) ([]BasicPipelineProperties, error) {
	...
	ppArray := make([]BasicPipelineProperties, len(rawMessages))

	for index, rawMessage := range rawMessages {
		pp, err := unmarshalBasicPipelineProperties(*rawMessage)
		if err != nil {
			return nil, err
		}
		ppArray[index] = pp
...
func (pp PipelineProperties) MarshalJSON() ([]byte, error) {
	pp.PipelineType = PipelineTypePipelineProperties
	objectMap := make(map[string]interface{})
	if pp.BootstrapConfiguration != nil {
		objectMap["bootstrapConfiguration"] = pp.BootstrapConfiguration
	}
	if pp.PipelineType != "" {
		objectMap["pipelineType"] = pp.PipelineType
	}
	return json.Marshal(objectMap)
}

// AsAzurePipelineProperties is the BasicPipelineProperties implementation for PipelineProperties.
func (pp PipelineProperties) AsAzurePipelineProperties() (*AzurePipelineProperties, bool) {
	return nil, false
}

// AsGithubWorkflowProperties is the BasicPipelineProperties implementation for PipelineProperties.
func (pp PipelineProperties) AsGithubWorkflowProperties() (*GithubWorkflowProperties, bool) {
	return nil, false
}

// AsPipelineProperties is the BasicPipelineProperties implementation for PipelineProperties.
func (pp PipelineProperties) AsPipelineProperties() (*PipelineProperties, bool) {
	return &pp, true
}

// AsBasicPipelineProperties is the BasicPipelineProperties implementation for PipelineProperties.
func (pp PipelineProperties) AsBasicPipelineProperties() (BasicPipelineProperties, bool) {
	return &pp, true
}
