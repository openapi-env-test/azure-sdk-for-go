...
type AgreementProperties struct {
	...
	// BillingProfileInfo - READ-ONLY; The list of billing profiles associated with agreement and present only for specific agreements.
	BillingProfileInfo *ProfileInfo `json:"billingProfileInfo,omitempty"`
...
// MarshalJSON is the custom marshaler for OperationsErrorDetails.
func (oed OperationsErrorDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}

// OperationsErrorResponse error response indicates that the service is not able to process the incoming
...
// ProfileInfo details about billing profile associated with agreement and available only for specific
// agreements.
type ProfileInfo struct {
	// BillingProfileID - The unique identifier for the billing profile.
	BillingProfileID *string `json:"billingProfileId,omitempty"`
	// BillingProfileDisplayName - The name of the billing profile
	BillingProfileDisplayName *string `json:"billingProfileDisplayName,omitempty"`
	// IndirectRelationshipOrganizationName - Billing account name. This property is available for a specific type of agreement.
