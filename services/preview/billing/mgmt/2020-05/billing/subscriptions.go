...
// billing profile as the existing invoice section. This operation is supported only for products that are purchased
...
func (client SubscriptionsClient) Move(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters TransferBillingSubscriptionRequestProperties) (result SubscriptionsMoveFuture, err error) {
	if tracing.IsEnabled() {
...
func (client SubscriptionsClient) MovePreparer(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters TransferBillingSubscriptionRequestProperties) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountName":      autorest.Encode("path", billingAccountName),
		"billingSubscriptionName": autorest.Encode("path", billingSubscriptionName),
	}
...
func (client SubscriptionsClient) Update(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters Subscription) (result Subscription, err error) {
	if tracing.IsEnabled() {
...
func (client SubscriptionsClient) ValidateMove(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters TransferBillingSubscriptionRequestProperties) (result ValidateSubscriptionTransferEligibilityResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ValidateMovePreparer(ctx, billingAccountName, billingSubscriptionName, parameters)
	if err != nil {
...
func (client SubscriptionsClient) ValidateMovePreparer(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters TransferBillingSubscriptionRequestProperties) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountName":      autorest.Encode("path", billingAccountName),
		"billingSubscriptionName": autorest.Encode("path", billingSubscriptionName),
	}
