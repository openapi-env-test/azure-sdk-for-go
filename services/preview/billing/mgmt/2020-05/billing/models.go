...
const (
	// Off ...
	Off ProfileSpendingLimit = "Off"
	// On ...
	On ProfileSpendingLimit = "On"
)
...
func PossibleProfileSpendingLimitValues() []ProfileSpendingLimit {
	return []ProfileSpendingLimit{Off, On}
}
...
// DepartmentListResult the list of departments.
...
type PropertyProperties struct {
	...
	// BillingProfileSpendingLimit - READ-ONLY; The billing profile spending limit. Possible values include: 'Off', 'On'
...
type RoleAssignmentProperties struct {
	...
	PrincipalID *string `json:"principalId,omitempty"`
	// RoleDefinitionName - READ-ONLY; The ID of the role definition.
...
// UpdateAutoRenewOperation result of the update auto renew operation
type UpdateAutoRenewOperation struct {
	autorest.Response `json:"-"`
	// UpdateAutoRenewOperationProperties - Summary of update auto renew operation properties
	*UpdateAutoRenewOperationProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for UpdateAutoRenewOperation.
func (uaro UpdateAutoRenewOperation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if uaro.UpdateAutoRenewOperationProperties != nil {
		objectMap["properties"] = uaro.UpdateAutoRenewOperationProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for UpdateAutoRenewOperation struct.
func (uaro *UpdateAutoRenewOperation) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var updateAutoRenewOperationProperties UpdateAutoRenewOperationProperties
				err = json.Unmarshal(*v, &updateAutoRenewOperationProperties)
				if err != nil {
					return err
				}
				uaro.UpdateAutoRenewOperationProperties = &updateAutoRenewOperationProperties
			}
		}
	}
...
type UpdateAutoRenewOperationProperties struct {
	// EndDate - The date at which the product will be canceled.
	EndDate *date.Time `json:"endDate,omitempty"`
}

// UpdateAutoRenewRequest request parameters to update auto renew settings for a product.
type UpdateAutoRenewRequest struct {
	// AutoRenew - The flag that determines the auto-renew settings for a product. Possible values include: 'True', 'False'
