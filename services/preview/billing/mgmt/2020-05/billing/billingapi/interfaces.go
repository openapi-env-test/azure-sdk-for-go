...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/billing/mgmt/2020-05/billing"
)
...
type SubscriptionsClientAPI interface {
	...
	Move(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters billing.TransferBillingSubscriptionRequestProperties) (result billing.SubscriptionsMoveFuture, err error)
	Update(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters billing.Subscription) (result billing.Subscription, err error)
	ValidateMove(ctx context.Context, billingAccountName string, billingSubscriptionName string, parameters billing.TransferBillingSubscriptionRequestProperties) (result billing.ValidateSubscriptionTransferEligibilityResult, err error)
}
...
type ProductsClientAPI interface {
	...
	UpdateAutoRenew(ctx context.Context, billingAccountName string, productName string, body billing.UpdateAutoRenewRequest) (result billing.UpdateAutoRenewOperation, err error)
...
type EnrollmentAccountsClientAPI interface {
	Get(ctx context.Context, billingAccountName string, enrollmentAccountName string, expand string, filter string) (result billing.EnrollmentAccount, err error)
...
type RoleAssignmentsClientAPI interface {
	AddByBillingAccount(ctx context.Context, billingAccountName string, parameters billing.RoleAssignmentPayload) (result billing.RoleAssignmentListResult, err error)
	AddByBillingProfile(ctx context.Context, billingAccountName string, billingProfileName string, parameters billing.RoleAssignmentPayload) (result billing.RoleAssignmentListResult, err error)
	AddByInvoiceSection(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, parameters billing.RoleAssignmentPayload) (result billing.RoleAssignmentListResult, err error)
