...
// Get gets a department by ID. The operation is supported only for billing accounts with agreement type Enterprise
// Agreement.
// Parameters:
// billingAccountName - the ID that uniquely identifies a billing account.
// departmentName - the ID that uniquely identifies a department.
// expand - may be used to expand the enrollment accounts.
// filter - may be used to filter by department name. The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and
...
// ListByBillingAccountName lists the departments that a user has access to. The operation is supported only for
