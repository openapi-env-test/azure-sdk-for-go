...
// FullBackup creates full backup using user provided SAS token to Azure Blob Storage container
// Parameters:
// vaultBaseURL - the vault name, for example https://myvault.vault.azure.net.
// azureStorageBlobContainerURI - azure Blob shared access signature token pointing to a valid Azure Blob
// container where the full backup needs to be stored. This token needs to be valid for at least next 24 hours
// from the time of making this call
...
// FullBackupStatus returns the full backup operation status
// Parameters:
// vaultBaseURL - the vault name, for example https://myvault.vault.azure.net.
// jobID - job Id returned part of the creation of backup
...
// FullRestoreOperationMethod restores all key materials using the SAS token to the previously stored Azure Storage
// backup folder
// Parameters:
// vaultBaseURL - the vault name, for example https://myvault.vault.azure.net.
// restoreBlobDetails - azure blob SAS token to the folder where the previous successful full backup was stored
...
// FullRestoreStatus returns the full restore operation status from a user provided valid backup
// Parameters:
// vaultBaseURL - the vault name, for example https://myvault.vault.azure.net.
// jobID - job Id returned part of the full restore operation
