...
// KeyReleaseConditionCondition enumerates the values for key release condition condition.
type KeyReleaseConditionCondition string

const (
	// Equals equals comparison.
	Equals KeyReleaseConditionCondition = "equals"
)

// PossibleKeyReleaseConditionConditionValues returns an array of possible values for the KeyReleaseConditionCondition const type.
func PossibleKeyReleaseConditionConditionValues() []KeyReleaseConditionCondition {
	return []KeyReleaseConditionCondition{Equals}
}

// KeyReleasePolicyVersion enumerates the values for key release policy version.
type KeyReleasePolicyVersion string

const (
	// ZeroFullStopTwo Schema version 0.2
	ZeroFullStopTwo KeyReleasePolicyVersion = "0.2"
)

// PossibleKeyReleasePolicyVersionValues returns an array of possible values for the KeyReleasePolicyVersion const type.
func PossibleKeyReleasePolicyVersionValues() []KeyReleasePolicyVersion {
	return []KeyReleasePolicyVersion{ZeroFullStopTwo}
}
...
// SecurityDomainJSONWebKey enumerates the values for security domain json web key.
type SecurityDomainJSONWebKey string

const (
	// SecurityDomainJSONWebKeyRSA ...
	SecurityDomainJSONWebKeyRSA SecurityDomainJSONWebKey = "RSA"
	// SecurityDomainJSONWebKeyRSAHSM ...
	SecurityDomainJSONWebKeyRSAHSM SecurityDomainJSONWebKey = "RSA-HSM"
)

// PossibleSecurityDomainJSONWebKeyValues returns an array of possible values for the SecurityDomainJSONWebKey const type.
func PossibleSecurityDomainJSONWebKeyValues() []SecurityDomainJSONWebKey {
	return []SecurityDomainJSONWebKey{SecurityDomainJSONWebKeyRSA, SecurityDomainJSONWebKeyRSAHSM}
}
