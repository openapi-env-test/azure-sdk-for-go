...
type FullBackupOperation struct {
	...
	// AzureStorageBlobContainerURI - The Azure Blob storage folder Uri which contains the full backup
...
type RestoreOperationParameters struct {
	...
	// FolderToRestore - Folder name of the blob where the previous successful full backup is stored
...
type SASTokenParameter struct {
	...
	// Token - Azure Blob storage SAS token pointing to the azure blob storage container
