...
// selectParameter - oData select. Optional.
// expand - oData expand. Optional.
func (client AlertsClient) ListResourceGroupLevelByRegion(ctx context.Context, resourceGroupName string, filter string, selectParameter string, expand string) (result AlertListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListResourceGroupLevelByRegionPreparer(ctx, resourceGroupName, filter, selectParameter, expand)
	if err != nil {
...
func (client AlertsClient) ListResourceGroupLevelByRegionPreparer(ctx context.Context, resourceGroupName string, filter string, selectParameter string, expand string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"ascLocation":       autorest.Encode("path", client.AscLocation),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
func (client AlertsClient) ListResourceGroupLevelByRegionComplete(ctx context.Context, resourceGroupName string, filter string, selectParameter string, expand string) (result AlertListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AlertsClient.ListResourceGroupLevelByRegion")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListResourceGroupLevelByRegion(ctx, resourceGroupName, filter, selectParameter, expand)
	return
}
...
// selectParameter - oData select. Optional.
// expand - oData expand. Optional.
func (client AlertsClient) ListSubscriptionLevelByRegion(ctx context.Context, filter string, selectParameter string, expand string) (result AlertListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListSubscriptionLevelByRegionPreparer(ctx, filter, selectParameter, expand)
	if err != nil {
...
func (client AlertsClient) ListSubscriptionLevelByRegionPreparer(ctx context.Context, filter string, selectParameter string, expand string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"ascLocation":    autorest.Encode("path", client.AscLocation),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client AlertsClient) ListSubscriptionLevelByRegionComplete(ctx context.Context, filter string, selectParameter string, expand string) (result AlertListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AlertsClient.ListSubscriptionLevelByRegion")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListSubscriptionLevelByRegion(ctx, filter, selectParameter, expand)
	return
}
