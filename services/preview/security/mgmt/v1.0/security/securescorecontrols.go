...
// List get all secure score controls on specific initiatives inside a scope
// Parameters:
...
func (client SecureScoreControlsClient) List(ctx context.Context, scope string, expand ExpandControlsEnum) (result SecureScoreControlListPage, err error) {
...
func (client SecureScoreControlsClient) ListPreparer(ctx context.Context, scope string, expand ExpandControlsEnum) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{scope}/providers/Microsoft.Security/secureScoreControls", pathParameters),
...
func (client SecureScoreControlsClient) ListComplete(ctx context.Context, scope string, expand ExpandControlsEnum) (result SecureScoreControlListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SecureScoreControlsClient.List")
		defer func() {
			sc := -1
...
// ListBySecureScore get all secure score controls on specific initiatives inside a scope
// Parameters:
// scope - scope of the query, can be subscription (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or
// management group (/providers/Microsoft.Management/managementGroups/mgName).
// secureScoreName - the secure score initiative name
// expand - oData expand. Optional.
func (client SecureScoreControlsClient) ListBySecureScore(ctx context.Context, scope string, secureScoreName string, expand ExpandControlsEnum) (result SecureScoreControlListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListBySecureScorePreparer(ctx, scope, secureScoreName, expand)
	if err != nil {
...
func (client SecureScoreControlsClient) ListBySecureScorePreparer(ctx context.Context, scope string, secureScoreName string, expand ExpandControlsEnum) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"scope":           autorest.Encode("path", scope),
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/{scope}/providers/Microsoft.Security/secureScores/{secureScoreName}/secureScoreControls", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client SecureScoreControlsClient) ListBySecureScoreComplete(ctx context.Context, scope string, secureScoreName string, expand ExpandControlsEnum) (result SecureScoreControlListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SecureScoreControlsClient.ListBySecureScore")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListBySecureScore(ctx, scope, secureScoreName, expand)
	return
}
