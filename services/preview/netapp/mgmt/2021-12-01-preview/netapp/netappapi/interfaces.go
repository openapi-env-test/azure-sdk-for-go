...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/netapp/mgmt/2021-12-01-preview/netapp"
)
...
type ResourceClientAPI interface {
	...
	QueryNetworkSiblingSet(ctx context.Context, body netapp.QueryNetworkSiblingSetRequest, location string) (result netapp.NetworkSiblingSet, err error)
	QueryRegionInfo(ctx context.Context, location string) (result netapp.RegionInfo, err error)
	UpdateNetworkSiblingSet(ctx context.Context, body netapp.UpdateNetworkSiblingSetRequest, location string) (result netapp.ResourceUpdateNetworkSiblingSetFuture, err error)
}
