...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/netapp/mgmt/2021-12-01-preview/netapp"
...
type NetworkSiblingSet struct {
	...
	// NetworkFeatures - Possible values include: 'Basic', 'Standard', 'BasicStandard', 'StandardBasic'
	NetworkFeatures NetworkFeatures `json:"networkFeatures,omitempty"`
	// ProvisioningState - Possible values include: 'ProvisioningStateSucceeded', 'ProvisioningStateFailed', 'ProvisioningStateCanceled', 'ProvisioningStateUpdating'
	ProvisioningState ProvisioningState `json:"provisioningState,omitempty"`
	// NicInfoList - List of NIC information
...
type RegionInfo struct {
	...
	// AvailabilityZoneMappings - Provides logical availability zone mappings for the subscription for a region.
...
type RegionInfoAvailabilityZoneMappingsItem struct {
	// AvailabilityZone - Logical availability zone.
	AvailabilityZone *string `json:"availabilityZone,omitempty"`
	// IsAvailable - Available availability zone
	IsAvailable *bool `json:"isAvailable,omitempty"`
}
...
// ResourceUpdateNetworkSiblingSetFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type ResourceUpdateNetworkSiblingSetFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(ResourceClient) (NetworkSiblingSet, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *ResourceUpdateNetworkSiblingSetFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for ResourceUpdateNetworkSiblingSetFuture.Result.
func (future *ResourceUpdateNetworkSiblingSetFuture) result(client ResourceClient) (nss NetworkSiblingSet, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.ResourceUpdateNetworkSiblingSetFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		nss.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.ResourceUpdateNetworkSiblingSetFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if nss.Response.Response, err = future.GetResult(sender); err == nil && nss.Response.Response.StatusCode != http.StatusNoContent {
		nss, err = client.UpdateNetworkSiblingSetResponder(nss.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "netapp.ResourceUpdateNetworkSiblingSetFuture", "Result", nss.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type UpdateNetworkSiblingSetRequest struct {
	...
	SubnetID                 *string `json:"subnetId,omitempty"`
	NetworkSiblingSetStateID *string `json:"networkSiblingSetStateId,omitempty"`
	// NetworkFeatures - Network features available to the volume, some such. Possible values include: 'Basic', 'Standard', 'BasicStandard', 'StandardBasic'
	NetworkFeatures NetworkFeatures `json:"networkFeatures,omitempty"`
}
