...
const (
	...
	// BasicStandard Updating from Basic to Standard network features.
	BasicStandard NetworkFeatures = "Basic_Standard"
	// Standard Standard network features.
	Standard NetworkFeatures = "Standard"
	// StandardBasic Updating from Standard to Basic network features.
	StandardBasic NetworkFeatures = "Standard_Basic"
)
...
func PossibleNetworkFeaturesValues() []NetworkFeatures {
	return []NetworkFeatures{Basic, BasicStandard, Standard, StandardBasic}
}
