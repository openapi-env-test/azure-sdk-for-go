...
// location - the location
func (client ResourceClient) QueryNetworkSiblingSet(ctx context.Context, body QueryNetworkSiblingSetRequest, location string) (result NetworkSiblingSet, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ResourceClient.QueryNetworkSiblingSet")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: body,
			Constraints: []validation.Constraint{{Target: "body.NetworkSiblingSetID", Name: validation.Null, Rule: true, Chain: nil},
				{Target: "body.SubnetID", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("netapp.ResourceClient", "QueryNetworkSiblingSet", err.Error())
	}

	req, err := client.QueryNetworkSiblingSetPreparer(ctx, body, location)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "QueryNetworkSiblingSet", nil, "Failure preparing request")
		return
	}

	resp, err := client.QueryNetworkSiblingSetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "QueryNetworkSiblingSet", resp, "Failure sending request")
		return
	}

	result, err = client.QueryNetworkSiblingSetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "QueryNetworkSiblingSet", resp, "Failure responding to request")
		return
	}
...
// QueryNetworkSiblingSetPreparer prepares the QueryNetworkSiblingSet request.
func (client ResourceClient) QueryNetworkSiblingSetPreparer(ctx context.Context, body QueryNetworkSiblingSetRequest, location string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"location":       autorest.Encode("path", location),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.NetApp/locations/{location}/queryNetworkSiblingSet", pathParameters),
		autorest.WithJSON(body),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// QueryNetworkSiblingSetSender sends the QueryNetworkSiblingSet request. The method will close the
// http.Response Body if it receives an error.
func (client ResourceClient) QueryNetworkSiblingSetSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// QueryNetworkSiblingSetResponder handles the response to the QueryNetworkSiblingSet request. The method always
// closes the http.Response Body.
func (client ResourceClient) QueryNetworkSiblingSetResponder(resp *http.Response) (result NetworkSiblingSet, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
// Parameters:
// location - the location
func (client ResourceClient) QueryRegionInfo(ctx context.Context, location string) (result RegionInfo, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ResourceClient.QueryRegionInfo")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	req, err := client.QueryRegionInfoPreparer(ctx, location)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "QueryRegionInfo", nil, "Failure preparing request")
		return
	}

	resp, err := client.QueryRegionInfoSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "QueryRegionInfo", resp, "Failure sending request")
		return
	}

	result, err = client.QueryRegionInfoResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "QueryRegionInfo", resp, "Failure responding to request")
		return
	}
...
// QueryRegionInfoPreparer prepares the QueryRegionInfo request.
func (client ResourceClient) QueryRegionInfoPreparer(ctx context.Context, location string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"location":       autorest.Encode("path", location),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
// QueryRegionInfoSender sends the QueryRegionInfo request. The method will close the
// http.Response Body if it receives an error.
func (client ResourceClient) QueryRegionInfoSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// QueryRegionInfoResponder handles the response to the QueryRegionInfo request. The method always
// closes the http.Response Body.
func (client ResourceClient) QueryRegionInfoResponder(resp *http.Response) (result RegionInfo, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
// location - the location
func (client ResourceClient) UpdateNetworkSiblingSet(ctx context.Context, body UpdateNetworkSiblingSetRequest, location string) (result ResourceUpdateNetworkSiblingSetFuture, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ResourceClient.UpdateNetworkSiblingSet")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: body,
			Constraints: []validation.Constraint{{Target: "body.NetworkSiblingSetID", Name: validation.Null, Rule: true, Chain: nil},
				{Target: "body.SubnetID", Name: validation.Null, Rule: true, Chain: nil},
				{Target: "body.NetworkSiblingSetStateID", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("netapp.ResourceClient", "UpdateNetworkSiblingSet", err.Error())
	}

	req, err := client.UpdateNetworkSiblingSetPreparer(ctx, body, location)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "UpdateNetworkSiblingSet", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateNetworkSiblingSetSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.ResourceClient", "UpdateNetworkSiblingSet", result.Response(), "Failure sending request")
		return
	}
...
// UpdateNetworkSiblingSetPreparer prepares the UpdateNetworkSiblingSet request.
func (client ResourceClient) UpdateNetworkSiblingSetPreparer(ctx context.Context, body UpdateNetworkSiblingSetRequest, location string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"location":       autorest.Encode("path", location),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.NetApp/locations/{location}/updateNetworkSiblingSet", pathParameters),
		autorest.WithJSON(body),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// UpdateNetworkSiblingSetSender sends the UpdateNetworkSiblingSet request. The method will close the
// http.Response Body if it receives an error.
func (client ResourceClient) UpdateNetworkSiblingSetSender(req *http.Request) (future ResourceUpdateNetworkSiblingSetFuture, err error) {
...
// UpdateNetworkSiblingSetResponder handles the response to the UpdateNetworkSiblingSet request. The method always
// closes the http.Response Body.
func (client ResourceClient) UpdateNetworkSiblingSetResponder(resp *http.Response) (result NetworkSiblingSet, err error) {
	err = autorest.Respond(
		resp,
