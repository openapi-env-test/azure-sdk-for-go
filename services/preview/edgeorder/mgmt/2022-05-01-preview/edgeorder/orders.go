...
func (client OrdersClient) ListByResourceGroup(ctx context.Context, resourceGroupName string, skipToken string, top *int32) (result OrderResourceListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListByResourceGroupPreparer(ctx, resourceGroupName, skipToken, top)
	if err != nil {
...
func (client OrdersClient) ListByResourceGroupPreparer(ctx context.Context, resourceGroupName string, skipToken string, top *int32) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	}
...
func (client OrdersClient) ListByResourceGroupComplete(ctx context.Context, resourceGroupName string, skipToken string, top *int32) (result OrderResourceListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/OrdersClient.ListByResourceGroup")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListByResourceGroup(ctx, resourceGroupName, skipToken, top)
	return
}
...
// top - $top is supported on fetching list of resources. $top=10 means that the first 10 items in the list
// will be returned to the API caller.
func (client OrdersClient) ListBySubscription(ctx context.Context, skipToken string, top *int32) (result OrderResourceListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListBySubscriptionPreparer(ctx, skipToken, top)
	if err != nil {
...
func (client OrdersClient) ListBySubscriptionPreparer(ctx context.Context, skipToken string, top *int32) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client OrdersClient) ListBySubscriptionComplete(ctx context.Context, skipToken string, top *int32) (result OrderResourceListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/OrdersClient.ListBySubscription")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListBySubscription(ctx, skipToken, top)
	return
}
