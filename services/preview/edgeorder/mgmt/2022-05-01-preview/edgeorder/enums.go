...
const (
	...
	Discoverable AvailabilityStage = "Discoverable"
...
func PossibleAvailabilityStageValues() []AvailabilityStage {
	return []AvailabilityStage{Available, ComingSoon, Deprecated, Discoverable, Preview, Signup, Unavailable}
}
...
// ChildConfigurationType enumerates the values for child configuration type.
...
// PossibleChildConfigurationTypeValues returns an array of possible values for the ChildConfigurationType const type.
func PossibleChildConfigurationTypeValues() []ChildConfigurationType {
	return []ChildConfigurationType{ChildConfigurationTypeAdditionalConfiguration, ChildConfigurationTypeDeviceConfiguration}
}
...
// FulfillmentType enumerates the values for fulfillment type.
type FulfillmentType string

const (
	// External The fulfillment (the whole journey of the product offering) is handled by external third party
	// entities.
	External FulfillmentType = "External"
	// Microsoft The fulfillment (the whole journey of the product offering) is handled by microsoft.
	Microsoft FulfillmentType = "Microsoft"
)

// PossibleFulfillmentTypeValues returns an array of possible values for the FulfillmentType const type.
func PossibleFulfillmentTypeValues() []FulfillmentType {
	return []FulfillmentType{External, Microsoft}
}

// IdentificationType enumerates the values for identification type.
type IdentificationType string

const (
	// NotSupported Product does not have any explicit identifier.
	NotSupported IdentificationType = "NotSupported"
	// SerialNumber Product is identifiable by serial number.
	SerialNumber IdentificationType = "SerialNumber"
)

// PossibleIdentificationTypeValues returns an array of possible values for the IdentificationType const type.
func PossibleIdentificationTypeValues() []IdentificationType {
	return []IdentificationType{NotSupported, SerialNumber}
}
...
const (
	// LinkTypeDiscoverable Link to order the product from another source and not from Azure Edge Hardware
	// Center.
...
func PossibleLinkTypeValues() []LinkType {
	return []LinkType{LinkTypeDiscoverable, LinkTypeDocumentation, LinkTypeGeneric, LinkTypeKnowMore, LinkTypeSignUp, LinkTypeSpecification, LinkTypeTermsAndConditions}
}
...
// OrderMode enumerates the values for order mode.
type OrderMode string

const (
	// Default Default Order mode.
	Default OrderMode = "Default"
	// DoNotFulfill Mode in which the Order will not be fulfilled.
	DoNotFulfill OrderMode = "DoNotFulfill"
)

// PossibleOrderModeValues returns an array of possible values for the OrderMode const type.
func PossibleOrderModeValues() []OrderMode {
	return []OrderMode{Default, DoNotFulfill}
}
