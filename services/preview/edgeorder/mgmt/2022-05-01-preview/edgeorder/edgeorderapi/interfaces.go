...
type AddressesClientAPI interface {
	...
	ListByResourceGroup(ctx context.Context, resourceGroupName string, filter string, top *int32, skipToken string) (result edgeorder.AddressResourceListPage, err error)
	ListByResourceGroupComplete(ctx context.Context, resourceGroupName string, filter string, top *int32, skipToken string) (result edgeorder.AddressResourceListIterator, err error)
	ListBySubscription(ctx context.Context, filter string, top *int32, skipToken string) (result edgeorder.AddressResourceListPage, err error)
	ListBySubscriptionComplete(ctx context.Context, filter string, top *int32, skipToken string) (result edgeorder.AddressResourceListIterator, err error)
...
type OrderItemsClientAPI interface {
	...
	ListByResourceGroup(ctx context.Context, resourceGroupName string, filter string, expand string, top *int32, skipToken string) (result edgeorder.OrderItemResourceListPage, err error)
	ListByResourceGroupComplete(ctx context.Context, resourceGroupName string, filter string, expand string, top *int32, skipToken string) (result edgeorder.OrderItemResourceListIterator, err error)
	ListBySubscription(ctx context.Context, filter string, expand string, top *int32, skipToken string) (result edgeorder.OrderItemResourceListPage, err error)
	ListBySubscriptionComplete(ctx context.Context, filter string, expand string, top *int32, skipToken string) (result edgeorder.OrderItemResourceListIterator, err error)
...
type OrdersClientAPI interface {
	...
	ListByResourceGroup(ctx context.Context, resourceGroupName string, top *int32, skipToken string) (result edgeorder.OrderResourceListPage, err error)
	ListByResourceGroupComplete(ctx context.Context, resourceGroupName string, top *int32, skipToken string) (result edgeorder.OrderResourceListIterator, err error)
	ListBySubscription(ctx context.Context, top *int32, skipToken string) (result edgeorder.OrderResourceListPage, err error)
	ListBySubscriptionComplete(ctx context.Context, top *int32, skipToken string) (result edgeorder.OrderResourceListIterator, err error)
}
