...
// order items.
func (client OrderItemsClient) ListByResourceGroup(ctx context.Context, resourceGroupName string, filter string, expand string, top *int32, skipToken string) (result OrderItemResourceListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListByResourceGroupPreparer(ctx, resourceGroupName, filter, expand, top, skipToken)
	if err != nil {
...
func (client OrderItemsClient) ListByResourceGroupPreparer(ctx context.Context, resourceGroupName string, filter string, expand string, top *int32, skipToken string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	}
...
func (client OrderItemsClient) ListByResourceGroupComplete(ctx context.Context, resourceGroupName string, filter string, expand string, top *int32, skipToken string) (result OrderItemResourceListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/OrderItemsClient.ListByResourceGroup")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListByResourceGroup(ctx, resourceGroupName, filter, expand, top, skipToken)
	return
}
...
// skipToken - $skipToken is supported on Get list of order items, which provides the next page in the list of
// order items.
func (client OrderItemsClient) ListBySubscription(ctx context.Context, filter string, expand string, top *int32, skipToken string) (result OrderItemResourceListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListBySubscriptionPreparer(ctx, filter, expand, top, skipToken)
	if err != nil {
...
func (client OrderItemsClient) ListBySubscriptionPreparer(ctx context.Context, filter string, expand string, top *int32, skipToken string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client OrderItemsClient) ListBySubscriptionComplete(ctx context.Context, filter string, expand string, top *int32, skipToken string) (result OrderItemResourceListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/OrderItemsClient.ListBySubscription")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListBySubscription(ctx, filter, expand, top, skipToken)
	return
}
