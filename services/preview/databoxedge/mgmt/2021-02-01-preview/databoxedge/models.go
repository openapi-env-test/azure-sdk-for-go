...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/databoxedge/mgmt/2021-02-01-preview/databoxedge"
...
type DeviceExtendedInfoPatch struct {
	...
	// SyncStatus - For changing or to initiate the resync to key-vault set the status to KeyVaultSyncPending, rest of the status will not be applicable. Possible values include: 'KeyVaultSynced', 'KeyVaultSyncFailed', 'KeyVaultNotConfigured', 'KeyVaultSyncPending', 'KeyVaultSyncing', 'KeyVaultNotSynced'
...
type DeviceExtendedInfoProperties struct {
	...
	// ChannelIntegrityKeyVersion - The version of Channel Integrity Key stored in the Client Key Vault
	ChannelIntegrityKeyVersion *string `json:"channelIntegrityKeyVersion,omitempty"`
	// KeyVaultSyncStatus - Key vault sync status. Possible values include: 'KeyVaultSynced', 'KeyVaultSyncFailed', 'KeyVaultNotConfigured', 'KeyVaultSyncPending', 'KeyVaultSyncing', 'KeyVaultNotSynced'
	...
	DeviceSecrets map[string]*Secret `json:"deviceSecrets"`
}
...
type MonitoringMetricConfiguration struct {
	autorest.Response `json:"-"`
	// SystemData - MonitoringConfiguration on ASE device
	SystemData *SystemData `json:"systemData,omitempty"`
...
func (mmc MonitoringMetricConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if mmc.SystemData != nil {
		objectMap["systemData"] = mmc.SystemData
	}
...
type NetworkSettings struct {
	autorest.Response `json:"-"`
	// SystemData - NetworkSettings on ASE device
	SystemData *SystemData `json:"systemData,omitempty"`
...
func (ns NetworkSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if ns.SystemData != nil {
		objectMap["systemData"] = ns.SystemData
	}
	return json.Marshal(objectMap)
}
...
type Order struct {
	autorest.Response `json:"-"`
	// SystemData - Order configured on ASE resource
	SystemData *SystemData `json:"systemData,omitempty"`
...
func (o Order) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if o.SystemData != nil {
		objectMap["systemData"] = o.SystemData
	}
...
type OrderStatus struct {
	// Status - Status of the order as per the allowed status types. Possible values include: 'Untracked', 'AwaitingFulfillment', 'AwaitingPreparation', 'AwaitingShipment', 'Shipped', 'Arriving', 'Delivered', 'ReplacementRequested', 'LostDevice', 'Declined', 'ReturnInitiated', 'AwaitingReturnShipment', 'ShippedBack', 'CollectedAtMicrosoft', 'AwaitingPickup', 'PickupCompleted', 'AwaitingDrop'
...
// Sku the SKU type.
type Sku struct {
	// Name - SKU name. Possible values include: 'Gateway', 'Edge', 'TEA1Node', 'TEA1NodeUPS', 'TEA1NodeHeater', 'TEA1NodeUPSHeater', 'TEA4NodeHeater', 'TEA4NodeUPSHeater', 'TMA', 'TDC', 'TCASmall', 'GPU', 'TCALarge', 'EdgePBase', 'EdgePHigh', 'EdgePRBase', 'EdgePRBaseUPS', 'EP2641VPUW', 'EP21281T4Mx1W', 'EP22562T4W', 'EdgeMRMini', 'RCASmall', 'RCALarge', 'RDC', 'Management'
...
type UpdateDetails struct {
	...
	// UpdateSize - Size of the update(In Bytes)
	UpdateSize *float64 `json:"updateSize,omitempty"`
	// UpdateType - Type of the Update. Possible values include: 'UpdateTypeSoftware', 'UpdateTypeKubernetes', 'UpdateTypeFirmware'
	UpdateType UpdateType `json:"updateType,omitempty"`
	// TargetVersion - Target Version number
	TargetVersion *string `json:"targetVersion,omitempty"`
	// EstimatedInstallTimeInMins - Estimated Install Time for the update
	...
	// Status - Status of the update. Possible values include: 'DownloadPending', 'DownloadStarted', 'DownloadCompleted', 'InstallStarted', 'InstallCompleted'
...
type UpdateSummary struct {
	autorest.Response `json:"-"`
	// SystemData - UpdateSummary Result
	SystemData *SystemData `json:"systemData,omitempty"`
...
type UpdateSummaryProperties struct {
	...
	// LastCompletedDownloadJobID - READ-ONLY; JobId of the last ran download job.(Can be success/cancelled/failed)
	LastCompletedDownloadJobID *string `json:"lastCompletedDownloadJobId,omitempty"`
	// LastDownloadJobStatus - READ-ONLY; JobStatus of the last ran download job. Possible values include: 'JobStatusInvalid', 'JobStatusRunning', 'JobStatusSucceeded', 'JobStatusFailed', 'JobStatusCanceled', 'JobStatusPaused', 'JobStatusScheduled'
	...
	// LastCompletedInstallJobID - READ-ONLY; JobId of the last ran install job.(Can be success/cancelled/failed)
	LastCompletedInstallJobID *string `json:"lastCompletedInstallJobId,omitempty"`
	// LastInstallJobStatus - READ-ONLY; JobStatus of the last ran install job. Possible values include: 'JobStatusInvalid', 'JobStatusRunning', 'JobStatusSucceeded', 'JobStatusFailed', 'JobStatusCanceled', 'JobStatusPaused', 'JobStatusScheduled'
	...
	// Updates - READ-ONLY; The list of updates available for install.
	...
	// TotalTimeInMinutes - READ-ONLY; The total time in Minutes
	TotalTimeInMinutes *int32 `json:"totalTimeInMinutes,omitempty"`
}
