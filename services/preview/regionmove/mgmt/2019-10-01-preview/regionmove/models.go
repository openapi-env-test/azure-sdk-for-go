...
func (future *MoveCollectionsBulkRemoveFuture) Result(client MoveCollectionsClient) (osVar OperationStatus, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "regionmove.MoveCollectionsBulkRemoveFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("regionmove.MoveCollectionsBulkRemoveFuture")
		return
	}
	...
	if osVar.Response.Response, err = future.GetResult(sender); err == nil && osVar.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "regionmove.MoveCollectionsBulkRemoveFuture", "Result", osVar.Response.Response, "Failure responding to request")
		}
	}
	return
}
