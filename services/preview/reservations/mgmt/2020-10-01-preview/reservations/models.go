...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/reservations/mgmt/2020-10-01-preview/reservations"
...
type CalculateExchangeRequestProperties struct {
	...
	ReservationsToExchange *[]ReturnRequest `json:"reservationsToExchange,omitempty"`
}
...
type ReturnRequest struct {
	// ID - Fully qualified identifier of the ReservationOrder being returned
	ID         *string                  `json:"id,omitempty"`
	Properties *ReturnRequestProperties `json:"properties,omitempty"`
}

// ReturnRequestProperties return request properties
type ReturnRequestProperties struct {
	// Scope - Possible values include: 'Reservation'
...
// ToReturn to be present only if ReturnRequestScope = Reservation and null otherwise
