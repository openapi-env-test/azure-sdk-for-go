...
type ManagersClientAPI interface {
	...
	PatchTags(ctx context.Context, parameters network.TagsObject, resourceGroupName string, networkManagerName string) (result network.Manager, err error)
}
...
type ManagerCommitsClientAPI interface {
	Post(ctx context.Context, parameters network.ManagerCommit, resourceGroupName string, networkManagerName string) (result network.ManagerCommit, err error)
}
...
// EffectiveVirtualNetworksClientAPI contains the set of methods on the EffectiveVirtualNetworksClient type.
type EffectiveVirtualNetworksClientAPI interface {
	ListByNetworkGroup(ctx context.Context, resourceGroupName string, networkManagerName string, networkGroupName string, parameters network.QueryRequestOptions) (result network.EffectiveVirtualNetworksListResult, err error)
	ListByNetworkManager(ctx context.Context, resourceGroupName string, networkManagerName string, parameters network.EffectiveVirtualNetworksParameter, top *int32, skipToken string) (result network.EffectiveVirtualNetworksListResult, err error)
}

var _ EffectiveVirtualNetworksClientAPI = (*network.EffectiveVirtualNetworksClient)(nil)

// ActiveConnectivityConfigurationsClientAPI contains the set of methods on the ActiveConnectivityConfigurationsClient type.
type ActiveConnectivityConfigurationsClientAPI interface {
	List(ctx context.Context, parameters network.ActiveConfigurationParameter, resourceGroupName string, networkManagerName string) (result network.ActiveConnectivityConfigurationsListResult, err error)
}

var _ ActiveConnectivityConfigurationsClientAPI = (*network.ActiveConnectivityConfigurationsClient)(nil)

// ActiveSecurityAdminRulesClientAPI contains the set of methods on the ActiveSecurityAdminRulesClient type.
type ActiveSecurityAdminRulesClientAPI interface {
	List(ctx context.Context, parameters network.ActiveConfigurationParameter, resourceGroupName string, networkManagerName string) (result network.ActiveSecurityAdminRulesListResult, err error)
}

var _ ActiveSecurityAdminRulesClientAPI = (*network.ActiveSecurityAdminRulesClient)(nil)

// ActiveSecurityUserRulesClientAPI contains the set of methods on the ActiveSecurityUserRulesClient type.
type ActiveSecurityUserRulesClientAPI interface {
	List(ctx context.Context, parameters network.ActiveConfigurationParameter, resourceGroupName string, networkManagerName string) (result network.ActiveSecurityUserRulesListResult, err error)
}

var _ ActiveSecurityUserRulesClientAPI = (*network.ActiveSecurityUserRulesClient)(nil)
...
type ConnectivityConfigurationsClientAPI interface {
	...
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (result autorest.Response, err error)
...
// EffectiveConnectivityConfigurationsClientAPI contains the set of methods on the EffectiveConnectivityConfigurationsClient type.
type EffectiveConnectivityConfigurationsClientAPI interface {
	List(ctx context.Context, parameters network.QueryRequestOptions, resourceGroupName string, virtualNetworkName string) (result network.ManagerEffectiveConnectivityConfigurationListResult, err error)
}

var _ EffectiveConnectivityConfigurationsClientAPI = (*network.EffectiveConnectivityConfigurationsClient)(nil)

// ManagerEffectiveSecurityAdminRulesClientAPI contains the set of methods on the ManagerEffectiveSecurityAdminRulesClient type.
type ManagerEffectiveSecurityAdminRulesClientAPI interface {
	List(ctx context.Context, parameters network.QueryRequestOptions, resourceGroupName string, virtualNetworkName string) (result network.ManagerEffectiveSecurityAdminRulesListResult, err error)
}

var _ ManagerEffectiveSecurityAdminRulesClientAPI = (*network.ManagerEffectiveSecurityAdminRulesClient)(nil)
...
// SecurityUserConfigurationsClientAPI contains the set of methods on the SecurityUserConfigurationsClient type.
type SecurityUserConfigurationsClientAPI interface {
	CreateOrUpdate(ctx context.Context, securityUserConfiguration network.SecurityConfiguration, resourceGroupName string, networkManagerName string, configurationName string) (result network.SecurityConfiguration, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (result autorest.Response, err error)
...
var _ SecurityUserConfigurationsClientAPI = (*network.SecurityUserConfigurationsClient)(nil)

// UserRuleCollectionsClientAPI contains the set of methods on the UserRuleCollectionsClient type.
type UserRuleCollectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, userRuleCollection network.RuleCollection, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result network.RuleCollection, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result network.RuleCollection, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, top *int32, skipToken string) (result network.RuleCollectionListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, top *int32, skipToken string) (result network.RuleCollectionListResultIterator, err error)
}

var _ UserRuleCollectionsClientAPI = (*network.UserRuleCollectionsClient)(nil)

// UserRulesClientAPI contains the set of methods on the UserRulesClient type.
type UserRulesClientAPI interface {
	CreateOrUpdate(ctx context.Context, userRule network.BasicBaseUserRule, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result network.BaseUserRuleModel, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result network.BaseUserRuleModel, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, top *int32, skipToken string) (result network.UserRuleListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, top *int32, skipToken string) (result network.UserRuleListResultIterator, err error)
}

var _ UserRulesClientAPI = (*network.UserRulesClient)(nil)
...
type SecurityAdminConfigurationsClientAPI interface {
	CreateOrUpdate(ctx context.Context, securityAdminConfiguration network.SecurityConfiguration, resourceGroupName string, networkManagerName string, configurationName string) (result network.SecurityConfiguration, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (result network.SecurityConfiguration, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.SecurityConfigurationListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.SecurityConfigurationListResultIterator, err error)
...
type AdminRuleCollectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, ruleCollection network.RuleCollection, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result network.RuleCollection, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result network.RuleCollection, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, top *int32, skipToken string) (result network.RuleCollectionListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, top *int32, skipToken string) (result network.RuleCollectionListResultIterator, err error)
...
// SecurityPerimetersClientAPI contains the set of methods on the SecurityPerimetersClient type.
type SecurityPerimetersClientAPI interface {
	CheckMembersMethod(ctx context.Context, parameters network.CheckMembers, resourceGroupName string, networkSecurityPerimeterName string, networkSecurityPerimeterProfile string) (result network.CheckMembers, err error)
	CreateOrUpdate(ctx context.Context, parameters network.SecurityPerimeter, resourceGroupName string, networkSecurityPerimeterName string) (result network.SecurityPerimeter, err error)
	Delete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string) (result network.SecurityPerimeter, err error)
	List(ctx context.Context, resourceGroupName string, top *int32, skipToken string) (result network.SecurityPerimeterListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, top *int32, skipToken string) (result network.SecurityPerimeterListResultIterator, err error)
	ListBySubscription(ctx context.Context, top *int32, skipToken string) (result network.SecurityPerimeterListResultPage, err error)
	ListBySubscriptionComplete(ctx context.Context, top *int32, skipToken string) (result network.SecurityPerimeterListResultIterator, err error)
	Query(ctx context.Context, parameters network.QueryNSPReqRes, location string) (result network.QueryNSPReqRes, err error)
}

var _ SecurityPerimetersClientAPI = (*network.SecurityPerimetersClient)(nil)

// NspProfilesClientAPI contains the set of methods on the NspProfilesClient type.
type NspProfilesClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.NspProfile, resourceGroupName string, networkSecurityPerimeterName string, profileName string) (result network.NspProfile, err error)
	Delete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, profileName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, profileName string) (result network.NspProfile, err error)
	List(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, top *int32, skipToken string) (result network.NspProfileListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, top *int32, skipToken string) (result network.NspProfileListResultIterator, err error)
}

var _ NspProfilesClientAPI = (*network.NspProfilesClient)(nil)

// NspAccessRulesClientAPI contains the set of methods on the NspAccessRulesClient type.
type NspAccessRulesClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.NspAccessRule, resourceGroupName string, networkSecurityPerimeterName string, profileName string, accessRuleName string) (result network.NspAccessRule, err error)
	Delete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, profileName string, accessRuleName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, profileName string, accessRuleName string) (result network.NspAccessRule, err error)
	List(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, profileName string, top *int32, skipToken string) (result network.NspAccessRuleListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, profileName string, top *int32, skipToken string) (result network.NspAccessRuleListResultIterator, err error)
}

var _ NspAccessRulesClientAPI = (*network.NspAccessRulesClient)(nil)

// NspAssociationsClientAPI contains the set of methods on the NspAssociationsClient type.
type NspAssociationsClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.NspAssociation, resourceGroupName string, networkSecurityPerimeterName string, associationName string) (result network.NspAssociation, err error)
	Delete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string) (result network.NspAssociationsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string) (result network.NspAssociation, err error)
	List(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, top *int32, skipToken string) (result network.NspAssociationsListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, top *int32, skipToken string) (result network.NspAssociationsListResultIterator, err error)
}

var _ NspAssociationsClientAPI = (*network.NspAssociationsClient)(nil)

// NspAssociationsProxyClientAPI contains the set of methods on the NspAssociationsProxyClient type.
type NspAssociationsProxyClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.NspAssociation, resourceGroupName string, networkSecurityPerimeterName string, associationName string) (result network.NspAssociation, err error)
	Delete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, associationName string) (result network.NspAssociation, err error)
	List(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, top *int32, skipToken string) (result network.NspAssociationsListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkSecurityPerimeterName string, top *int32, skipToken string) (result network.NspAssociationsListResultIterator, err error)
}

var _ NspAssociationsProxyClientAPI = (*network.NspAssociationsProxyClient)(nil)

// PerimeterAssociableResourceTypesClientAPI contains the set of methods on the PerimeterAssociableResourceTypesClient type.
type PerimeterAssociableResourceTypesClientAPI interface {
	List(ctx context.Context, location string) (result network.PerimeterAssociableResourcesListResultPage, err error)
	ListComplete(ctx context.Context, location string) (result network.PerimeterAssociableResourcesListResultIterator, err error)
}

var _ PerimeterAssociableResourceTypesClientAPI = (*network.PerimeterAssociableResourceTypesClient)(nil)

// NspAccessRulesReconcileClientAPI contains the set of methods on the NspAccessRulesReconcileClient type.
type NspAccessRulesReconcileClientAPI interface {
	Post(ctx context.Context, parameters interface{}, resourceGroupName string, networkSecurityPerimeterName string, profileName string, accessRuleName string) (result network.SetObject, err error)
}

var _ NspAccessRulesReconcileClientAPI = (*network.NspAccessRulesReconcileClient)(nil)
