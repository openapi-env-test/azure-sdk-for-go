...
// IsMember enumerates the values for is member.
type IsMember string
...
// PossibleIsMemberValues returns an array of possible values for the IsMember const type.
func PossibleIsMemberValues() []IsMember {
	return []IsMember{No, Yes}
}
