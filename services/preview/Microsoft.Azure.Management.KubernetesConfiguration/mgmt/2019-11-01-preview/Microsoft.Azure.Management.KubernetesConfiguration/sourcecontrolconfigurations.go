...
func (client SourceControlConfigurationsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, APIVersion string, sourceControlConfiguration SourceControlConfiguration) (result SourceControlConfiguration, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client SourceControlConfigurationsClient) Delete(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, APIVersion string) (result SourceControlConfigurationsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client SourceControlConfigurationsClient) Get(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, sourceControlConfigurationName string, APIVersion string) (result SourceControlConfiguration, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "Get", resp, "Failure responding to request")
	}
...
func (client SourceControlConfigurationsClient) List(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, APIVersion string) (result SourceControlConfigurationListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "List", resp, "Failure sending request")
		return
	}

	result.sccl, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "List", resp, "Failure responding to request")
	}
...
func (client SourceControlConfigurationsClient) listNextResults(ctx context.Context, lastResults SourceControlConfigurationList) (result SourceControlConfigurationList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.SourceControlConfigurationsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
