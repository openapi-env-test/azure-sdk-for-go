...
func (client OperationsClient) List(ctx context.Context, APIVersion string) (result ResourceProviderOperationListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result.rpol, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.OperationsClient", "List", resp, "Failure responding to request")
	}
...
func (client OperationsClient) listNextResults(ctx context.Context, lastResults ResourceProviderOperationList) (result ResourceProviderOperationList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.OperationsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.OperationsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuremanagementkubernetesconfiguration.OperationsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
