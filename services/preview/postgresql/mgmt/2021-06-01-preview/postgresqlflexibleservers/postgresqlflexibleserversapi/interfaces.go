...
type BaseClientAPI interface {
	CheckMigrationNameAvailability(ctx context.Context, targetDBServerSubscriptionID string, targetDBServerResourceGroupName string, targetDBServerName string, parameters postgresqlflexibleservers.MigrationNameAvailabilityResource) (result postgresqlflexibleservers.MigrationNameAvailabilityResource, err error)
}

var _ BaseClientAPI = (*postgresqlflexibleservers.BaseClient)(nil)
...
// MigrationsClientAPI contains the set of methods on the MigrationsClient type.
type MigrationsClientAPI interface {
	Create(ctx context.Context, targetDBServerSubscriptionID string, targetDBServerResourceGroupName string, targetDBServerName string, migrationName string, parameters postgresqlflexibleservers.MigrationResource) (result postgresqlflexibleservers.MigrationResource, err error)
	Delete(ctx context.Context, targetDBServerSubscriptionID string, targetDBServerResourceGroupName string, targetDBServerName string, migrationName string) (result autorest.Response, err error)
	Get(ctx context.Context, targetDBServerSubscriptionID string, targetDBServerResourceGroupName string, targetDBServerName string, migrationName string) (result postgresqlflexibleservers.MigrationResource, err error)
	ListByTargetServer(ctx context.Context, targetDBServerSubscriptionID string, targetDBServerResourceGroupName string, targetDBServerName string, migrationListFilter postgresqlflexibleservers.MigrationListFilter) (result postgresqlflexibleservers.MigrationResourceListResultPage, err error)
	ListByTargetServerComplete(ctx context.Context, targetDBServerSubscriptionID string, targetDBServerResourceGroupName string, targetDBServerName string, migrationListFilter postgresqlflexibleservers.MigrationListFilter) (result postgresqlflexibleservers.MigrationResourceListResultIterator, err error)
	Update(ctx context.Context, targetDBServerSubscriptionID string, targetDBServerResourceGroupName string, targetDBServerName string, migrationName string, parameters postgresqlflexibleservers.MigrationResourceForPatch) (result postgresqlflexibleservers.MigrationResource, err error)
}

var _ MigrationsClientAPI = (*postgresqlflexibleservers.MigrationsClient)(nil)
