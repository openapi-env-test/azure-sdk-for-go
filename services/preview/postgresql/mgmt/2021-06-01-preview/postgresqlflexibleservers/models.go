...
// AADApp azure active directory application.
type AADApp struct {
	AadSecret *string    `json:"aadSecret,omitempty"`
...
type MigrationNameAvailabilityResource struct {
	...
	// Reason - READ-ONLY; Migration name availability reason. Possible values include: 'Invalid', 'AlreadyExists'
	Reason MigrationNameAvailabilityReason `json:"reason,omitempty"`
	// Message - READ-ONLY; Migration name availability message.
	Message *string `json:"message,omitempty"`
}

// MarshalJSON is the custom marshaler for MigrationNameAvailabilityResource.
func (mnar MigrationNameAvailabilityResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if mnar.Name != nil {
		objectMap["name"] = mnar.Name
	}
	if mnar.Type != nil {
		objectMap["type"] = mnar.Type
	}
	return json.Marshal(objectMap)
}
...
type MigrationResource struct {
	...
	*MigrationResourceProperties `json:"properties,omitempty"`
...
// MarshalJSON is the custom marshaler for MigrationResource.
func (mr MigrationResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if mr.MigrationResourceProperties != nil {
		objectMap["properties"] = mr.MigrationResourceProperties
	}
	if mr.Tags != nil {
...
// UnmarshalJSON is the custom unmarshaler for MigrationResource struct.
func (mr *MigrationResource) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var migrationResourceProperties MigrationResourceProperties
				err = json.Unmarshal(*v, &migrationResourceProperties)
				if err != nil {
					return err
				}
				mr.MigrationResourceProperties = &migrationResourceProperties
			}
		case "systemData":
			if v != nil {
				var systemData SystemData
...
type MigrationResourceForPatch struct {
	// MigrationResourcePropertiesForPatch - Migration resource properties.
	*MigrationResourcePropertiesForPatch `json:"properties,omitempty"`
	// Tags - Application-specific metadata in the form of key-value pairs.
	Tags map[string]*string `json:"tags"`
}

// MarshalJSON is the custom marshaler for MigrationResourceForPatch.
func (mrfp MigrationResourceForPatch) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if mrfp.MigrationResourcePropertiesForPatch != nil {
		objectMap["properties"] = mrfp.MigrationResourcePropertiesForPatch
	}
	if mrfp.Tags != nil {
		objectMap["tags"] = mrfp.Tags
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for MigrationResourceForPatch struct.
func (mrfp *MigrationResourceForPatch) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var migrationResourcePropertiesForPatch MigrationResourcePropertiesForPatch
				err = json.Unmarshal(*v, &migrationResourcePropertiesForPatch)
				if err != nil {
					return err
				}
				mrfp.MigrationResourcePropertiesForPatch = &migrationResourcePropertiesForPatch
			}
		case "tags":
			if v != nil {
				var tags map[string]*string
...
// MigrationResourceGroup migration resource group.
...
type MigrationResourceListResult struct {
	autorest.Response `json:"-"`
	// Value - READ-ONLY
	Value *[]MigrationResource `json:"value,omitempty"`
	// NextLink - READ-ONLY; The link used to get the next page of migrations.
	NextLink *string `json:"nextLink,omitempty"`
}

// MarshalJSON is the custom marshaler for MigrationResourceListResult.
func (mrlr MigrationResourceListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}

// MigrationResourceListResultIterator provides access to a complete listing of MigrationResource values.
type MigrationResourceListResultIterator struct {
	i    int
	page MigrationResourceListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *MigrationResourceListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/MigrationResourceListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *MigrationResourceListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter MigrationResourceListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter MigrationResourceListResultIterator) Response() MigrationResourceListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter MigrationResourceListResultIterator) Value() MigrationResource {
	if !iter.page.NotDone() {
...
// Creates a new instance of the MigrationResourceListResultIterator type.
func NewMigrationResourceListResultIterator(page MigrationResourceListResultPage) MigrationResourceListResultIterator {
	return MigrationResourceListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (mrlr MigrationResourceListResult) IsEmpty() bool {
	return mrlr.Value == nil || len(*mrlr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (mrlr MigrationResourceListResult) hasNextLink() bool {
	return mrlr.NextLink != nil && len(*mrlr.NextLink) != 0
}

// migrationResourceListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (mrlr MigrationResourceListResult) migrationResourceListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !mrlr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
...
// MigrationResourceListResultPage contains a page of MigrationResource values.
type MigrationResourceListResultPage struct {
	fn   func(context.Context, MigrationResourceListResult) (MigrationResourceListResult, error)
	mrlr MigrationResourceListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *MigrationResourceListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/MigrationResourceListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *MigrationResourceListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page MigrationResourceListResultPage) NotDone() bool {
	return !page.mrlr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page MigrationResourceListResultPage) Response() MigrationResourceListResult {
	return page.mrlr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page MigrationResourceListResultPage) Values() []MigrationResource {
...
// Creates a new instance of the MigrationResourceListResultPage type.
func NewMigrationResourceListResultPage(cur MigrationResourceListResult, getNextPage func(context.Context, MigrationResourceListResult) (MigrationResourceListResult, error)) MigrationResourceListResultPage {
	return MigrationResourceListResultPage{
		fn:   getNextPage,
		mrlr: cur,
	}
}
...
type MigrationResourceProperties struct {
	// MigrationID - READ-ONLY
	MigrationID *uuid.UUID `json:"migrationId,omitempty"`
	// MigrationName - READ-ONLY
	MigrationName *string `json:"migrationName,omitempty"`
	// MigrationDetailsLevel - READ-ONLY; Possible values include: 'MigrationDetailsLevelDefault', 'MigrationDetailsLevelSummary', 'MigrationDetailsLevelFull'
	MigrationDetailsLevel MigrationDetailsLevel `json:"migrationDetailsLevel,omitempty"`
	// CurrentStatus - READ-ONLY
	CurrentStatus *MigrationStatus `json:"currentStatus,omitempty"`
	// SourceDBServerMetadata - READ-ONLY
	SourceDBServerMetadata *DBServerMetadata `json:"sourceDBServerMetadata,omitempty"`
	// TargetDBServerMetadata - READ-ONLY
	...
	// TargetDBServerResourceID - READ-ONLY
	TargetDBServerResourceID                  *string                 `json:"targetDBServerResourceId,omitempty"`
	DBsToMigrate                              *[]string               `json:"dBsToMigrate,omitempty"`
	MigrationResourceGroup                    *MigrationResourceGroup `json:"migrationResourceGroup,omitempty"`
	SetupLogicalReplicationOnSourceDBIfNeeded *bool                   `json:"setupLogicalReplicationOnSourceDBIfNeeded,omitempty"`
	OverwriteDBsInTarget                      *bool                   `json:"overwriteDBsInTarget,omitempty"`
	MigrationWindowStartTimeInUtc             *date.Time              `json:"migrationWindowStartTimeInUtc,omitempty"`
	StartDataMigration                        *bool                   `json:"startDataMigration,omitempty"`
	TriggerCutover                            *bool                   `json:"triggerCutover,omitempty"`
}

// MarshalJSON is the custom marshaler for MigrationResourceProperties.
func (mrp MigrationResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if mrp.SourceDBServerResourceID != nil {
		objectMap["sourceDBServerResourceId"] = mrp.SourceDBServerResourceID
	}
	if mrp.SourceDBServerFullyQualifiedDomainName != nil {
		objectMap["sourceDBServerFullyQualifiedDomainName"] = mrp.SourceDBServerFullyQualifiedDomainName
	}
	if mrp.TargetDBServerFullyQualifiedDomainName != nil {
		objectMap["targetDBServerFullyQualifiedDomainName"] = mrp.TargetDBServerFullyQualifiedDomainName
	}
	if mrp.SecretParameters != nil {
		objectMap["secretParameters"] = mrp.SecretParameters
	}
	if mrp.UserAssignedIdentityResourceID != nil {
		objectMap["userAssignedIdentityResourceId"] = mrp.UserAssignedIdentityResourceID
	}
	if mrp.DBsToMigrate != nil {
		objectMap["dBsToMigrate"] = mrp.DBsToMigrate
	}
	if mrp.MigrationResourceGroup != nil {
		objectMap["migrationResourceGroup"] = mrp.MigrationResourceGroup
	}
	if mrp.SetupLogicalReplicationOnSourceDBIfNeeded != nil {
		objectMap["setupLogicalReplicationOnSourceDBIfNeeded"] = mrp.SetupLogicalReplicationOnSourceDBIfNeeded
	}
	if mrp.OverwriteDBsInTarget != nil {
		objectMap["overwriteDBsInTarget"] = mrp.OverwriteDBsInTarget
	}
	if mrp.MigrationWindowStartTimeInUtc != nil {
		objectMap["migrationWindowStartTimeInUtc"] = mrp.MigrationWindowStartTimeInUtc
	}
	if mrp.StartDataMigration != nil {
		objectMap["startDataMigration"] = mrp.StartDataMigration
	}
	if mrp.TriggerCutover != nil {
		objectMap["triggerCutover"] = mrp.TriggerCutover
	}
	return json.Marshal(objectMap)
}
...
type MigrationSecretParameters struct {
	AdminCredentials *AdminCredentials `json:"adminCredentials,omitempty"`
	AadApp           *AADApp           `json:"aadApp,omitempty"`
}

// MigrationStatus migration status.
type MigrationStatus struct {
	// State - READ-ONLY; Possible values include: 'InProgress', 'WaitingForUserAction', 'Canceled', 'Failed', 'Succeeded'
	State MigrationState `json:"state,omitempty"`
	// Error - READ-ONLY
	Error *string `json:"error,omitempty"`
	// CurrentSubStateDetails - READ-ONLY
	CurrentSubStateDetails *MigrationSubStateDetails `json:"currentSubStateDetails,omitempty"`
}

// MarshalJSON is the custom marshaler for MigrationStatus.
...
type MigrationSubStateDetails struct {
	// CurrentSubState - READ-ONLY; Possible values include: 'PerformingPreRequisiteSteps', 'WaitingForLogicalReplicationSetupRequestOnSourceDB', 'WaitingForDBsToMigrateSpecification', 'WaitingForTargetDBOverwriteConfirmation', 'WaitingForDataMigrationScheduling', 'WaitingForDataMigrationWindow', 'MigratingData', 'WaitingForCutoverTrigger', 'CompletingMigration', 'Completed'
	CurrentSubState MigrationSubState `json:"currentSubState,omitempty"`
}

// MarshalJSON is the custom marshaler for MigrationSubStateDetails.
func (mssd MigrationSubStateDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// ServiceError an error response from the Batch service.
