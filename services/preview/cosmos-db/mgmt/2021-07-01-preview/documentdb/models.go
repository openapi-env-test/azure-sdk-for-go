...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/cosmos-db/mgmt/2021-07-01-preview/documentdb"
...
type DataTransferServiceResourceProperties struct {
	...
	// Status - READ-ONLY; Possible values include: 'ServiceStatusCreating', 'ServiceStatusRunning', 'ServiceStatusUpdating', 'ServiceStatusDeleting', 'ServiceStatusError', 'ServiceStatusStopped'
	Status ServiceStatus `json:"status,omitempty"`
	// ServiceType - Possible values include: 'ServiceTypeServiceResourceProperties', 'ServiceTypeDataTransfer', 'ServiceTypeSQLDedicatedGateway', 'ServiceTypeGraphAPICompute'
...
type DiagnosticLogSettings struct {
	// EnableFullTextQuery - Describe the level of detail with which queries are to be logged. Possible values include: 'None', 'True', 'False'
...
type ServiceResourceCreateUpdateProperties struct {
	...
	// InstanceCount - Instance count for the service.
	InstanceCount *int32 `json:"instanceCount,omitempty"`
	// ServiceType - Possible values include: 'SQLDedicatedGateway', 'DataTransfer', 'GraphAPICompute'
