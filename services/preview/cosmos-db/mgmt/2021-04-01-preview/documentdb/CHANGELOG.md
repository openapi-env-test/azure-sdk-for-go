...
1. ServiceSize.ServiceSizeCosmosD16s
1. ServiceSize.ServiceSizeCosmosD4s
1. ServiceSize.ServiceSizeCosmosD8s
1. ServiceType.ServiceTypeDataTransfer
1. ServiceType.ServiceTypeSQLDedicatedGateway
...
1. ServiceTypeBasicServiceResourceProperties.ServiceTypeBasicServiceResourcePropertiesServiceTypeServiceResourceProperties
...
1. CreateModeDefault changed type from CreateMode to CreateModeBasicDatabaseAccountCreateUpdateProperties
1. CreateModeRestore changed type from CreateMode to CreateModeBasicDatabaseAccountCreateUpdateProperties
...
1. ServiceSize.CosmosD16s
1. ServiceSize.CosmosD4s
1. ServiceSize.CosmosD8s
1. ServiceType.DataTransfer
1. ServiceType.SQLDedicatedGateway
1. ServiceTypeBasicServiceResourceProperties.ServiceTypeDataTransferServiceResourceProperties
1. ServiceTypeBasicServiceResourceProperties.ServiceTypeSQLDedicatedGatewayServiceResourceProperties
1. ServiceTypeBasicServiceResourceProperties.ServiceTypeServiceResourceProperties
1. TriggerType.Post
1. TriggerType.Pre
1. UnitType.Bytes
