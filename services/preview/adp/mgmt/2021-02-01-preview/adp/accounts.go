...
// AccountsClient is the microsoft Autonomous Development Platform abcd
...
// CheckNameAvailabilityABC checks that the account name is valid and is not already in use
// Parameters:
// parameters - the checkNameAvailability parameters.
func (client AccountsClient) CheckNameAvailabilityABC(ctx context.Context, parameters AccountCheckNameAvailabilityParameters) (result CheckNameAvailabilityResult, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AccountsClient.CheckNameAvailabilityABC")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("adp.AccountsClient", "CheckNameAvailabilityABC", err.Error())
	}

	req, err := client.CheckNameAvailabilityABCPreparer(ctx, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "CheckNameAvailabilityABC", nil, "Failure preparing request")
		return
	}

	resp, err := client.CheckNameAvailabilityABCSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "CheckNameAvailabilityABC", resp, "Failure sending request")
		return
	}

	result, err = client.CheckNameAvailabilityABCResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "CheckNameAvailabilityABC", resp, "Failure responding to request")
		return
	}
...
// CheckNameAvailabilityABCPreparer prepares the CheckNameAvailabilityABC request.
func (client AccountsClient) CheckNameAvailabilityABCPreparer(ctx context.Context, parameters AccountCheckNameAvailabilityParameters) (*http.Request, error) {
...
// CheckNameAvailabilityABCSender sends the CheckNameAvailabilityABC request. The method will close the
// http.Response Body if it receives an error.
func (client AccountsClient) CheckNameAvailabilityABCSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// CheckNameAvailabilityABCResponder handles the response to the CheckNameAvailabilityABC request. The method always
// closes the http.Response Body.
func (client AccountsClient) CheckNameAvailabilityABCResponder(resp *http.Response) (result CheckNameAvailabilityResult, err error) {
