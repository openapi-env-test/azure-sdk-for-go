...
func PossibleDataEncryptionTypeValues() []DataEncryptionType {
	return []DataEncryptionType{AzureKeyVault, SystemManaged}
}
...
// ResetAllToDefault enumerates the values for reset all to default.
...
// PossibleResetAllToDefaultValues returns an array of possible values for the ResetAllToDefault const type.
func PossibleResetAllToDefaultValues() []ResetAllToDefault {
	return []ResetAllToDefault{ResetAllToDefaultFalse, ResetAllToDefaultTrue}
}
