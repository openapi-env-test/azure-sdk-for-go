...
// AdministratorListResultIterator provides access to a complete listing of AzureADAdministrator values.
...
func (iter AdministratorListResultIterator) Value() AzureADAdministrator {
	if !iter.page.NotDone() {
		return AzureADAdministrator{}
	}
...
// AdministratorListResultPage contains a page of AzureADAdministrator values.
...
func (page AdministratorListResultPage) Values() []AzureADAdministrator {
	if page.alr.IsEmpty() {
		return nil
	}
...
type AdministratorProperties struct {
	// AdministratorType - Type of the sever administrator. Possible values include: 'ActiveDirectory'
...
// MarshalJSON is the custom marshaler for AzureADAdministrator.
func (aaa AzureADAdministrator) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if aaa.AdministratorProperties != nil {
		objectMap["properties"] = aaa.AdministratorProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for AzureADAdministrator struct.
func (aaa *AzureADAdministrator) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				aaa.AdministratorProperties = &administratorProperties
			}
		case "systemData":
			if v != nil {
...
// AzureADAdministratorsCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type AzureADAdministratorsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(AzureADAdministratorsClient) (AzureADAdministrator, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *AzureADAdministratorsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for AzureADAdministratorsCreateOrUpdateFuture.Result.
func (future *AzureADAdministratorsCreateOrUpdateFuture) result(client AzureADAdministratorsClient) (aaa AzureADAdministrator, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "mysqlflexibleservers.AzureADAdministratorsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		aaa.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("mysqlflexibleservers.AzureADAdministratorsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if aaa.Response.Response, err = future.GetResult(sender); err == nil && aaa.Response.Response.StatusCode != http.StatusNoContent {
		aaa, err = client.CreateOrUpdateResponder(aaa.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "mysqlflexibleservers.AzureADAdministratorsCreateOrUpdateFuture", "Result", aaa.Response.Response, "Failure responding to request")
		}
	}
	return
}

// AzureADAdministratorsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type AzureADAdministratorsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(AzureADAdministratorsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *AzureADAdministratorsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for AzureADAdministratorsDeleteFuture.Result.
func (future *AzureADAdministratorsDeleteFuture) result(client AzureADAdministratorsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "mysqlflexibleservers.AzureADAdministratorsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("mysqlflexibleservers.AzureADAdministratorsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type ConfigurationListForBatchUpdate struct {
	...
	// ResetAllToDefault - Whether to reset all server parameters to default. Possible values include: 'ResetAllToDefaultTrue', 'ResetAllToDefaultFalse'
