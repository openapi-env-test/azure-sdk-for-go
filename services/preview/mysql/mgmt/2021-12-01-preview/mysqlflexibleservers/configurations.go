...
// resourceGroupName - the name of the resource group. The name is case insensitive.
// serverName - the name of the server.
// tags - the tags of the server configuration.
// keyword - the keyword of the server configuration.
// page - the page of the server configuration.
// pageSize - the pageSize of the server configuration.
func (client ConfigurationsClient) ListByServer(ctx context.Context, resourceGroupName string, serverName string, tags string, keyword string, page *int32, pageSize *int32) (result ConfigurationListResultPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListByServerPreparer(ctx, resourceGroupName, serverName, tags, keyword, page, pageSize)
	if err != nil {
...
func (client ConfigurationsClient) ListByServerPreparer(ctx context.Context, resourceGroupName string, serverName string, tags string, keyword string, page *int32, pageSize *int32) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serverName":        autorest.Encode("path", serverName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	if len(keyword) > 0 {
		queryParameters["keyword"] = autorest.Encode("query", keyword)
	}
	if page != nil {
...
func (client ConfigurationsClient) ListByServerComplete(ctx context.Context, resourceGroupName string, serverName string, tags string, keyword string, page *int32, pageSize *int32) (result ConfigurationListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ConfigurationsClient.ListByServer")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListByServer(ctx, resourceGroupName, serverName, tags, keyword, page, pageSize)
	return
}
