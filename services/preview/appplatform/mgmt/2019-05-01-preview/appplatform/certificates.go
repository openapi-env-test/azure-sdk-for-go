...
// serviceName - the name of the Service resource.
// certificateName - the name of the certificate resource.
func (client CertificatesClient) List(ctx context.Context, resourceGroupName string, serviceName string, certificateName string) (result CertificateResourceCollection, err error) {
	if tracing.IsEnabled() {
