...
// VMWareDatastore a datastore resource
type VMWareDatastore struct {
	autorest.Response `json:"-"`
	// Properties - The properties of a datastore
	Properties *VMWareDatastoreProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; Resource ID.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; Resource name.
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for VMWareDatastore.
func (vwd VMWareDatastore) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if vwd.Properties != nil {
		objectMap["properties"] = vwd.Properties
	}
	return json.Marshal(objectMap)
}

// VMWareDatastoreBacking a datastore backing resource
type VMWareDatastoreBacking struct {
	autorest.Response `json:"-"`
	// Properties - The properties of a datastore backing
	Properties *VMWareDatastoreBackingProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; Resource ID.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; Resource name.
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for VMWareDatastoreBacking.
func (vwdb VMWareDatastoreBacking) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if vwdb.Properties != nil {
		objectMap["properties"] = vwdb.Properties
	}
	return json.Marshal(objectMap)
}

// VMWareDatastoreBackingProperties the properties of a datastore backing
type VMWareDatastoreBackingProperties struct {
	// BackingType - READ-ONLY; The type or protocol of the datastore backing. Possible values include: 'NFSv3', 'ISCSI'
	BackingType DatastoreBackingType `json:"backingType,omitempty"`
	// ReadBlockSize - READ-ONLY; Block size for data read
	ReadBlockSize *int64 `json:"readBlockSize,omitempty"`
	// WriteBlockSize - READ-ONLY; Block size for data write
	WriteBlockSize *int64 `json:"writeBlockSize,omitempty"`
	// StorageIP - READ-ONLY; IP address of device hosting storage
	StorageIP *string `json:"storageIP,omitempty"`
	// StorageFilePath - READ-ONLY; A unique file path for the volume. Used when creating mount targets
	StorageFilePath *string `json:"storageFilePath,omitempty"`
	// StorageVolumeName - READ-ONLY; Volume name of remote storage
	StorageVolumeName *string `json:"storageVolumeName,omitempty"`
	// ProvisioningState - READ-ONLY; The state of the datastore backing provisioning. Possible values include: 'DatastoreBackingProvisioningStateSucceeded', 'DatastoreBackingProvisioningStateFailed'
	ProvisioningState DatastoreBackingProvisioningState `json:"provisioningState,omitempty"`
}

// VMWareDatastoreBackingsCreateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type VMWareDatastoreBackingsCreateFuture struct {
	azure.Future
}

// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future *VMWareDatastoreBackingsCreateFuture) Result(client VMWareDatastoreBackingsClient) (vwdb VMWareDatastoreBacking, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "avs.VMWareDatastoreBackingsCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("avs.VMWareDatastoreBackingsCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vwdb.Response.Response, err = future.GetResult(sender); err == nil && vwdb.Response.Response.StatusCode != http.StatusNoContent {
		vwdb, err = client.CreateResponder(vwdb.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "avs.VMWareDatastoreBackingsCreateFuture", "Result", vwdb.Response.Response, "Failure responding to request")
		}
	}
	return
}

// VMWareDatastoreCreateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type VMWareDatastoreCreateFuture struct {
	azure.Future
}

// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future *VMWareDatastoreCreateFuture) Result(client VMWareDatastoreClient) (vwd VMWareDatastore, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "avs.VMWareDatastoreCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("avs.VMWareDatastoreCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vwd.Response.Response, err = future.GetResult(sender); err == nil && vwd.Response.Response.StatusCode != http.StatusNoContent {
		vwd, err = client.CreateResponder(vwd.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "avs.VMWareDatastoreCreateFuture", "Result", vwd.Response.Response, "Failure responding to request")
		}
	}
	return
}

// VMWareDatastoreProperties the properties of a datastore
type VMWareDatastoreProperties struct {
	// Size - READ-ONLY; Size of datastore (in GB)
	Size *int64 `json:"size,omitempty"`
	// ProvisioningState - READ-ONLY; The state of the datastore provisioning. Possible values include: 'DatastoreProvisioningStateSucceeded', 'DatastoreProvisioningStateFailed'
