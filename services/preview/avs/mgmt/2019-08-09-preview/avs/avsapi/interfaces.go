...
type PrivateCloudsClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, privateCloudName string, privateCloud avs.PrivateCloud) (result avs.PrivateCloudsUpdateFuture, err error)
}
...
type ClustersClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, cluster avs.Cluster) (result avs.ClustersUpdateFuture, err error)
}
...
type VMWareDatastoreBackingsClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, vmwareDatastoreBackingName string, backingType string, readBlockSize int64, writeBlockSize int64, storageIP string, storageFilePath string, storageVolumeName string) (result avs.VMWareDatastoreBackingsCreateFuture, err error)
}
...
type VMWareDatastoreClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, vmwareDatastoreBackingName string, vmwareDatastoreName string, dataStoreSize float64) (result avs.VMWareDatastoreCreateFuture, err error)
}
