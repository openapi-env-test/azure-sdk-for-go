...
// DatastoreBackingProvisioningState enumerates the values for datastore backing provisioning state.
type DatastoreBackingProvisioningState string

const (
	// DatastoreBackingProvisioningStateFailed ...
	DatastoreBackingProvisioningStateFailed DatastoreBackingProvisioningState = "Failed"
	// DatastoreBackingProvisioningStateSucceeded ...
	DatastoreBackingProvisioningStateSucceeded DatastoreBackingProvisioningState = "Succeeded"
)

// PossibleDatastoreBackingProvisioningStateValues returns an array of possible values for the DatastoreBackingProvisioningState const type.
func PossibleDatastoreBackingProvisioningStateValues() []DatastoreBackingProvisioningState {
	return []DatastoreBackingProvisioningState{DatastoreBackingProvisioningStateFailed, DatastoreBackingProvisioningStateSucceeded}
}

// DatastoreBackingType enumerates the values for datastore backing type.
type DatastoreBackingType string

const (
	// ISCSI ...
	ISCSI DatastoreBackingType = "iSCSI"
	// NFSv3 ...
	NFSv3 DatastoreBackingType = "NFSv3"
)

// PossibleDatastoreBackingTypeValues returns an array of possible values for the DatastoreBackingType const type.
func PossibleDatastoreBackingTypeValues() []DatastoreBackingType {
	return []DatastoreBackingType{ISCSI, NFSv3}
}
...
func PossibleDatastoreProvisioningStateValues() []DatastoreProvisioningState {
	return []DatastoreProvisioningState{DatastoreProvisioningStateFailed, DatastoreProvisioningStateSucceeded}
}
