...
const (
	// Artifact ...
	Artifact ConfigurationType = "Artifact"
	// File ...
	File ConfigurationType = "File"
)
...
func PossibleConfigurationTypeValues() []ConfigurationType {
	return []ConfigurationType{Artifact, File}
}
...
const (
	// Consistent ...
	Consistent StateValue = "Consistent"
	// InConsistent ...
	InConsistent StateValue = "InConsistent"
	// Updating ...
	Updating StateValue = "Updating"
)
...
func PossibleStateValueValues() []StateValue {
	return []StateValue{Consistent, InConsistent, Updating}
}
