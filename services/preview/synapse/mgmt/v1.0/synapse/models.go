...
type AzureADOnlyAuthenticationProperties struct {
	...
	// State - READ-ONLY; property configuration state. Possible values include: 'Consistent', 'InConsistent', 'Updating'
...
type SparkConfigProperties struct {
	...
	Filename *string `json:"filename,omitempty"`
	// ConfigurationType - The type of the spark config properties file. Possible values include: 'File', 'Artifact'
...
type SQLPoolResourceProperties struct {
	...
	CreationDate *date.Time `json:"creationDate,omitempty"`
	// StorageAccountType - The storage account type used to store backups for this sql pool. Possible values include: 'GRS', 'LRS'
