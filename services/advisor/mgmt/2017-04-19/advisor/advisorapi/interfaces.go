...
type SuppressionsClientAPI interface {
	Create(ctx context.Context, resourceURI string, recommendationID string, nameTest string, suppressionContract advisor.SuppressionContract) (result advisor.SuppressionContract, err error)
