...
// GetABC sends the get abc request.
// Parameters:
// name - name of metadata entity.
func (client RecommendationMetadataClient) GetABC(ctx context.Context, name string) (result MetadataEntity, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/RecommendationMetadataClient.GetABC")
		defer func() {
			sc := -1
	...
	req, err := client.GetABCPreparer(ctx, name)
	if err != nil {
		err = autorest.NewErrorWithError(err, "advisor.RecommendationMetadataClient", "GetABC", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "advisor.RecommendationMetadataClient", "GetABC", resp, "Failure sending request")
		return
	}

	result, err = client.GetABCResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "advisor.RecommendationMetadataClient", "GetABC", resp, "Failure responding to request")
		return
	}
...
func (client RecommendationMetadataClient) GetABCPreparer(ctx context.Context, name string) (*http.Request, error) {
...
func (client RecommendationMetadataClient) GetABCSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
}

// GetABCResponder handles the response to the GetABC request. The method always
// closes the http.Response Body.
func (client RecommendationMetadataClient) GetABCResponder(resp *http.Response) (result MetadataEntity, err error) {
