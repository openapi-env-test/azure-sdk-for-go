...
func (client SecurityPoliciesClient) Create(ctx context.Context, resourceGroupName string, profileName string, securityPolicyName string, securityPolicy SecurityPolicy) (result SecurityPoliciesCreateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.SecurityPoliciesClient", "Create", err.Error())
	}

	req, err := client.CreatePreparer(ctx, resourceGroupName, profileName, securityPolicyName, securityPolicy)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client SecurityPoliciesClient) CreateSender(req *http.Request) (future SecurityPoliciesCreateFuture, err error) {
	...
	future.Result = func(client SecurityPoliciesClient) (sp SecurityPolicy, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesCreateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.SecurityPoliciesCreateFuture")
			return
		}
		...
		if sp.Response.Response, err = future.GetResult(sender); err == nil && sp.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesCreateFuture", "Result", sp.Response.Response, "Failure responding to request")
			}
		}
		return
	}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.SecurityPoliciesClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, profileName, securityPolicyName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client SecurityPoliciesClient) DeleteSender(req *http.Request) (future SecurityPoliciesDeleteFuture, err error) {
	...
	future.Result = func(client SecurityPoliciesClient) (ar autorest.Response, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesDeleteFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.SecurityPoliciesDeleteFuture")
			return
		}
...
func (client SecurityPoliciesClient) Get(ctx context.Context, resourceGroupName string, profileName string, securityPolicyName string) (result SecurityPolicy, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.SecurityPoliciesClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, profileName, securityPolicyName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client SecurityPoliciesClient) ListByProfile(ctx context.Context, resourceGroupName string, profileName string) (result SecurityPolicyListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.SecurityPoliciesClient", "ListByProfile", err.Error())
	}

	result.fn = client.listByProfileNextResults
	req, err := client.ListByProfilePreparer(ctx, resourceGroupName, profileName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "ListByProfile", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "ListByProfile", resp, "Failure sending request")
		return
	}

	result.splr, err = client.ListByProfileResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "ListByProfile", resp, "Failure responding to request")
		return
	}
...
func (client SecurityPoliciesClient) listByProfileNextResults(ctx context.Context, lastResults SecurityPolicyListResult) (result SecurityPolicyListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "listByProfileNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "listByProfileNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByProfileResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "listByProfileNextResults", resp, "Failure responding to next results request")
	}
	return
}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.SecurityPoliciesClient", "Patch", err.Error())
	}

	req, err := client.PatchPreparer(ctx, resourceGroupName, profileName, securityPolicyName, securityPolicyParameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Patch", nil, "Failure preparing request")
		return
	}

	result, err = client.PatchSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesClient", "Patch", nil, "Failure sending request")
		return
	}
...
func (client SecurityPoliciesClient) PatchSender(req *http.Request) (future SecurityPoliciesPatchFuture, err error) {
	...
	future.Result = func(client SecurityPoliciesClient) (sp SecurityPolicy, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesPatchFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.SecurityPoliciesPatchFuture")
			return
		}
		sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
		if sp.Response.Response, err = future.GetResult(sender); err == nil && sp.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.SecurityPoliciesPatchFuture", "Result", sp.Response.Response, "Failure responding to request")
			}
		}
		return
	}
