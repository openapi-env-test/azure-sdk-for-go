...
func (client AFDOriginsClient) Create(ctx context.Context, resourceGroupName string, profileName string, originGroupName string, originName string, origin AFDOrigin) (result AFDOriginsCreateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.AFDOriginsClient", "Create", err.Error())
	}

	req, err := client.CreatePreparer(ctx, resourceGroupName, profileName, originGroupName, originName, origin)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client AFDOriginsClient) CreateSender(req *http.Request) (future AFDOriginsCreateFuture, err error) {
	...
	future.Result = func(client AFDOriginsClient) (ao AFDOrigin, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsCreateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.AFDOriginsCreateFuture")
			return
		}
		...
		if ao.Response.Response, err = future.GetResult(sender); err == nil && ao.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsCreateFuture", "Result", ao.Response.Response, "Failure responding to request")
			}
		}
		return
	}
...
func (client AFDOriginsClient) Delete(ctx context.Context, resourceGroupName string, profileName string, originGroupName string, originName string) (result AFDOriginsDeleteFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.AFDOriginsClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, profileName, originGroupName, originName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client AFDOriginsClient) DeleteSender(req *http.Request) (future AFDOriginsDeleteFuture, err error) {
	...
	future.Result = func(client AFDOriginsClient) (ar autorest.Response, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsDeleteFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.AFDOriginsDeleteFuture")
			return
		}
...
func (client AFDOriginsClient) Get(ctx context.Context, resourceGroupName string, profileName string, originGroupName string, originName string) (result AFDOrigin, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.AFDOriginsClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, profileName, originGroupName, originName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client AFDOriginsClient) ListByOriginGroup(ctx context.Context, resourceGroupName string, profileName string, originGroupName string) (result AFDOriginListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.AFDOriginsClient", "ListByOriginGroup", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "ListByOriginGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "ListByOriginGroup", resp, "Failure sending request")
		return
	}

	result.aolr, err = client.ListByOriginGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "ListByOriginGroup", resp, "Failure responding to request")
		return
	}
...
func (client AFDOriginsClient) listByOriginGroupNextResults(ctx context.Context, lastResults AFDOriginListResult) (result AFDOriginListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "listByOriginGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "listByOriginGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByOriginGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "listByOriginGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.AFDOriginsClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, profileName, originGroupName, originName, originUpdateProperties)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsClient", "Update", nil, "Failure sending request")
		return
	}
...
func (client AFDOriginsClient) UpdateSender(req *http.Request) (future AFDOriginsUpdateFuture, err error) {
	...
	future.Result = func(client AFDOriginsClient) (ao AFDOrigin, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsUpdateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.AFDOriginsUpdateFuture")
			return
		}
		sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
		if ao.Response.Response, err = future.GetResult(sender); err == nil && ao.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.AFDOriginsUpdateFuture", "Result", ao.Response.Response, "Failure responding to request")
			}
		}
		return
	}
