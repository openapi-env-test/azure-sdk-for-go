...
func (client RulesClient) Create(ctx context.Context, resourceGroupName string, profileName string, ruleSetName string, ruleName string, rule Rule) (result RulesCreateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.RulesClient", "Create", err.Error())
	}

	req, err := client.CreatePreparer(ctx, resourceGroupName, profileName, ruleSetName, ruleName, rule)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client RulesClient) CreateSender(req *http.Request) (future RulesCreateFuture, err error) {
	...
	future.Result = func(client RulesClient) (r Rule, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.RulesCreateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.RulesCreateFuture")
			return
		}
		...
		if r.Response.Response, err = future.GetResult(sender); err == nil && r.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.RulesCreateFuture", "Result", r.Response.Response, "Failure responding to request")
			}
		}
		return
	}
...
func (client RulesClient) Delete(ctx context.Context, resourceGroupName string, profileName string, ruleSetName string, ruleName string) (result RulesDeleteFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.RulesClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, profileName, ruleSetName, ruleName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client RulesClient) DeleteSender(req *http.Request) (future RulesDeleteFuture, err error) {
	...
	future.Result = func(client RulesClient) (ar autorest.Response, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.RulesDeleteFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.RulesDeleteFuture")
			return
		}
...
func (client RulesClient) Get(ctx context.Context, resourceGroupName string, profileName string, ruleSetName string, ruleName string) (result Rule, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.RulesClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, profileName, ruleSetName, ruleName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client RulesClient) ListByRuleSet(ctx context.Context, resourceGroupName string, profileName string, ruleSetName string) (result RuleListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.RulesClient", "ListByRuleSet", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "ListByRuleSet", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "ListByRuleSet", resp, "Failure sending request")
		return
	}

	result.rlr, err = client.ListByRuleSetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "ListByRuleSet", resp, "Failure responding to request")
		return
	}
...
func (client RulesClient) listByRuleSetNextResults(ctx context.Context, lastResults RuleListResult) (result RuleListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.RulesClient", "listByRuleSetNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.RulesClient", "listByRuleSetNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByRuleSetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "listByRuleSetNextResults", resp, "Failure responding to next results request")
	}
	return
}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.RulesClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, profileName, ruleSetName, ruleName, ruleUpdateProperties)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RulesClient", "Update", nil, "Failure sending request")
		return
	}
...
func (client RulesClient) UpdateSender(req *http.Request) (future RulesUpdateFuture, err error) {
	...
	future.Result = func(client RulesClient) (r Rule, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.RulesUpdateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.RulesUpdateFuture")
			return
		}
		sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
		if r.Response.Response, err = future.GetResult(sender); err == nil && r.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.RulesUpdateFuture", "Result", r.Response.Response, "Failure responding to request")
			}
		}
		return
	}
