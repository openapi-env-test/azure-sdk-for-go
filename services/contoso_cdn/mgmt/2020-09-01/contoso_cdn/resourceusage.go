...
func (client ResourceUsageClient) List(ctx context.Context) (result ResourceUsageListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.ResourceUsageClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.ResourceUsageClient", "List", resp, "Failure sending request")
		return
	}

	result.rulr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.ResourceUsageClient", "List", resp, "Failure responding to request")
		return
	}
...
func (client ResourceUsageClient) listNextResults(ctx context.Context, lastResults ResourceUsageListResult) (result ResourceUsageListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.ResourceUsageClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.ResourceUsageClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.ResourceUsageClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
