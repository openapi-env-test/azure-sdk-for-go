...
func (client OriginGroupsClient) Create(ctx context.Context, resourceGroupName string, profileName string, endpointName string, originGroupName string, originGroup OriginGroup) (result OriginGroupsCreateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.OriginGroupsClient", "Create", err.Error())
	}

	req, err := client.CreatePreparer(ctx, resourceGroupName, profileName, endpointName, originGroupName, originGroup)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client OriginGroupsClient) CreateSender(req *http.Request) (future OriginGroupsCreateFuture, err error) {
	...
	future.Result = func(client OriginGroupsClient) (og OriginGroup, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsCreateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.OriginGroupsCreateFuture")
			return
		}
		...
		if og.Response.Response, err = future.GetResult(sender); err == nil && og.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsCreateFuture", "Result", og.Response.Response, "Failure responding to request")
			}
		}
		return
	}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.OriginGroupsClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, profileName, endpointName, originGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client OriginGroupsClient) DeleteSender(req *http.Request) (future OriginGroupsDeleteFuture, err error) {
	...
	future.Result = func(client OriginGroupsClient) (ar autorest.Response, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsDeleteFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.OriginGroupsDeleteFuture")
			return
		}
...
func (client OriginGroupsClient) Get(ctx context.Context, resourceGroupName string, profileName string, endpointName string, originGroupName string) (result OriginGroup, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.OriginGroupsClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, profileName, endpointName, originGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client OriginGroupsClient) ListByEndpoint(ctx context.Context, resourceGroupName string, profileName string, endpointName string) (result OriginGroupListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.OriginGroupsClient", "ListByEndpoint", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "ListByEndpoint", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "ListByEndpoint", resp, "Failure sending request")
		return
	}

	result.oglr, err = client.ListByEndpointResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "ListByEndpoint", resp, "Failure responding to request")
		return
	}
...
func (client OriginGroupsClient) listByEndpointNextResults(ctx context.Context, lastResults OriginGroupListResult) (result OriginGroupListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "listByEndpointNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "listByEndpointNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByEndpointResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "listByEndpointNextResults", resp, "Failure responding to next results request")
	}
	return
}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.OriginGroupsClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, profileName, endpointName, originGroupName, originGroupUpdateProperties)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsClient", "Update", nil, "Failure sending request")
		return
	}
...
func (client OriginGroupsClient) UpdateSender(req *http.Request) (future OriginGroupsUpdateFuture, err error) {
	...
	future.Result = func(client OriginGroupsClient) (og OriginGroup, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsUpdateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.OriginGroupsUpdateFuture")
			return
		}
		sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
		if og.Response.Response, err = future.GetResult(sender); err == nil && og.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.OriginGroupsUpdateFuture", "Result", og.Response.Response, "Failure responding to request")
			}
		}
		return
	}
