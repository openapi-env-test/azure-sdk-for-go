...
func (client AFDProfilesClient) CheckHostNameAvailability(ctx context.Context, resourceGroupName string, profileName string, checkHostNameAvailabilityInput ValidateCustomDomainInput) (result ValidateCustomDomainOutput, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.AFDProfilesClient", "CheckHostNameAvailability", err.Error())
	}

	req, err := client.CheckHostNameAvailabilityPreparer(ctx, resourceGroupName, profileName, checkHostNameAvailabilityInput)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "CheckHostNameAvailability", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "CheckHostNameAvailability", resp, "Failure sending request")
		return
	}

	result, err = client.CheckHostNameAvailabilityResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "CheckHostNameAvailability", resp, "Failure responding to request")
		return
	}
...
func (client AFDProfilesClient) ListResourceUsage(ctx context.Context, resourceGroupName string, profileName string) (result UsagesListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.AFDProfilesClient", "ListResourceUsage", err.Error())
	}

	result.fn = client.listResourceUsageNextResults
	req, err := client.ListResourceUsagePreparer(ctx, resourceGroupName, profileName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "ListResourceUsage", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "ListResourceUsage", resp, "Failure sending request")
		return
	}

	result.ulr, err = client.ListResourceUsageResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "ListResourceUsage", resp, "Failure responding to request")
		return
	}
...
func (client AFDProfilesClient) listResourceUsageNextResults(ctx context.Context, lastResults UsagesListResult) (result UsagesListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "listResourceUsageNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "listResourceUsageNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResourceUsageResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.AFDProfilesClient", "listResourceUsageNextResults", resp, "Failure responding to next results request")
	}
	return
}
