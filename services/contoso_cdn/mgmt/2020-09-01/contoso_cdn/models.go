...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/contoso_cdn/mgmt/2020-09-01/contoso_cdn"
...
// CdnCertificateSourceParameters defines the parameters for using CDN managed certificate for securing
// custom domain.
...
// CdnManagedHTTPSParameters defines the certificate source parameters using CDN managed certificate for
// enabling SSL.
...
// MarshalJSON is the custom marshaler for CdnManagedHTTPSParameters.
func (cmhp CdnManagedHTTPSParameters) MarshalJSON() ([]byte, error) {
	cmhp.CertificateSource = CertificateSourceCdn
	objectMap := make(map[string]interface{})
	if cmhp.CertificateSourceParameters != nil {
		objectMap["certificateSourceParameters"] = cmhp.CertificateSourceParameters
	}
	if cmhp.ProtocolType != "" {
		objectMap["protocolType"] = cmhp.ProtocolType
	}
	if cmhp.MinimumTLSVersion != "" {
		objectMap["minimumTlsVersion"] = cmhp.MinimumTLSVersion
	}
	if cmhp.CertificateSource != "" {
		objectMap["certificateSource"] = cmhp.CertificateSource
	}
	return json.Marshal(objectMap)
}

// AsCdnManagedHTTPSParameters is the BasicCustomDomainHTTPSParameters implementation for CdnManagedHTTPSParameters.
func (cmhp CdnManagedHTTPSParameters) AsCdnManagedHTTPSParameters() (*CdnManagedHTTPSParameters, bool) {
	return &cmhp, true
}

// AsUserManagedHTTPSParameters is the BasicCustomDomainHTTPSParameters implementation for CdnManagedHTTPSParameters.
func (cmhp CdnManagedHTTPSParameters) AsUserManagedHTTPSParameters() (*UserManagedHTTPSParameters, bool) {
	return nil, false
}

// AsCustomDomainHTTPSParameters is the BasicCustomDomainHTTPSParameters implementation for CdnManagedHTTPSParameters.
func (cmhp CdnManagedHTTPSParameters) AsCustomDomainHTTPSParameters() (*CustomDomainHTTPSParameters, bool) {
	return nil, false
}

// AsBasicCustomDomainHTTPSParameters is the BasicCustomDomainHTTPSParameters implementation for CdnManagedHTTPSParameters.
func (cmhp CdnManagedHTTPSParameters) AsBasicCustomDomainHTTPSParameters() (BasicCustomDomainHTTPSParameters, bool) {
	return &cmhp, true
}
...
type CdnWebApplicationFirewallPolicy struct {
	autorest.Response `json:"-"`
	// CdnWebApplicationFirewallPolicyProperties - Properties of the web application firewall policy.
	*CdnWebApplicationFirewallPolicyProperties `json:"properties,omitempty"`
...
// MarshalJSON is the custom marshaler for CdnWebApplicationFirewallPolicy.
func (cwafp CdnWebApplicationFirewallPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cwafp.CdnWebApplicationFirewallPolicyProperties != nil {
		objectMap["properties"] = cwafp.CdnWebApplicationFirewallPolicyProperties
	}
	if cwafp.Etag != nil {
		objectMap["etag"] = cwafp.Etag
	}
	if cwafp.Sku != nil {
		objectMap["sku"] = cwafp.Sku
	}
	if cwafp.Location != nil {
		objectMap["location"] = cwafp.Location
	}
	if cwafp.Tags != nil {
		objectMap["tags"] = cwafp.Tags
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for CdnWebApplicationFirewallPolicy struct.
func (cwafp *CdnWebApplicationFirewallPolicy) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var cdnWebApplicationFirewallPolicyProperties CdnWebApplicationFirewallPolicyProperties
				err = json.Unmarshal(*v, &cdnWebApplicationFirewallPolicyProperties)
				if err != nil {
					return err
				}
				cwafp.CdnWebApplicationFirewallPolicyProperties = &cdnWebApplicationFirewallPolicyProperties
			}
		case "etag":
			if v != nil {
				var etag string
...
// CdnWebApplicationFirewallPolicyList defines a list of WebApplicationFirewallPolicies for Azure CDN. It
...
type CdnWebApplicationFirewallPolicyList struct {
	...
	Value *[]CdnWebApplicationFirewallPolicy `json:"value,omitempty"`
	// NextLink - URL to get the next set of WebApplicationFirewallPolicy objects if there are any.
	NextLink *string `json:"nextLink,omitempty"`
}

// MarshalJSON is the custom marshaler for CdnWebApplicationFirewallPolicyList.
func (cwafpl CdnWebApplicationFirewallPolicyList) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cwafpl.NextLink != nil {
		objectMap["nextLink"] = cwafpl.NextLink
	}
	return json.Marshal(objectMap)
}

// CdnWebApplicationFirewallPolicyListIterator provides access to a complete listing of
// CdnWebApplicationFirewallPolicy values.
type CdnWebApplicationFirewallPolicyListIterator struct {
	i    int
	page CdnWebApplicationFirewallPolicyListPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *CdnWebApplicationFirewallPolicyListIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/CdnWebApplicationFirewallPolicyListIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *CdnWebApplicationFirewallPolicyListIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter CdnWebApplicationFirewallPolicyListIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter CdnWebApplicationFirewallPolicyListIterator) Response() CdnWebApplicationFirewallPolicyList {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter CdnWebApplicationFirewallPolicyListIterator) Value() CdnWebApplicationFirewallPolicy {
	if !iter.page.NotDone() {
...
// Creates a new instance of the CdnWebApplicationFirewallPolicyListIterator type.
func NewCdnWebApplicationFirewallPolicyListIterator(page CdnWebApplicationFirewallPolicyListPage) CdnWebApplicationFirewallPolicyListIterator {
	return CdnWebApplicationFirewallPolicyListIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (cwafpl CdnWebApplicationFirewallPolicyList) IsEmpty() bool {
	return cwafpl.Value == nil || len(*cwafpl.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (cwafpl CdnWebApplicationFirewallPolicyList) hasNextLink() bool {
	return cwafpl.NextLink != nil && len(*cwafpl.NextLink) != 0
}

// cdnWebApplicationFirewallPolicyListPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (cwafpl CdnWebApplicationFirewallPolicyList) cdnWebApplicationFirewallPolicyListPreparer(ctx context.Context) (*http.Request, error) {
	if !cwafpl.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(cwafpl.NextLink)))
}

// CdnWebApplicationFirewallPolicyListPage contains a page of CdnWebApplicationFirewallPolicy values.
type CdnWebApplicationFirewallPolicyListPage struct {
	fn     func(context.Context, CdnWebApplicationFirewallPolicyList) (CdnWebApplicationFirewallPolicyList, error)
	cwafpl CdnWebApplicationFirewallPolicyList
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *CdnWebApplicationFirewallPolicyListPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/CdnWebApplicationFirewallPolicyListPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.cwafpl)
		if err != nil {
			return err
		}
		page.cwafpl = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *CdnWebApplicationFirewallPolicyListPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page CdnWebApplicationFirewallPolicyListPage) NotDone() bool {
	return !page.cwafpl.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page CdnWebApplicationFirewallPolicyListPage) Response() CdnWebApplicationFirewallPolicyList {
	return page.cwafpl
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page CdnWebApplicationFirewallPolicyListPage) Values() []CdnWebApplicationFirewallPolicy {
	if page.cwafpl.IsEmpty() {
		return nil
	}
	return *page.cwafpl.Value
}

// Creates a new instance of the CdnWebApplicationFirewallPolicyListPage type.
func NewCdnWebApplicationFirewallPolicyListPage(cur CdnWebApplicationFirewallPolicyList, getNextPage func(context.Context, CdnWebApplicationFirewallPolicyList) (CdnWebApplicationFirewallPolicyList, error)) CdnWebApplicationFirewallPolicyListPage {
	return CdnWebApplicationFirewallPolicyListPage{
		fn:     getNextPage,
		cwafpl: cur,
	}
}

// CdnWebApplicationFirewallPolicyPatchParameters properties required to update a
...
// MarshalJSON is the custom marshaler for CdnWebApplicationFirewallPolicyPatchParameters.
func (cwafppp CdnWebApplicationFirewallPolicyPatchParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cwafppp.Tags != nil {
		objectMap["tags"] = cwafppp.Tags
	}
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for CdnWebApplicationFirewallPolicyProperties.
func (cwafpp CdnWebApplicationFirewallPolicyProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cwafpp.PolicySettings != nil {
		objectMap["policySettings"] = cwafpp.PolicySettings
	}
	if cwafpp.RateLimitRules != nil {
		objectMap["rateLimitRules"] = cwafpp.RateLimitRules
	}
	if cwafpp.CustomRules != nil {
		objectMap["customRules"] = cwafpp.CustomRules
	}
	if cwafpp.ManagedRules != nil {
		objectMap["managedRules"] = cwafpp.ManagedRules
	}
	return json.Marshal(objectMap)
}
...
type BasicCustomDomainHTTPSParameters interface {
	AsCdnManagedHTTPSParameters() (*CdnManagedHTTPSParameters, bool)
...
func unmarshalBasicCustomDomainHTTPSParameters(body []byte) (BasicCustomDomainHTTPSParameters, error) {
	...
	case string(CertificateSourceCdn):
		var cmhp CdnManagedHTTPSParameters
		err := json.Unmarshal(body, &cmhp)
		return cmhp, err
...
// AsCdnManagedHTTPSParameters is the BasicCustomDomainHTTPSParameters implementation for CustomDomainHTTPSParameters.
func (cdhp CustomDomainHTTPSParameters) AsCdnManagedHTTPSParameters() (*CdnManagedHTTPSParameters, bool) {
	return nil, false
}
...
type PoliciesCreateOrUpdateFuture struct {
	...
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PoliciesClient) (CdnWebApplicationFirewallPolicy, error)
}
...
// AsCdnManagedHTTPSParameters is the BasicCustomDomainHTTPSParameters implementation for UserManagedHTTPSParameters.
func (umhp UserManagedHTTPSParameters) AsCdnManagedHTTPSParameters() (*CdnManagedHTTPSParameters, bool) {
	return nil, false
}
