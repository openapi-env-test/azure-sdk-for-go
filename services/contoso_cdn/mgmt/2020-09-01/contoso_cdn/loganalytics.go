...
func (client LogAnalyticsClient) GetLogAnalyticsLocations(ctx context.Context, resourceGroupName string, profileName string) (result ContinentsResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.LogAnalyticsClient", "GetLogAnalyticsLocations", err.Error())
	}

	req, err := client.GetLogAnalyticsLocationsPreparer(ctx, resourceGroupName, profileName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsLocations", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsLocations", resp, "Failure sending request")
		return
	}

	result, err = client.GetLogAnalyticsLocationsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsLocations", resp, "Failure responding to request")
		return
	}
...
func (client LogAnalyticsClient) GetLogAnalyticsMetrics(ctx context.Context, resourceGroupName string, profileName string, metrics []string, dateTimeBegin date.Time, dateTimeEnd date.Time, granularity string, groupBy []string, continents []string, countryOrRegions []string, customDomains []string, protocols []string) (result MetricsResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.LogAnalyticsClient", "GetLogAnalyticsMetrics", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsMetrics", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsMetrics", resp, "Failure sending request")
		return
	}

	result, err = client.GetLogAnalyticsMetricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsMetrics", resp, "Failure responding to request")
		return
	}
...
func (client LogAnalyticsClient) GetLogAnalyticsRankings(ctx context.Context, resourceGroupName string, profileName string, rankings []string, metrics []string, maxRanking float64, dateTimeBegin date.Time, dateTimeEnd date.Time, customDomains []string) (result RankingsResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: metrics,
			Constraints: []validation.Constraint{{Target: "metrics", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.LogAnalyticsClient", "GetLogAnalyticsRankings", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsRankings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsRankings", resp, "Failure sending request")
		return
	}

	result, err = client.GetLogAnalyticsRankingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsRankings", resp, "Failure responding to request")
		return
	}
...
func (client LogAnalyticsClient) GetLogAnalyticsResources(ctx context.Context, resourceGroupName string, profileName string) (result ResourcesResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.LogAnalyticsClient", "GetLogAnalyticsResources", err.Error())
	}

	req, err := client.GetLogAnalyticsResourcesPreparer(ctx, resourceGroupName, profileName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsResources", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsResources", resp, "Failure sending request")
		return
	}

	result, err = client.GetLogAnalyticsResourcesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetLogAnalyticsResources", resp, "Failure responding to request")
		return
	}
...
func (client LogAnalyticsClient) GetWafLogAnalyticsMetrics(ctx context.Context, resourceGroupName string, profileName string, metrics []string, dateTimeBegin date.Time, dateTimeEnd date.Time, granularity string, actions []string, groupBy []string, ruleTypes []string) (result WafMetricsResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: metrics,
			Constraints: []validation.Constraint{{Target: "metrics", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsMetrics", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsMetrics", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsMetrics", resp, "Failure sending request")
		return
	}

	result, err = client.GetWafLogAnalyticsMetricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsMetrics", resp, "Failure responding to request")
		return
	}
...
func (client LogAnalyticsClient) GetWafLogAnalyticsRankings(ctx context.Context, resourceGroupName string, profileName string, metrics []string, dateTimeBegin date.Time, dateTimeEnd date.Time, maxRanking float64, rankings []string, actions []string, ruleTypes []string) (result WafRankingsResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsRankings", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsRankings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsRankings", resp, "Failure sending request")
		return
	}

	result, err = client.GetWafLogAnalyticsRankingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.LogAnalyticsClient", "GetWafLogAnalyticsRankings", resp, "Failure responding to request")
		return
	}
