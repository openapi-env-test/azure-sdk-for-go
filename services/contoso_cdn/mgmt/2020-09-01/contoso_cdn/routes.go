...
func (client RoutesClient) Create(ctx context.Context, resourceGroupName string, profileName string, endpointName string, routeName string, route Route) (result RoutesCreateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.RoutesClient", "Create", err.Error())
	}

	req, err := client.CreatePreparer(ctx, resourceGroupName, profileName, endpointName, routeName, route)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client RoutesClient) CreateSender(req *http.Request) (future RoutesCreateFuture, err error) {
	...
	future.Result = func(client RoutesClient) (r Route, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.RoutesCreateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.RoutesCreateFuture")
			return
		}
		...
		if r.Response.Response, err = future.GetResult(sender); err == nil && r.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.RoutesCreateFuture", "Result", r.Response.Response, "Failure responding to request")
			}
		}
		return
	}
...
func (client RoutesClient) Delete(ctx context.Context, resourceGroupName string, profileName string, endpointName string, routeName string) (result RoutesDeleteFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("contosocdn.RoutesClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, profileName, endpointName, routeName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client RoutesClient) DeleteSender(req *http.Request) (future RoutesDeleteFuture, err error) {
	...
	future.Result = func(client RoutesClient) (ar autorest.Response, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.RoutesDeleteFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.RoutesDeleteFuture")
			return
		}
...
func (client RoutesClient) Get(ctx context.Context, resourceGroupName string, profileName string, endpointName string, routeName string) (result Route, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.RoutesClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, profileName, endpointName, routeName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client RoutesClient) ListByEndpoint(ctx context.Context, resourceGroupName string, profileName string, endpointName string) (result RouteListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.RoutesClient", "ListByEndpoint", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "ListByEndpoint", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "ListByEndpoint", resp, "Failure sending request")
		return
	}

	result.rlr, err = client.ListByEndpointResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "ListByEndpoint", resp, "Failure responding to request")
		return
	}
...
func (client RoutesClient) listByEndpointNextResults(ctx context.Context, lastResults RouteListResult) (result RouteListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "listByEndpointNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "listByEndpointNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByEndpointResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "listByEndpointNextResults", resp, "Failure responding to next results request")
	}
	return
}
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("contosocdn.RoutesClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, profileName, endpointName, routeName, routeUpdateProperties)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.RoutesClient", "Update", nil, "Failure sending request")
		return
	}
...
func (client RoutesClient) UpdateSender(req *http.Request) (future RoutesUpdateFuture, err error) {
	...
	future.Result = func(client RoutesClient) (r Route, err error) {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "contosocdn.RoutesUpdateFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("contosocdn.RoutesUpdateFuture")
			return
		}
		sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
		if r.Response.Response, err = future.GetResult(sender); err == nil && r.Response.Response.StatusCode != http.StatusNoContent {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "contosocdn.RoutesUpdateFuture", "Result", r.Response.Response, "Failure responding to request")
			}
		}
		return
	}
