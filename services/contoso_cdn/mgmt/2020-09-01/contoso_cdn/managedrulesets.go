...
func (client ManagedRuleSetsClient) List(ctx context.Context) (result ManagedRuleSetDefinitionListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.ManagedRuleSetsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "contosocdn.ManagedRuleSetsClient", "List", resp, "Failure sending request")
		return
	}

	result.mrsdl, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.ManagedRuleSetsClient", "List", resp, "Failure responding to request")
		return
	}
...
func (client ManagedRuleSetsClient) listNextResults(ctx context.Context, lastResults ManagedRuleSetDefinitionList) (result ManagedRuleSetDefinitionList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "contosocdn.ManagedRuleSetsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "contosocdn.ManagedRuleSetsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "contosocdn.ManagedRuleSetsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
