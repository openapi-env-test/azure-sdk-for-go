...
type FactoriesClientAPI interface {
	...
	ConfigureFactoryRepoForDemo(ctx context.Context, locationID string, factoryRepoUpdate datafactory.FactoryRepoUpdate) (result datafactory.Factory, err error)
