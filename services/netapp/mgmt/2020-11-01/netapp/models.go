...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/netapp/mgmt/2020-11-01/netapp"
...
type AccountEncryption struct {
	// KeySource - Encryption Key Source. Possible values are: 'Microsoft.NetApp'. Possible values include: 'MicrosoftNetApp'
