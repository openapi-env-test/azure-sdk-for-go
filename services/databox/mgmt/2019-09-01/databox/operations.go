...
// Get this method gets all the operations.
func (client OperationsClient) Get(ctx context.Context) (result OperationListPage, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "databox.OperationsClient", "Get", nil , "Failure preparing request")
    return
    }
            ...
            err = autorest.NewErrorWithError(err, "databox.OperationsClient", "Get", resp, "Failure sending request")
            return
            }

            result.ol, err = client.GetResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "databox.OperationsClient", "Get", resp, "Failure responding to request")
            }
...
func (client OperationsClient) GetResponder(resp *http.Response) (result OperationList, err error) {
    ...
    result.Response = autorest.Response{Response: resp}
        return
            ...
            if err != nil {
            return result, autorest.NewErrorWithError(err, "databox.OperationsClient", "getNextResults", nil , "Failure preparing next results request")
            }
            if req == nil {
            return
            }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            return result, autorest.NewErrorWithError(err, "databox.OperationsClient", "getNextResults", resp, "Failure sending next results request")
            }
            result, err = client.GetResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "databox.OperationsClient", "getNextResults", resp, "Failure responding to next results request")
            }
            return
                    }
