...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/databox/mgmt/2021-05-01/databox"
	"github.com/Azure/go-autorest/autorest"
)

// BaseClientAPI contains the set of methods on the BaseClient type.
type BaseClientAPI interface {
	Mitigate(ctx context.Context, jobName string, resourceGroupName string, mitigateJobRequest databox.MitigateJobRequest) (result autorest.Response, err error)
}

var _ BaseClientAPI = (*databox.BaseClient)(nil)

// OperationsClientAPI contains the set of methods on the OperationsClient type.
type OperationsClientAPI interface {
	ListAA(ctx context.Context) (result databox.OperationListPage, err error)
	ListAAComplete(ctx context.Context) (result databox.OperationListIterator, err error)
}
