...
func NewRecipientTransfersClient(subscriptionID string, subscriptionID1 string) RecipientTransfersClient {
	return NewRecipientTransfersClientWithBaseURI(DefaultBaseURI, subscriptionID, subscriptionID1)
}
...
// stack).
func NewRecipientTransfersClientWithBaseURI(baseURI string, subscriptionID string, subscriptionID1 string) RecipientTransfersClient {
	return RecipientTransfersClient{NewWithBaseURI(baseURI, subscriptionID, subscriptionID1)}
}
...
func (client RecipientTransfersClient) Accept(ctx context.Context, transferName string, parameters AcceptTransferRequest) (result RecipientTransferDetails, err error) {
	...
	req, err := client.AcceptPreparer(ctx, transferName, parameters)
	if err != nil {
...
func (client RecipientTransfersClient) AcceptPreparer(ctx context.Context, transferName string, parameters AcceptTransferRequest) (*http.Request, error) {
...
func (client RecipientTransfersClient) Validate(ctx context.Context, transferName string, parameters AcceptTransferRequest) (result ValidateTransferListResponse, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/RecipientTransfersClient.Validate")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	req, err := client.ValidatePreparer(ctx, transferName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "billing.RecipientTransfersClient", "Validate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "billing.RecipientTransfersClient", "Validate", resp, "Failure sending request")
		return
	}

	result, err = client.ValidateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "billing.RecipientTransfersClient", "Validate", resp, "Failure responding to request")
	}
...
func (client RecipientTransfersClient) ValidatePreparer(ctx context.Context, transferName string, parameters AcceptTransferRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"transferName": autorest.Encode("path", transferName),
	}
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/providers/Microsoft.Billing/transfers/{transferName}/validateTransfer", pathParameters),
		autorest.WithJSON(parameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// http.Response Body if it receives an error.
func (client RecipientTransfersClient) ValidateSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
}

// ValidateResponder handles the response to the Validate request. The method always
// closes the http.Response Body.
func (client RecipientTransfersClient) ValidateResponder(resp *http.Response) (result ValidateTransferListResponse, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
