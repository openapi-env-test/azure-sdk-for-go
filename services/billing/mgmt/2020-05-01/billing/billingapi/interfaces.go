...
type PartnerTransfersClientAPI interface {
	Cancel(ctx context.Context, billingAccountName string, billingProfileName string, customerName string, transferName string) (result billing.TransferDetails, err error)
	Get(ctx context.Context, billingAccountName string, billingProfileName string, customerName string, transferName string) (result billing.TransferDetails, err error)
	Initiate(ctx context.Context, billingAccountName string, billingProfileName string, customerName string, parameters billing.InitiateTransferRequest) (result billing.TransferDetails, err error)
	List(ctx context.Context, billingAccountName string, billingProfileName string, customerName string) (result billing.TransferDetailsListResultPage, err error)
	ListComplete(ctx context.Context, billingAccountName string, billingProfileName string, customerName string) (result billing.TransferDetailsListResultIterator, err error)
}
