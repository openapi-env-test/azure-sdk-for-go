...
// LinkedWorkspacesClientAPI contains the set of methods on the LinkedWorkspacesClient type.
type LinkedWorkspacesClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, workspaceName string, parameters machinelearningservices.LinkedWorkspaceCreateDto) (result machinelearningservices.LinkedWorkspace, err error)
	Delete(ctx context.Context, resourceGroupName string, workspaceName string, linkName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, workspaceName string, linkName string) (result machinelearningservices.LinkedWorkspace, err error)
	List(ctx context.Context, resourceGroupName string, workspaceName string, linkSubscriptionID string, linkResourceGroup string, linkResourceName string, linkResourceID string, linkType machinelearningservices.LinkType, uaiResourceID string) (result machinelearningservices.ListLinkedWorkspace, err error)
	Update(ctx context.Context, resourceGroupName string, workspaceName string, linkName string, parameters machinelearningservices.LinkedWorkspaceUpdateDto) (result machinelearningservices.LinkedWorkspace, err error)
}

var _ LinkedWorkspacesClientAPI = (*machinelearningservices.LinkedWorkspacesClient)(nil)
