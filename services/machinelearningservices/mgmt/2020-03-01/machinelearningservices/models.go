...
func PossibleResourceIdentityTypeValues() []ResourceIdentityType {
	return []ResourceIdentityType{SystemAssigned, SystemAssignedUserAssigned}
}
...
type LinkedWorkspace struct {
	...
	// LinkType - READ-ONLY; The type of the linked workspace. Possible values include: 'Synapse'
	LinkType LinkType `json:"linkType,omitempty"`
	// SubscriptionID - SubscriptionId of the target of the linked workspace.
	SubscriptionID *string `json:"subscriptionId,omitempty"`
	// ResourceGroupName - Resource group name of the target of the linked workspace.
	ResourceGroupName *string `json:"resourceGroupName,omitempty"`
	// ProviderNamespace - Resource provider namespace of the target of the linked workspace.
	ProviderNamespace *string `json:"providerNamespace,omitempty"`
	// ResourceType - Resource type of the target of the linked workspace.
	ResourceType *string `json:"resourceType,omitempty"`
	// WorkspaceName - Resource name of the target of the linked workspace.
	WorkspaceName *string `json:"workspaceName,omitempty"`
	// ResourceID - ResourceId of the target of the linked workspace.
	ResourceID *string `json:"resourceId,omitempty"`
	// UserAssignedIdentityResourceID - ResourceId of the user assigned identity that used to communicate with the linked workspace.
	UserAssignedIdentityResourceID *string `json:"userAssignedIdentityResourceId,omitempty"`
}

// LinkedWorkspaceCreateDto object used for creating linked workspace.
type LinkedWorkspaceCreateDto struct {
	// LinkName - Friendly name of the linked workspace
	LinkName *string `json:"linkName,omitempty"`
	// ResourceID - ResourceId of the linked workspace
	ResourceID *string `json:"resourceId,omitempty"`
	// UserAssignedIdentityResourceID - ResourceId of the user assigned identity for the linked workspace
	UserAssignedIdentityResourceID *string `json:"userAssignedIdentityResourceId,omitempty"`
}

// LinkedWorkspaceUpdateDto object used for updating linked workspace.
type LinkedWorkspaceUpdateDto struct {
	// UserAssignedIdentityResourceID - ResourceId of the user assigned identity for the linked workspace
	UserAssignedIdentityResourceID *string `json:"userAssignedIdentityResourceId,omitempty"`
}
...
// ListLinkedWorkspace ...
type ListLinkedWorkspace struct {
	autorest.Response `json:"-"`
	Value             *[]LinkedWorkspace `json:"value,omitempty"`
}
...
type WorkspaceProperties struct {
	...
	// LinkedWorkspaces - Dictionary that contains all linked workspaces in the AML workspace, with resourceId of the linked workspace as key.
	LinkedWorkspaces map[string]*LinkedWorkspace `json:"linkedWorkspaces"`
}
...
func (wp WorkspaceProperties) MarshalJSON() ([]byte, error) {
	...
	if wp.LinkedWorkspaces != nil {
		objectMap["linkedWorkspaces"] = wp.LinkedWorkspaces
	}
	return json.Marshal(objectMap)
}
