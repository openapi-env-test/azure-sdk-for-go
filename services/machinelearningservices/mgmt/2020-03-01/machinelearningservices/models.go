...
type SharedPrivateLinkResource struct {
	// Name - READ-ONLY; Unique name of the private link.
	Name *string `json:"name,omitempty"`
...
type SharedPrivateLinkResourceProperty struct {
	// PrivateLinkResourceID - READ-ONLY; The resource id that private link links to.
...
type WorkspaceProperties struct {
	...
	// SharedPrivateLinkResources - READ-ONLY; The list of shared private link resources in this workspace.
