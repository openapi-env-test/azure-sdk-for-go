...
type ACIServiceResponse struct {
	...
	Properties map[string]*string `json:"properties"`
	// State - READ-ONLY; The current state of the service. Possible values include: 'Transitioning', 'Healthy', 'Unhealthy', 'Failed', 'Unschedulable'
...
type AmlComputeProperties struct {
	// OsType - Compute OS Type. Possible values include: 'Linux', 'Windows'
...
type Identity struct {
	...
	TenantID *string `json:"tenantId,omitempty"`
	// Type - The identity type. Possible values include: 'SystemAssigned', 'SystemAssignedUserAssigned', 'UserAssigned', 'None'
