...
// LeaseContainerRequest enumerates the values for lease container request.
type LeaseContainerRequest string

const (
	// Acquire ...
	Acquire LeaseContainerRequest = "Acquire"
	// Break ...
	Break LeaseContainerRequest = "Break"
	// Change ...
	Change LeaseContainerRequest = "Change"
	// Release ...
	Release LeaseContainerRequest = "Release"
	// Renew ...
	Renew LeaseContainerRequest = "Renew"
)

// PossibleLeaseContainerRequestValues returns an array of possible values for the LeaseContainerRequest const type.
func PossibleLeaseContainerRequestValues() []LeaseContainerRequest {
	return []LeaseContainerRequest{Acquire, Break, Change, Release, Renew}
}
