...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/peering/mgmt/2022-06-01/peering"
...
type DirectConnection struct {
	...
	// ConnectionState - READ-ONLY; The state of the connection. Possible values include: 'None', 'PendingApproval', 'Approved', 'ProvisioningStarted', 'ProvisioningFailed', 'ProvisioningCompleted', 'Validating', 'Active', 'TypeChangeRequested', 'TypeChangeInProgress'
