...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/peering/mgmt/2022-06-01/peering"
...
type LegacyPeeringsClientAPI interface {
	List(ctx context.Context, peeringLocation string, kind peering.LegacyPeeringsKind, asn *int32, directPeeringType peering.DirectPeeringType) (result peering.ListResultPage, err error)
	ListComplete(ctx context.Context, peeringLocation string, kind peering.LegacyPeeringsKind, asn *int32, directPeeringType peering.DirectPeeringType) (result peering.ListResultIterator, err error)
}
...
type RegisteredPrefixesClientAPI interface {
	...
	Validate(ctx context.Context, resourceGroupName string, peeringName string, registeredPrefixName string) (result peering.RegisteredPrefix, err error)
}
