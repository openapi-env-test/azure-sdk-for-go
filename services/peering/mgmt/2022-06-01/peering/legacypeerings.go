...
// directPeeringType - the direct peering type.
func (client LegacyPeeringsClient) List(ctx context.Context, peeringLocation string, kind LegacyPeeringsKind, asn *int32, directPeeringType DirectPeeringType) (result ListResultPage, err error) {
	...
	req, err := client.ListPreparer(ctx, peeringLocation, kind, asn, directPeeringType)
	if err != nil {
...
func (client LegacyPeeringsClient) ListPreparer(ctx context.Context, peeringLocation string, kind LegacyPeeringsKind, asn *int32, directPeeringType DirectPeeringType) (*http.Request, error) {
...
func (client LegacyPeeringsClient) ListComplete(ctx context.Context, peeringLocation string, kind LegacyPeeringsKind, asn *int32, directPeeringType DirectPeeringType) (result ListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/LegacyPeeringsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, peeringLocation, kind, asn, directPeeringType)
	return
}
