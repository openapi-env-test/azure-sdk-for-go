...
type ServerProperties struct {
	...
	// Version - PostgreSQL Server version. Possible values include: 'ServerVersionOneFour', 'ServerVersionOneThree', 'ServerVersionOneTwo', 'ServerVersionOneOne'
...
type VirtualNetworkSubnetUsageResult struct {
	autorest.Response `json:"-"`
	// Location - READ-ONLY; The location the resource resides in.
	Location *string `json:"location,omitempty"`
