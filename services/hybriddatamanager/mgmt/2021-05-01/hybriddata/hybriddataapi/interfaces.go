...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/hybriddatamanager/mgmt/2021-05-01/hybriddata"
...
type JobDefinitionsClientAPI interface {
	Cancel(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string) (result hybriddata.JobDefinitionsCancelFuture, err error)
	CheckStatus(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string) (result hybriddata.JobDefinitionsCheckStatusFuture, err error)
	...
	Retry(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string) (result autorest.Response, err error)
	...
	Skip(ctx context.Context, dataServiceName string, jobDefinitionName string, resourceGroupName string, dataManagerName string) (result autorest.Response, err error)
}
