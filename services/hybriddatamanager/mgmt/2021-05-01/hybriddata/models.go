...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/hybriddatamanager/mgmt/2021-05-01/hybriddata"
...
type Job struct {
	autorest.Response `json:"-"`
	// Status - Status of the job. Possible values include: 'JobStatusNone', 'JobStatusInProgress', 'JobStatusSucceeded', 'JobStatusWaitingForAction', 'JobStatusFailed', 'JobStatusCancelled', 'JobStatusCancelling', 'JobStatusPartiallySucceeded', 'JobStatusWaiting', 'JobStatusCancelledSkipped', 'JobStatusFailedSkipped', 'JobStatusCancelledRetried', 'JobStatusFailedRetried'
...
type JobDefinitionProperties struct {
	...
	// JobDefinitionSchemaVersion - Schema version of the job definition.
	JobDefinitionSchemaVersion *string `json:"jobDefinitionSchemaVersion,omitempty"`
	// JobDefinitionState - State of the job definition. Possible values include: 'Created', 'Queueing', 'Waiting', 'Running', 'Complete', 'Cancelling', 'Cancelled', 'Paused'
...
// JobDefinitionsCancelFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type JobDefinitionsCancelFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *JobDefinitionsCancelFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for JobDefinitionsCancelFuture.Result.
func (future *JobDefinitionsCancelFuture) result(client JobDefinitionsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "hybriddata.JobDefinitionsCancelFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("hybriddata.JobDefinitionsCancelFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// JobDefinitionsCheckStatusFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type JobDefinitionsCheckStatusFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(JobDefinitionsClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *JobDefinitionsCheckStatusFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for JobDefinitionsCheckStatusFuture.Result.
func (future *JobDefinitionsCheckStatusFuture) result(client JobDefinitionsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "hybriddata.JobDefinitionsCheckStatusFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("hybriddata.JobDefinitionsCheckStatusFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type JobFilter struct {
	// Status - The status of the job. Possible values include: 'JobStatusNone', 'JobStatusInProgress', 'JobStatusSucceeded', 'JobStatusWaitingForAction', 'JobStatusFailed', 'JobStatusCancelled', 'JobStatusCancelling', 'JobStatusPartiallySucceeded', 'JobStatusWaiting', 'JobStatusCancelledSkipped', 'JobStatusFailedSkipped', 'JobStatusCancelledRetried', 'JobStatusFailedRetried'
	Status JobStatus `json:"status,omitempty"`
...
type JobProperties struct {
	...
	// ItemsDeleted - Number of items deleted by the job as of now
	ItemsDeleted *int64 `json:"itemsDeleted,omitempty"`
	// TotalItemsToDelete - Number of items to be deleted by the job in total
	TotalItemsToDelete *int64 `json:"totalItemsToDelete,omitempty"`
	// FilesCopiedCounter - Of the items copied by the job as of now, how many are files
	FilesCopiedCounter *int64 `json:"filesCopiedCounter,omitempty"`
	// FilesDeletedCounter - Of the items deleted by the job as of now, how many are files
	FilesDeletedCounter *int64 `json:"filesDeletedCounter,omitempty"`
	// BytesCopied - Number of bytes actually copied by the job as of now
	BytesCopied *int64 `json:"bytesCopied,omitempty"`
	// BackupStartTime - Time getting the backup started
	BackupStartTime *date.Time `json:"backupStartTime,omitempty"`
	// BackupEndTime - Time getting the backup ended
	BackupEndTime *date.Time `json:"backupEndTime,omitempty"`
	// EstimationConfigureComputeStartTime - Time configuring compute for estimation stage started
	EstimationConfigureComputeStartTime *date.Time `json:"estimationConfigureComputeStartTime,omitempty"`
	// EstimationConfigureComputeEndTime - Time configuring compute for estimation stage ended
	EstimationConfigureComputeEndTime *date.Time `json:"estimationConfigureComputeEndTime,omitempty"`
	// DirectoryParserStartTime - Time enumerating source directory started
	DirectoryParserStartTime *date.Time `json:"directoryParserStartTime,omitempty"`
	// DirectoryParserEndTime - Time enumerating source directory ended
	DirectoryParserEndTime *date.Time `json:"directoryParserEndTime,omitempty"`
	// PurgeDetectionStartTime - Time enumerating target directory started
	PurgeDetectionStartTime *date.Time `json:"purgeDetectionStartTime,omitempty"`
	// PurgeDetectionEndTime - Time enumerating target directory ended
	PurgeDetectionEndTime *date.Time `json:"purgeDetectionEndTime,omitempty"`
	// EstimationStartTime - Time estimating files started
	EstimationStartTime *date.Time `json:"estimationStartTime,omitempty"`
	// EstimationEndTime - Time estimating files ended
	EstimationEndTime *date.Time `json:"estimationEndTime,omitempty"`
	// PostEstimationStartTime - Time deleting excess files started
	PostEstimationStartTime *date.Time `json:"postEstimationStartTime,omitempty"`
	// PostEstimationEndTime - Time deleting excess files ended
	PostEstimationEndTime *date.Time `json:"postEstimationEndTime,omitempty"`
	// CopyConfigureComputeStartTime - Time configuring compute for copy stage started
	CopyConfigureComputeStartTime *date.Time `json:"copyConfigureComputeStartTime,omitempty"`
	// CopyConfigureComputeEndTime - Time configuring compute for copy stage ended
	CopyConfigureComputeEndTime *date.Time `json:"copyConfigureComputeEndTime,omitempty"`
	// CopyStartTime - Time copying files started
	CopyStartTime *date.Time `json:"copyStartTime,omitempty"`
	// CopyEndTime - Time copying files ended
	CopyEndTime *date.Time `json:"copyEndTime,omitempty"`
	// PostCopyStartTime - Time copying logs and creating share snapshot started
	PostCopyStartTime *date.Time `json:"postCopyStartTime,omitempty"`
	// PostCopyEndTime - Time copying logs and creating share snapshot ended
	PostCopyEndTime *date.Time `json:"postCopyEndTime,omitempty"`
	// CleanupComputeStartTime - Time cleaning up compute started
	CleanupComputeStartTime *date.Time `json:"cleanupComputeStartTime,omitempty"`
	// CleanupComputeEndTime - Time cleaning up compute ended
	CleanupComputeEndTime *date.Time `json:"cleanupComputeEndTime,omitempty"`
	...
	// CopyErrors - Number of copy errors
	CopyErrors *int64 `json:"copyErrors,omitempty"`
	// UnsupportedFiles - Number of unsupported files
...
type JobStages struct {
	...
	// StageStatus - Status of the job stage. Possible values include: 'JobStatusNone', 'JobStatusInProgress', 'JobStatusSucceeded', 'JobStatusWaitingForAction', 'JobStatusFailed', 'JobStatusCancelled', 'JobStatusCancelling', 'JobStatusPartiallySucceeded', 'JobStatusWaiting', 'JobStatusCancelledSkipped', 'JobStatusFailedSkipped', 'JobStatusCancelledRetried', 'JobStatusFailedRetried'
