...
// Create update the state of specified private endpoint connection associated with a SignalR resource.
// Parameters:
...
func (client PrivateEndpointConnectionsClient) Create(ctx context.Context, privateEndpointConnectionName string, resourceGroupName string, resourceName string, parameters *PrivateEndpointConnection) (result PrivateEndpointConnectionsCreateFuture, err error) {
	...
	req, err := client.CreatePreparer(ctx, privateEndpointConnectionName, resourceGroupName, resourceName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "signalr.PrivateEndpointConnectionsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "signalr.PrivateEndpointConnectionsClient", "Create", result.Response(), "Failure sending request")
		return
	}
...
func (client PrivateEndpointConnectionsClient) CreatePreparer(ctx context.Context, privateEndpointConnectionName string, resourceGroupName string, resourceName string, parameters *PrivateEndpointConnection) (*http.Request, error) {
