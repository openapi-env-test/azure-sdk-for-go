...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/resources/mgmt/2020-10-01/managementgroups"
...
type ParentGroupBagInfo struct {
	// ID - The fully qualified ID for the parent management group.  For example, /providers/Microsoft.Management/managementGroups/0000000-0000-0000-0000-000000000000
	ID *string `json:"id,omitempty"`
	// Name - The name of the parent management group. For example, 00000000-0000-0000-0000-000000000000
	Name *string `json:"name,omitempty"`
