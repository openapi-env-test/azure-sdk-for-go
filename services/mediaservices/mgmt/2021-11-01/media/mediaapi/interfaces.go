...
// TracksClientAPI contains the set of methods on the TracksClient type.
type TracksClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, accountName string, assetName string, trackName string, parameters media.AssetTrack) (result media.TracksCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, accountName string, assetName string, trackName string) (result media.TracksDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, accountName string, assetName string, trackName string) (result media.AssetTrack, err error)
	List(ctx context.Context, resourceGroupName string, accountName string, assetName string) (result media.AssetTrackCollection, err error)
	Update(ctx context.Context, resourceGroupName string, accountName string, assetName string, trackName string, parameters media.AssetTrack) (result media.TracksUpdateFuture, err error)
	UpdateTrackData(ctx context.Context, resourceGroupName string, accountName string, assetName string, trackName string) (result media.TracksUpdateTrackDataFuture, err error)
}

var _ TracksClientAPI = (*media.TracksClient)(nil)
...
type OperationStatusesClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, accountName string, assetName string, trackName string, operationID string) (result media.AssetTrackOperationStatus, err error)
}

var _ OperationStatusesClientAPI = (*media.OperationStatusesClient)(nil)
...
type OperationResultsClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, accountName string, assetName string, trackName string, operationID string) (result media.AssetTrack, err error)
}

var _ OperationResultsClientAPI = (*media.OperationResultsClient)(nil)
