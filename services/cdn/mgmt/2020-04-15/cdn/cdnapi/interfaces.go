...
import (
    ...
    "github.com/Azure/go-autorest/autorest"
        ...
        type ProfilesClientAPI interface {
            ...
            ListXXX(ctx context.Context) (result cdn.ProfileListResultPage, err error)
                ListXXXComplete(ctx context.Context) (result cdn.ProfileListResultIterator, err error)
