...
type DataLakeAnalyticsAccountListResult struct {
	...
	// Count - READ-ONLY; The current number of data lake analytics accounts under this subscription.
...
type DataLakeAnalyticsAccountProperties struct {
	...
	// MaxJobCount - The maximum supported jobs running under the account at the same time.
	MaxJobCount *int32 `json:"maxJobCount,omitempty"`
	// MaxActiveJobCountPerUser - READ-ONLY; The maximum supported active jobs under the account at the same time.
	MaxActiveJobCountPerUser *int32 `json:"maxActiveJobCountPerUser,omitempty"`
	...
	// MaxJobRunningTimeInMin - READ-ONLY; The maximum supported active jobs under the account at the same time.
	MaxJobRunningTimeInMin *int32 `json:"maxJobRunningTimeInMin,omitempty"`
